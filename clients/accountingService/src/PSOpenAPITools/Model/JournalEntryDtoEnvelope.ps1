...
JournalEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-JournalEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to JournalEntryDtoEnvelope<PSCustomObject>
...
JournalEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJournalEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalEntryDtoEnvelope
