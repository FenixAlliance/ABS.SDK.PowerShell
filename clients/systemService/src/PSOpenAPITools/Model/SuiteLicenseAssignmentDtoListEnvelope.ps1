...
SuiteLicenseAssignmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-SuiteLicenseAssignmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuiteLicenseAssignmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to SuiteLicenseAssignmentDtoListEnvelope<PSCustomObject>
...
SuiteLicenseAssignmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSuiteLicenseAssignmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuiteLicenseAssignmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuiteLicenseAssignmentDtoListEnvelope
