...
ItemRefundPolicyCreateDto<PSCustomObject>
#>

function Initialize-ItemRefundPolicyCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRefundPolicyCreateDto' | Write-Debug
...
Convert from JSON to ItemRefundPolicyCreateDto<PSCustomObject>
...
ItemRefundPolicyCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemRefundPolicyCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRefundPolicyCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRefundPolicyCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId")
