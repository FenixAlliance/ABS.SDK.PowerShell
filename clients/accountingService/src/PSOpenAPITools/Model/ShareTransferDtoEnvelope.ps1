...
ShareTransferDtoEnvelope<PSCustomObject>
#>

function Initialize-ShareTransferDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferDtoEnvelope' | Write-Debug
...
Convert from JSON to ShareTransferDtoEnvelope<PSCustomObject>
...
ShareTransferDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareTransferDtoEnvelope
