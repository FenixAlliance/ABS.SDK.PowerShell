...
CurriculumExperienceDtoListEnvelope<PSCustomObject>
#>

function Initialize-CurriculumExperienceDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurriculumExperienceDtoListEnvelope' | Write-Debug
...
Convert from JSON to CurriculumExperienceDtoListEnvelope<PSCustomObject>
...
CurriculumExperienceDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurriculumExperienceDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurriculumExperienceDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
