...
function Initialize-ShareClassCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareClassCreateDto' | Write-Debug
...
Convert from JSON to ShareClassCreateDto<PSCustomObject>
...
ShareClassCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToShareClassCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareClassCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
