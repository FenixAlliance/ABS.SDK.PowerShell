...
[**Invoke-PatchCourseArticleAsync**](CourseArticlesApi.md#Invoke-PatchCourseArticleAsync) | **PATCH** /api/v2/LearningService/CourseArticles/{articleId} | Patch a course article
...
$CourseArticleCreateDto = Initialize-CourseArticleCreateDto -Id "MyId" -Timestamp (Get-Date) -Title "MyTitle" -Description "MyDescription" -Content "MyContent" -CourseId "MyCourseId" -CourseWikiId "MyCourseWikiId" # CourseArticleCreateDto |  (optional)
...
# Get all course articles
try {
    $Result = Get-CourseArticlesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseArticleDtoCollectionQueryParameters $CourseArticleDtoCollectionQueryParameters
} catch {
...
# Get course articles count
try {
    $Result = Get-CourseArticlesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseArticleDtoCollectionQueryParameters $CourseArticleDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchCourseArticleAsync"></a>
# **Invoke-PatchCourseArticleAsync**
> EmptyEnvelope Invoke-PatchCourseArticleAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ArticleId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a course article
try {
    $Result = Invoke-PatchCourseArticleAsync -TenantId $TenantId -ArticleId $ArticleId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchCourseArticleAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
