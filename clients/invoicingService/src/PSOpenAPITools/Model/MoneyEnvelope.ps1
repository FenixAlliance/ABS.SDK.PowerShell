...
MoneyEnvelope<PSCustomObject>
#>

function Initialize-MoneyEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoneyEnvelope' | Write-Debug
...
Convert from JSON to MoneyEnvelope<PSCustomObject>
...
MoneyEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMoneyEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoneyEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoneyEnvelope
