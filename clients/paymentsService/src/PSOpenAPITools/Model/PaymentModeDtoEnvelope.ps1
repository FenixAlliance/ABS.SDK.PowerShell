...
PaymentModeDtoEnvelope<PSCustomObject>
#>

function Initialize-PaymentModeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentModeDtoEnvelope' | Write-Debug
...
Convert from JSON to PaymentModeDtoEnvelope<PSCustomObject>
...
PaymentModeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentModeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentModeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentModeDtoEnvelope
