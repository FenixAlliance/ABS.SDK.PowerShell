...
TransactionCategoryUpdateDto<PSCustomObject>
#>

function Initialize-TransactionCategoryUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TransactionCategoryUpdateDto' | Write-Debug
...
Convert from JSON to TransactionCategoryUpdateDto<PSCustomObject>
...
TransactionCategoryUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToTransactionCategoryUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TransactionCategoryUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TransactionCategoryUpdateDto
        $AllProperties = ("name", "description", "enrollmentId", "tenantId")
