...
BlogPostTagDtoEnvelope<PSCustomObject>
#>

function Initialize-BlogPostTagDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostTagDtoEnvelope' | Write-Debug
...
Convert from JSON to BlogPostTagDtoEnvelope<PSCustomObject>
...
BlogPostTagDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostTagDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostTagDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostTagDtoEnvelope
