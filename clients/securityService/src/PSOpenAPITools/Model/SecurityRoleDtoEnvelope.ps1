...
SecurityRoleDtoEnvelope<PSCustomObject>
#>

function Initialize-SecurityRoleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityRoleDtoEnvelope' | Write-Debug
...
Convert from JSON to SecurityRoleDtoEnvelope<PSCustomObject>
...
SecurityRoleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityRoleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityRoleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityRoleDtoEnvelope
