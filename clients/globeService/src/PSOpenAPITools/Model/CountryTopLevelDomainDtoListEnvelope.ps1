...
CountryTopLevelDomainDtoListEnvelope<PSCustomObject>
#>

function Initialize-CountryTopLevelDomainDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryTopLevelDomainDtoListEnvelope' | Write-Debug
...
Convert from JSON to CountryTopLevelDomainDtoListEnvelope<PSCustomObject>
...
CountryTopLevelDomainDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryTopLevelDomainDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryTopLevelDomainDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryTopLevelDomainDtoListEnvelope
