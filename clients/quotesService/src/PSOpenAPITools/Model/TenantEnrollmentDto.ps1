...
TenantEnrollmentDto<PSCustomObject>
#>

function Initialize-TenantEnrollmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantEnrollmentDto' | Write-Debug
...
Convert from JSON to TenantEnrollmentDto<PSCustomObject>
...
TenantEnrollmentDto<PSCustomObject>
#>
function ConvertFrom-JsonToTenantEnrollmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantEnrollmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantEnrollmentDto
