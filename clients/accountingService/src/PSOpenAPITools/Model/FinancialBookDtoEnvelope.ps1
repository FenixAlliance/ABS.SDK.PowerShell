...
FinancialBookDtoEnvelope<PSCustomObject>
#>

function Initialize-FinancialBookDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FinancialBookDtoEnvelope' | Write-Debug
...
Convert from JSON to FinancialBookDtoEnvelope<PSCustomObject>
...
FinancialBookDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFinancialBookDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FinancialBookDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FinancialBookDtoEnvelope
