...
# Count item refund policies
try {
    $Result = Invoke-CountItemRefundPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRefundPolicyDtoCollectionQueryParameters $ItemRefundPolicyDtoCollectionQueryParameters
} catch {
...
# Get item refund policies
try {
    $Result = Get-ItemRefundPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRefundPolicyDtoCollectionQueryParameters $ItemRefundPolicyDtoCollectionQueryParameters
} catch {
