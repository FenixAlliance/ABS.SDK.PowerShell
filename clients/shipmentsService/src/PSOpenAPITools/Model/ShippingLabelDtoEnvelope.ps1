...
ShippingLabelDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingLabelDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingLabelDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingLabelDtoEnvelope<PSCustomObject>
...
ShippingLabelDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingLabelDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingLabelDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingLabelDtoEnvelope
