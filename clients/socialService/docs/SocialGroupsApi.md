...
# Patch a social group
try {
    $Result = Invoke-PatchSocialGroupAsync -TenantId $TenantId -SocialProfileId $SocialProfileId -SocialGroupId $SocialGroupId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
