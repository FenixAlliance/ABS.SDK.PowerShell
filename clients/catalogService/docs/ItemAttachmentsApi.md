...
# Patch an item attachment
try {
    $Result = Invoke-PatchItemAttachmentAsync -TenantId $TenantId -ItemAttachmentId $ItemAttachmentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
