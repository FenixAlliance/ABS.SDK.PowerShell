...
ItemShippingPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemShippingPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemShippingPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemShippingPolicyDtoListEnvelope<PSCustomObject>
...
ItemShippingPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemShippingPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemShippingPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemShippingPolicyDtoListEnvelope
