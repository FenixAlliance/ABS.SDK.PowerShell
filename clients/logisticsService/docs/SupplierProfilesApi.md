...
# Patch a supplier profile
try {
    $Result = Invoke-PatchSupplierProfileAsync -TenantId $TenantId -SupplierProfileId $SupplierProfileId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
