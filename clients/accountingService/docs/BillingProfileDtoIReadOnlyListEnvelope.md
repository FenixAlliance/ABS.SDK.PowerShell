...
```powershell
$BillingProfileDtoIReadOnlyListEnvelope = Initialize-PSOpenAPIToolsBillingProfileDtoIReadOnlyListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$BillingProfileDtoIReadOnlyListEnvelope | ConvertTo-JSON
```
