...
AppliedTaxPolicyRecordCreateDto<PSCustomObject>
#>

function Initialize-AppliedTaxPolicyRecordCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordCreateDto' | Write-Debug
...
Convert from JSON to AppliedTaxPolicyRecordCreateDto<PSCustomObject>
...
AppliedTaxPolicyRecordCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAppliedTaxPolicyRecordCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppliedTaxPolicyRecordCreateDto
