...
WishListDtoEnvelope<PSCustomObject>
#>

function Initialize-WishListDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WishListDtoEnvelope' | Write-Debug
...
Convert from JSON to WishListDtoEnvelope<PSCustomObject>
...
WishListDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWishListDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WishListDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WishListDtoEnvelope
