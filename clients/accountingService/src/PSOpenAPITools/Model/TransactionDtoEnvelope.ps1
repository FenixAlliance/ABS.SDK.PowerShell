...
TransactionDtoEnvelope<PSCustomObject>
#>

function Initialize-TransactionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TransactionDtoEnvelope' | Write-Debug
...
Convert from JSON to TransactionDtoEnvelope<PSCustomObject>
...
TransactionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTransactionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TransactionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TransactionDtoEnvelope
