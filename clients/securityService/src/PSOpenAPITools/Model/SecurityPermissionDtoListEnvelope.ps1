...
SecurityPermissionDtoListEnvelope<PSCustomObject>
#>

function Initialize-SecurityPermissionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityPermissionDtoListEnvelope' | Write-Debug
...
Convert from JSON to SecurityPermissionDtoListEnvelope<PSCustomObject>
...
SecurityPermissionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityPermissionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityPermissionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityPermissionDtoListEnvelope
