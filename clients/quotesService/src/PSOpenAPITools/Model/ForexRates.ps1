...
ForexRates<PSCustomObject>
#>

function Initialize-ForexRates {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ForexRates' | Write-Debug
...
Convert from JSON to ForexRates<PSCustomObject>
...
ForexRates<PSCustomObject>
#>
function ConvertFrom-JsonToForexRates {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ForexRates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ForexRates
