...
SocialPostCreateDto<PSCustomObject>
#>

function Initialize-SocialPostCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostCreateDto' | Write-Debug
...
Convert from JSON to SocialPostCreateDto<PSCustomObject>
...
SocialPostCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostCreateDto
