...
DealUnitDtoEnvelope<PSCustomObject>
#>

function Initialize-DealUnitDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitDtoEnvelope' | Write-Debug
...
Convert from JSON to DealUnitDtoEnvelope<PSCustomObject>
...
DealUnitDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitDtoEnvelope
