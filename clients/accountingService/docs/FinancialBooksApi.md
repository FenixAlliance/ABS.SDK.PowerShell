...
# Patch a financial book
try {
    $Result = Invoke-PatchFinancialBookAsync -TenantId $TenantId -FinancialBookId $FinancialBookId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
