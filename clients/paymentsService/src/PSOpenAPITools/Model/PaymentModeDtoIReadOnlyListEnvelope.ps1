...
PaymentModeDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-PaymentModeDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentModeDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to PaymentModeDtoIReadOnlyListEnvelope<PSCustomObject>
...
PaymentModeDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentModeDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentModeDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentModeDtoIReadOnlyListEnvelope
