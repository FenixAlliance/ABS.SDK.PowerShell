...
ActivityTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-ActivityTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to ActivityTypeDtoListEnvelope<PSCustomObject>
...
ActivityTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityTypeDtoListEnvelope
