...
TrainingProgramDtoListEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramDtoListEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramDtoListEnvelope<PSCustomObject>
...
TrainingProgramDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramDtoListEnvelope
