...
# Patch a social media post
try {
    $Result = Invoke-PatchSocialMediaPostAsync -TenantId $TenantId -SocialmediapostId $SocialmediapostId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
