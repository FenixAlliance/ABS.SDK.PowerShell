...
PriceListDtoListEnvelope<PSCustomObject>
#>

function Initialize-PriceListDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PriceListDtoListEnvelope' | Write-Debug
...
Convert from JSON to PriceListDtoListEnvelope<PSCustomObject>
...
PriceListDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPriceListDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PriceListDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceListDtoListEnvelope
