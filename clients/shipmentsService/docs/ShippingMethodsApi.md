...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ShippingMethodDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$ShippingMethodDtoCollectionQueryParameters = Initialize-ShippingMethodDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # ShippingMethodDtoCollectionQueryParameters |  (optional)

# Get all shipping methods
try {
    $Result = Get-ShippingMethodsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ShippingMethodDtoCollectionQueryParameters $ShippingMethodDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **ShippingMethodDtoCollectionQueryParameters** | [**ShippingMethodDtoCollectionQueryParameters**](ShippingMethodDtoCollectionQueryParameters.md)|  | [optional] 
...
# Get shipping methods count
try {
    $Result = Get-ShippingMethodsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ShippingMethodDtoCollectionQueryParameters $ShippingMethodDtoCollectionQueryParameters
} catch {
...
# Patch a shipping method
try {
    $Result = Invoke-PatchShippingMethodAsync -TenantId $TenantId -MethodId $MethodId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
