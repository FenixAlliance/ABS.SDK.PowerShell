...
VoyageDtoEnvelope<PSCustomObject>
#>

function Initialize-VoyageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VoyageDtoEnvelope' | Write-Debug
...
Convert from JSON to VoyageDtoEnvelope<PSCustomObject>
...
VoyageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToVoyageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VoyageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VoyageDtoEnvelope
