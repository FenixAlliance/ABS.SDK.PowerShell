...
ContactsGroupCreateDto<PSCustomObject>
#>

function Initialize-ContactsGroupCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactsGroupCreateDto' | Write-Debug
...
Convert from JSON to ContactsGroupCreateDto<PSCustomObject>
...
ContactsGroupCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactsGroupCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactsGroupCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactsGroupCreateDto
