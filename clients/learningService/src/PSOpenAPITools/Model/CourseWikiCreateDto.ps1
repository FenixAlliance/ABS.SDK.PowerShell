...
CourseWikiCreateDto<PSCustomObject>
#>

function Initialize-CourseWikiCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseWikiCreateDto' | Write-Debug
...
Convert from JSON to CourseWikiCreateDto<PSCustomObject>
...
CourseWikiCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToCourseWikiCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseWikiCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseWikiCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "courseID", "businessID", "courseUnitID", "releaseDateTime")
