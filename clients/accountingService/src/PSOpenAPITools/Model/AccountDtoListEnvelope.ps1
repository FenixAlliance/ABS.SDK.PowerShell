...
AccountDtoListEnvelope<PSCustomObject>
#>

function Initialize-AccountDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountDtoListEnvelope' | Write-Debug
...
Convert from JSON to AccountDtoListEnvelope<PSCustomObject>
...
AccountDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountDtoListEnvelope
