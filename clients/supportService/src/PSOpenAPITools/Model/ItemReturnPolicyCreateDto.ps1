...
ItemReturnPolicyCreateDto<PSCustomObject>
#>

function Initialize-ItemReturnPolicyCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemReturnPolicyCreateDto' | Write-Debug
...
Convert from JSON to ItemReturnPolicyCreateDto<PSCustomObject>
...
ItemReturnPolicyCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemReturnPolicyCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemReturnPolicyCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemReturnPolicyCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "shippingCourierId", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId")
