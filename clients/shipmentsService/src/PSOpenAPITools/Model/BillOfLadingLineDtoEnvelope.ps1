...
BillOfLadingLineDtoEnvelope<PSCustomObject>
#>

function Initialize-BillOfLadingLineDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillOfLadingLineDtoEnvelope' | Write-Debug
...
Convert from JSON to BillOfLadingLineDtoEnvelope<PSCustomObject>
...
BillOfLadingLineDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBillOfLadingLineDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillOfLadingLineDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillOfLadingLineDtoEnvelope
