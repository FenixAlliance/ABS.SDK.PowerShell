...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExpenseClaimDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$ExpenseClaimDtoCollectionQueryParameters = Initialize-ExpenseClaimDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # ExpenseClaimDtoCollectionQueryParameters |  (optional)

# Get all expense claims for a tenant
try {
    $Result = Get-ExpenseClaims -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ExpenseClaimDtoCollectionQueryParameters $ExpenseClaimDtoCollectionQueryParameters
} catch {
...
# Get the count of expense claims for a tenant
try {
    $Result = Get-ExpenseClaimsCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ExpenseClaimDtoCollectionQueryParameters $ExpenseClaimDtoCollectionQueryParameters
} catch {
...
# Patch an expense claim
try {
    $Result = Invoke-PatchExpenseClaim -TenantId $TenantId -ExpenseClaimId $ExpenseClaimId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
