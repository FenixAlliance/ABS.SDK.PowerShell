...
JobFieldCreateDto<PSCustomObject>
#>

function Initialize-JobFieldCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobFieldCreateDto' | Write-Debug
...
Convert from JSON to JobFieldCreateDto<PSCustomObject>
...
JobFieldCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToJobFieldCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobFieldCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobFieldCreateDto
        $AllProperties = ("id", "timestamp", "name", "imageUrl", "description")
