...
BillOfLadingLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-BillOfLadingLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillOfLadingLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to BillOfLadingLineDtoListEnvelope<PSCustomObject>
...
BillOfLadingLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBillOfLadingLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillOfLadingLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillOfLadingLineDtoListEnvelope
