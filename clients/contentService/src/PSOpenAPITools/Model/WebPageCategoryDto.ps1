...
function ConvertFrom-JsonToWebPageCategoryDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalId", "tenantId", "enrollmentId")
