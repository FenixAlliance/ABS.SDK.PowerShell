...
PriceCalculationDtoEnvelope<PSCustomObject>
#>

function Initialize-PriceCalculationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PriceCalculationDtoEnvelope' | Write-Debug
...
Convert from JSON to PriceCalculationDtoEnvelope<PSCustomObject>
...
PriceCalculationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPriceCalculationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PriceCalculationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceCalculationDtoEnvelope
