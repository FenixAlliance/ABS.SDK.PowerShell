...
TenantInvitationDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantInvitationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantInvitationDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantInvitationDtoListEnvelope<PSCustomObject>
...
TenantInvitationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantInvitationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantInvitationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantInvitationDtoListEnvelope
