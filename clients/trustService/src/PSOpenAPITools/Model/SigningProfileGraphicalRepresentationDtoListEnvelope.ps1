...
SigningProfileGraphicalRepresentationDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningProfileGraphicalRepresentationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningProfileGraphicalRepresentationDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningProfileGraphicalRepresentationDtoListEnvelope<PSCustomObject>
...
SigningProfileGraphicalRepresentationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningProfileGraphicalRepresentationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningProfileGraphicalRepresentationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningProfileGraphicalRepresentationDtoListEnvelope
