...
WalletDtoEnvelope<PSCustomObject>
#>

function Initialize-WalletDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WalletDtoEnvelope' | Write-Debug
...
Convert from JSON to WalletDtoEnvelope<PSCustomObject>
...
WalletDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWalletDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WalletDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WalletDtoEnvelope
