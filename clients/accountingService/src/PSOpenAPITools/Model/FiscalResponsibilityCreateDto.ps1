...
FiscalResponsibilityCreateDto<PSCustomObject>
#>

function Initialize-FiscalResponsibilityCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityCreateDto' | Write-Debug
...
Convert from JSON to FiscalResponsibilityCreateDto<PSCustomObject>
...
FiscalResponsibilityCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityCreateDto
