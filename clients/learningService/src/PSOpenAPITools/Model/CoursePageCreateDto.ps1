...
function Initialize-CoursePageCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CoursePageCreateDto' | Write-Debug
...
Convert from JSON to CoursePageCreateDto<PSCustomObject>
...
CoursePageCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToCoursePageCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CoursePageCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
