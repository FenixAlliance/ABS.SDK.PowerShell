...
WebPageCategoryUpdateDto<PSCustomObject>
#>

function Initialize-WebPageCategoryUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageCategoryUpdateDto' | Write-Debug
...
Convert from JSON to WebPageCategoryUpdateDto<PSCustomObject>
...
WebPageCategoryUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageCategoryUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageCategoryUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageCategoryUpdateDto
        $AllProperties = ("slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image")
