...
BankGuaranteeDtoListEnvelope<PSCustomObject>
#>

function Initialize-BankGuaranteeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankGuaranteeDtoListEnvelope' | Write-Debug
...
Convert from JSON to BankGuaranteeDtoListEnvelope<PSCustomObject>
...
BankGuaranteeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankGuaranteeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankGuaranteeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankGuaranteeDtoListEnvelope
