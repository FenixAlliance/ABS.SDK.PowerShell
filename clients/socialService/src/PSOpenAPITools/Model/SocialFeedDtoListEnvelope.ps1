...
SocialFeedDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialFeedDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialFeedDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialFeedDtoListEnvelope<PSCustomObject>
...
SocialFeedDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialFeedDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialFeedDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialFeedDtoListEnvelope
