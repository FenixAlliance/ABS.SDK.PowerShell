...
ServiceCaseTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-ServiceCaseTypeDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseTypeDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to ServiceCaseTypeDtoIReadOnlyListEnvelope<PSCustomObject>
...
ServiceCaseTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseTypeDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseTypeDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseTypeDtoIReadOnlyListEnvelope
