...
WarehouseDtoEnvelope<PSCustomObject>
#>

function Initialize-WarehouseDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarehouseDtoEnvelope' | Write-Debug
...
Convert from JSON to WarehouseDtoEnvelope<PSCustomObject>
...
WarehouseDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWarehouseDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarehouseDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarehouseDtoEnvelope
