...
# Patch a fiscal authority year
try {
    $Result = Invoke-PatchFiscalAuthorityYearAsync -TenantId $TenantId -FiscalYearId $FiscalYearId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
