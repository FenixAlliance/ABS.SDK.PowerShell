...
LoyaltyProgramDtoEnvelope<PSCustomObject>
#>

function Initialize-LoyaltyProgramDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoyaltyProgramDtoEnvelope' | Write-Debug
...
Convert from JSON to LoyaltyProgramDtoEnvelope<PSCustomObject>
...
LoyaltyProgramDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoyaltyProgramDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoyaltyProgramDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoyaltyProgramDtoEnvelope
