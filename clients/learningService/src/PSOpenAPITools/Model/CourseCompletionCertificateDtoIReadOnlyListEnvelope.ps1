...
CourseCompletionCertificateDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-CourseCompletionCertificateDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseCompletionCertificateDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to CourseCompletionCertificateDtoIReadOnlyListEnvelope<PSCustomObject>
...
CourseCompletionCertificateDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCourseCompletionCertificateDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseCompletionCertificateDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseCompletionCertificateDtoIReadOnlyListEnvelope
