...
BlogPostCategoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlogPostCategoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostCategoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlogPostCategoryDtoListEnvelope<PSCustomObject>
...
BlogPostCategoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostCategoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostCategoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostCategoryDtoListEnvelope
