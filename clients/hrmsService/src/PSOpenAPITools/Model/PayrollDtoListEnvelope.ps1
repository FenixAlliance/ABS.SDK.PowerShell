...
PayrollDtoListEnvelope<PSCustomObject>
#>

function Initialize-PayrollDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PayrollDtoListEnvelope' | Write-Debug
...
Convert from JSON to PayrollDtoListEnvelope<PSCustomObject>
...
PayrollDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPayrollDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PayrollDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PayrollDtoListEnvelope
