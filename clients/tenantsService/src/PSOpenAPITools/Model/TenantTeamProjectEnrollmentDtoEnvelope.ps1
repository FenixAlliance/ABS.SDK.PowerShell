...
TenantTeamProjectEnrollmentDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantTeamProjectEnrollmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTeamProjectEnrollmentDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantTeamProjectEnrollmentDtoEnvelope<PSCustomObject>
...
TenantTeamProjectEnrollmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTeamProjectEnrollmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTeamProjectEnrollmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTeamProjectEnrollmentDtoEnvelope
