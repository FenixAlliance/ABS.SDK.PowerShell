...
AccountGroupDtoListEnvelope<PSCustomObject>
#>

function Initialize-AccountGroupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountGroupDtoListEnvelope' | Write-Debug
...
Convert from JSON to AccountGroupDtoListEnvelope<PSCustomObject>
...
AccountGroupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountGroupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountGroupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountGroupDtoListEnvelope
