...
QuoteDtoListEnvelope<PSCustomObject>
#>

function Initialize-QuoteDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteDtoListEnvelope' | Write-Debug
...
Convert from JSON to QuoteDtoListEnvelope<PSCustomObject>
...
QuoteDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteDtoListEnvelope
