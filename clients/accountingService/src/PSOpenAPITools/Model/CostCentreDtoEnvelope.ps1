...
CostCentreDtoEnvelope<PSCustomObject>
#>

function Initialize-CostCentreDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreDtoEnvelope' | Write-Debug
...
Convert from JSON to CostCentreDtoEnvelope<PSCustomObject>
...
CostCentreDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreDtoEnvelope
