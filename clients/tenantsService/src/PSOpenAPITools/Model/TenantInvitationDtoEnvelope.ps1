...
TenantInvitationDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantInvitationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantInvitationDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantInvitationDtoEnvelope<PSCustomObject>
...
TenantInvitationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantInvitationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantInvitationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantInvitationDtoEnvelope
