...
ScheduleDtoEnvelope<PSCustomObject>
#>

function Initialize-ScheduleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ScheduleDtoEnvelope' | Write-Debug
...
Convert from JSON to ScheduleDtoEnvelope<PSCustomObject>
...
ScheduleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToScheduleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ScheduleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ScheduleDtoEnvelope
