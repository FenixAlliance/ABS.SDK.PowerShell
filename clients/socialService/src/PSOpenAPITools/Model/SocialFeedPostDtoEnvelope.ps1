...
SocialFeedPostDtoEnvelope<PSCustomObject>
#>

function Initialize-SocialFeedPostDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialFeedPostDtoEnvelope' | Write-Debug
...
Convert from JSON to SocialFeedPostDtoEnvelope<PSCustomObject>
...
SocialFeedPostDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialFeedPostDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialFeedPostDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialFeedPostDtoEnvelope
