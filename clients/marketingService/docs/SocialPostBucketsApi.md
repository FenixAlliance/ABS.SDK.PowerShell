...
# Patch a social post bucket
try {
    $Result = Invoke-PatchSocialPostBucketAsync -TenantId $TenantId -SocialpostbucketId $SocialpostbucketId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
