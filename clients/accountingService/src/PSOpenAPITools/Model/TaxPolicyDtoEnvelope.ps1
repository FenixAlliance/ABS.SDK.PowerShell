...
TaxPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-TaxPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to TaxPolicyDtoEnvelope<PSCustomObject>
...
TaxPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxPolicyDtoEnvelope
