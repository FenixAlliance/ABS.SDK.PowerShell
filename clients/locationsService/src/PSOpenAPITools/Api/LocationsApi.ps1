...
EmptyEnvelope
#>
function Invoke-PatchLocationAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-PatchLocationAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/LocationsService/Locations/{locationId}'
        if (!$LocationId) {
            throw "Error! The required parameter `LocationId` missing when calling patchLocationAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{locationId}', [System.Web.HTTPUtility]::UrlEncode($LocationId))

        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling patchLocationAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
...
EmptyEnvelope
#>
function Invoke-PatchWalletLocationAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-PatchWalletLocationAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/LocationsService/Locations/wallet/{walletId}/{locationId}'
        if (!$WalletId) {
            throw "Error! The required parameter `WalletId` missing when calling patchWalletLocationAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{walletId}', [System.Web.HTTPUtility]::UrlEncode($WalletId))
        if (!$LocationId) {
            throw "Error! The required parameter `LocationId` missing when calling patchWalletLocationAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{locationId}', [System.Web.HTTPUtility]::UrlEncode($LocationId))
