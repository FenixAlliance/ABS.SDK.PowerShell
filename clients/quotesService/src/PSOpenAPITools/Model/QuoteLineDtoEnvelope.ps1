...
QuoteLineDtoEnvelope<PSCustomObject>
#>

function Initialize-QuoteLineDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineDtoEnvelope' | Write-Debug
...
Convert from JSON to QuoteLineDtoEnvelope<PSCustomObject>
...
QuoteLineDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineDtoEnvelope
