...
#>
function Invoke-ApiV2GlobeServiceLanguagesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ApiV2GlobeServiceLanguagesGet' | Write-Debug
...
#>
function Invoke-ApiV2GlobeServiceLanguagesLanguageIdGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ApiV2GlobeServiceLanguagesLanguageIdGet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$LanguageId) {
            throw "Error! The required parameter `LanguageId` missing when calling apiV2GlobeServiceLanguagesLanguageIdGet."
        }
