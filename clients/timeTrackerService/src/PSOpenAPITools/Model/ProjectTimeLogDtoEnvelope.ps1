...
ProjectTimeLogDtoEnvelope<PSCustomObject>
#>

function Initialize-ProjectTimeLogDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectTimeLogDtoEnvelope' | Write-Debug
...
Convert from JSON to ProjectTimeLogDtoEnvelope<PSCustomObject>
...
ProjectTimeLogDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectTimeLogDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectTimeLogDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectTimeLogDtoEnvelope
