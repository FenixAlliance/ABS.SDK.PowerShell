...
**MarkedForPublish** | **Boolean** |  | [optional] 

## Examples

- Prepare the resource
```powershell
$BusinessApplicationUpdateDto = Initialize-PSOpenAPIToolsBusinessApplicationUpdateDto  -Name null `
 -Namespace null `
 -DisplayName null `
 -AvatarURL null `
 -WebsiteUrl null `
 ...
 -GitRepoUrl null `
 -MarkedForPublish null
```

- Convert the resource to JSON
```powershell
$BusinessApplicationUpdateDto | ConvertTo-JSON
```
