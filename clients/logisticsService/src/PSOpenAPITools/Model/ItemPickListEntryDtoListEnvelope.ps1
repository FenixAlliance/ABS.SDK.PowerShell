...
ItemPickListEntryDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemPickListEntryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPickListEntryDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemPickListEntryDtoListEnvelope<PSCustomObject>
...
ItemPickListEntryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPickListEntryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPickListEntryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPickListEntryDtoListEnvelope
