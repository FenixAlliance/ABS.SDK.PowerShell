...
WarehouseDtoListEnvelope<PSCustomObject>
#>

function Initialize-WarehouseDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarehouseDtoListEnvelope' | Write-Debug
...
Convert from JSON to WarehouseDtoListEnvelope<PSCustomObject>
...
WarehouseDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWarehouseDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarehouseDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarehouseDtoListEnvelope
