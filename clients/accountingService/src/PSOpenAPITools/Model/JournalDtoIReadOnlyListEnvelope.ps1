...
JournalDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-JournalDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to JournalDtoIReadOnlyListEnvelope<PSCustomObject>
...
JournalDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJournalDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalDtoIReadOnlyListEnvelope
