...
InvoiceLineAppliedTaxDtoListEnvelope<PSCustomObject>
#>

function Initialize-InvoiceLineAppliedTaxDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceLineAppliedTaxDtoListEnvelope' | Write-Debug
...
Convert from JSON to InvoiceLineAppliedTaxDtoListEnvelope<PSCustomObject>
...
InvoiceLineAppliedTaxDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceLineAppliedTaxDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceLineAppliedTaxDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceLineAppliedTaxDtoListEnvelope
