...
PayrollDtoEnvelope<PSCustomObject>
#>

function Initialize-PayrollDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PayrollDtoEnvelope' | Write-Debug
...
Convert from JSON to PayrollDtoEnvelope<PSCustomObject>
...
PayrollDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPayrollDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PayrollDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PayrollDtoEnvelope
