...
ShareIssuanceDtoEnvelope<PSCustomObject>
#>

function Initialize-ShareIssuanceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareIssuanceDtoEnvelope' | Write-Debug
...
Convert from JSON to ShareIssuanceDtoEnvelope<PSCustomObject>
...
ShareIssuanceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareIssuanceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareIssuanceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareIssuanceDtoEnvelope
