...
```powershell
$TenantTeamProjectEnrollmentDtoEnvelope = Initialize-PSOpenAPIToolsTenantTeamProjectEnrollmentDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TenantTeamProjectEnrollmentDtoEnvelope | ConvertTo-JSON
```
