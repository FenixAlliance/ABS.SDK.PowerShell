...
CountryLanguageDtoListEnvelope<PSCustomObject>
#>

function Initialize-CountryLanguageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryLanguageDtoListEnvelope' | Write-Debug
...
Convert from JSON to CountryLanguageDtoListEnvelope<PSCustomObject>
...
CountryLanguageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryLanguageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryLanguageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryLanguageDtoListEnvelope
