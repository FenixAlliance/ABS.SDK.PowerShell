...
# Patch a web page category
try {
    $Result = Invoke-PatchWebPageCategoryAsync -TenantId $TenantId -WebPageCategoryId $WebPageCategoryId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
