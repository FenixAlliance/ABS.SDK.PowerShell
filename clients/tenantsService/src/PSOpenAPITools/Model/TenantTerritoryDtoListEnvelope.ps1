...
TenantTerritoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTerritoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTerritoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTerritoryDtoListEnvelope<PSCustomObject>
...
TenantTerritoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTerritoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTerritoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTerritoryDtoListEnvelope
