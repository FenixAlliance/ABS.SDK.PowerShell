...
ContactSourceUpdateDto<PSCustomObject>
#>

function Initialize-ContactSourceUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactSourceUpdateDto' | Write-Debug
...
Convert from JSON to ContactSourceUpdateDto<PSCustomObject>
...
ContactSourceUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactSourceUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactSourceUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactSourceUpdateDto
