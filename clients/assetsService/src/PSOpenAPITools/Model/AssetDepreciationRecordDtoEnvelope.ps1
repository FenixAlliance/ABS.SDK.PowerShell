...
AssetDepreciationRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetDepreciationRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetDepreciationRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetDepreciationRecordDtoEnvelope<PSCustomObject>
...
AssetDepreciationRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetDepreciationRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetDepreciationRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetDepreciationRecordDtoEnvelope
