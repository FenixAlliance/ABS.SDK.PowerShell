...
[**Invoke-PatchTaxRate**](TaxRatesApi.md#Invoke-PatchTaxRate) | **PATCH** /api/v2/AccountingService/TaxRates/{id} | Patch a tax rate
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TaxRateDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TaxRateDtoCollectionQueryParameters = Initialize-TaxRateDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TaxRateDtoCollectionQueryParameters |  (optional)

# Get all tax rates for a tenant
try {
    $Result = Get-TaxRates -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TaxRateDtoCollectionQueryParameters $TaxRateDtoCollectionQueryParameters
} catch {
...
# Get tax rates count
try {
    $Result = Get-TaxRatesCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TaxRateDtoCollectionQueryParameters $TaxRateDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTaxRate"></a>
# **Invoke-PatchTaxRate**
> EmptyEnvelope Invoke-PatchTaxRate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tax rate
try {
    $Result = Invoke-PatchTaxRate -TenantId $TenantId -Id $Id -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTaxRate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
