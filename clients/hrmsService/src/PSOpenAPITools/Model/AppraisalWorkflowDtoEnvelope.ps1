...
AppraisalWorkflowDtoEnvelope<PSCustomObject>
#>

function Initialize-AppraisalWorkflowDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppraisalWorkflowDtoEnvelope' | Write-Debug
...
Convert from JSON to AppraisalWorkflowDtoEnvelope<PSCustomObject>
...
AppraisalWorkflowDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppraisalWorkflowDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppraisalWorkflowDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppraisalWorkflowDtoEnvelope
