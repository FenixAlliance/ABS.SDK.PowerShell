...
DealUnitFlowDtoListEnvelope<PSCustomObject>
#>

function Initialize-DealUnitFlowDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitFlowDtoListEnvelope' | Write-Debug
...
Convert from JSON to DealUnitFlowDtoListEnvelope<PSCustomObject>
...
DealUnitFlowDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitFlowDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitFlowDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitFlowDtoListEnvelope
