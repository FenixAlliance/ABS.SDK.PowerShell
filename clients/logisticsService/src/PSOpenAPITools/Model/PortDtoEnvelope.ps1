...
PortDtoEnvelope<PSCustomObject>
#>

function Initialize-PortDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortDtoEnvelope' | Write-Debug
...
Convert from JSON to PortDtoEnvelope<PSCustomObject>
...
PortDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPortDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortDtoEnvelope
