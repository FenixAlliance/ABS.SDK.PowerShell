...
# Patch a marketing campaign
try {
    $Result = Invoke-PatchMarketingCampaignAsync -TenantId $TenantId -MarketingcampaignId $MarketingcampaignId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
