...
SigningRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningRequestDtoListEnvelope<PSCustomObject>
...
SigningRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningRequestDtoListEnvelope
