...
CountryStateDtoEnvelope<PSCustomObject>
#>

function Initialize-CountryStateDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryStateDtoEnvelope' | Write-Debug
...
Convert from JSON to CountryStateDtoEnvelope<PSCustomObject>
...
CountryStateDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryStateDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryStateDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryStateDtoEnvelope
