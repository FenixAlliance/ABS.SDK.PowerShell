...
MarketingLeadDtoListEnvelope<PSCustomObject>
#>

function Initialize-MarketingLeadDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingLeadDtoListEnvelope' | Write-Debug
...
Convert from JSON to MarketingLeadDtoListEnvelope<PSCustomObject>
...
MarketingLeadDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingLeadDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingLeadDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingLeadDtoListEnvelope
