...
PaymentTermDtoEnvelope<PSCustomObject>
#>

function Initialize-PaymentTermDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentTermDtoEnvelope' | Write-Debug
...
Convert from JSON to PaymentTermDtoEnvelope<PSCustomObject>
...
PaymentTermDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentTermDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentTermDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentTermDtoEnvelope
