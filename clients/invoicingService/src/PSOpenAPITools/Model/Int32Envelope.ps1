...
Int32Envelope<PSCustomObject>
#>

function Initialize-Int32Envelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Int32Envelope' | Write-Debug
...
Convert from JSON to Int32Envelope<PSCustomObject>
...
Int32Envelope<PSCustomObject>
#>
function ConvertFrom-JsonToInt32Envelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Int32Envelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Int32Envelope
