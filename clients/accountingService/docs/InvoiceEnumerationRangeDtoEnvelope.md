...
```powershell
$InvoiceEnumerationRangeDtoEnvelope = Initialize-PSOpenAPIToolsInvoiceEnumerationRangeDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$InvoiceEnumerationRangeDtoEnvelope | ConvertTo-JSON
```
