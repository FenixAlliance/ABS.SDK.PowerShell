...
TimezoneDtoListEnvelope<PSCustomObject>
#>

function Initialize-TimezoneDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TimezoneDtoListEnvelope' | Write-Debug
...
Convert from JSON to TimezoneDtoListEnvelope<PSCustomObject>
...
TimezoneDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTimezoneDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TimezoneDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TimezoneDtoListEnvelope
