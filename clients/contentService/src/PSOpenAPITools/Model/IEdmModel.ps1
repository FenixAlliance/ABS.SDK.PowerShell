...
function Initialize-IEdmModel {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEdmModel' | Write-Debug
...
IEdmModel<PSCustomObject>
#>
function ConvertFrom-JsonToIEdmModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEdmModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEdmModel
