...
BankAccountDtoEnvelope<PSCustomObject>
#>

function Initialize-BankAccountDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankAccountDtoEnvelope' | Write-Debug
...
Convert from JSON to BankAccountDtoEnvelope<PSCustomObject>
...
BankAccountDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankAccountDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankAccountDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankAccountDtoEnvelope
