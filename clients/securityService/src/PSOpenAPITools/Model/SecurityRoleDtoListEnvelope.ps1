...
SecurityRoleDtoListEnvelope<PSCustomObject>
#>

function Initialize-SecurityRoleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityRoleDtoListEnvelope' | Write-Debug
...
Convert from JSON to SecurityRoleDtoListEnvelope<PSCustomObject>
...
SecurityRoleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityRoleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityRoleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityRoleDtoListEnvelope
