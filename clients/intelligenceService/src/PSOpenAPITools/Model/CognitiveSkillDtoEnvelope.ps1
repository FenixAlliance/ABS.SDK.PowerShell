...
CognitiveSkillDtoEnvelope<PSCustomObject>
#>

function Initialize-CognitiveSkillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CognitiveSkillDtoEnvelope' | Write-Debug
...
Convert from JSON to CognitiveSkillDtoEnvelope<PSCustomObject>
...
CognitiveSkillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCognitiveSkillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CognitiveSkillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CognitiveSkillDtoEnvelope
