...
DealUnitFlowDtoEnvelope<PSCustomObject>
#>

function Initialize-DealUnitFlowDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitFlowDtoEnvelope' | Write-Debug
...
Convert from JSON to DealUnitFlowDtoEnvelope<PSCustomObject>
...
DealUnitFlowDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitFlowDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitFlowDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitFlowDtoEnvelope
