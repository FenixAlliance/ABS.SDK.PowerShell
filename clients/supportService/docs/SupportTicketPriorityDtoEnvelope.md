...
```powershell
$SupportTicketPriorityDtoEnvelope = Initialize-PSOpenAPIToolsSupportTicketPriorityDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$SupportTicketPriorityDtoEnvelope | ConvertTo-JSON
```
