...
LocationDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-LocationDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to LocationDtoIReadOnlyListEnvelope<PSCustomObject>
...
LocationDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLocationDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationDtoIReadOnlyListEnvelope
