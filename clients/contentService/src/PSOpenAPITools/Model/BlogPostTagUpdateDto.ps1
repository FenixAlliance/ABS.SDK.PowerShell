...
BlogPostTagUpdateDto<PSCustomObject>
#>

function Initialize-BlogPostTagUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostTagUpdateDto' | Write-Debug
...
Convert from JSON to BlogPostTagUpdateDto<PSCustomObject>
...
BlogPostTagUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostTagUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostTagUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostTagUpdateDto
