...
OutboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-OutboxMessageDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OutboxMessageDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to OutboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
...
OutboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOutboxMessageDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OutboxMessageDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OutboxMessageDtoIReadOnlyListEnvelope
