...
DealUnitDto<PSCustomObject>
#>

function Initialize-DealUnitDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitDto' | Write-Debug
...
Convert from JSON to DealUnitDto<PSCustomObject>
...
DealUnitDto<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitDto
