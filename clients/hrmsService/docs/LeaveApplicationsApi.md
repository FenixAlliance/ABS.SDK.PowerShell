...
# Patch a leave application
try {
    $Result = Invoke-PatchLeaveApplicationAsync -TenantId $TenantId -LeaveApplicationId $LeaveApplicationId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
