...
ServiceCaseUpdateDto<PSCustomObject>
#>

function Initialize-ServiceCaseUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseUpdateDto' | Write-Debug
...
Convert from JSON to ServiceCaseUpdateDto<PSCustomObject>
...
ServiceCaseUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseUpdateDto
        $AllProperties = ("title", "description", "instructions", "taxable", "workLocation", "serviceId", "serviceQueueId", "serviceCaseTypeId", "serviceLevelAgreementId", "individualId", "organizationId", "accountHolderId", "receiverBusinessId", "currencyId", "territoryId", "priceListId", "promisedStartDate", "promisedEndDate")
