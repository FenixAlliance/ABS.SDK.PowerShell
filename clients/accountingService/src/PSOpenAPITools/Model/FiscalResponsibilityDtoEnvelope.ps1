...
FiscalResponsibilityDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalResponsibilityDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalResponsibilityDtoEnvelope<PSCustomObject>
...
FiscalResponsibilityDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityDtoEnvelope
