...
FiscalIdentificationTypeCreateDto<PSCustomObject>
#>

function Initialize-FiscalIdentificationTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeCreateDto' | Write-Debug
...
Convert from JSON to FiscalIdentificationTypeCreateDto<PSCustomObject>
...
FiscalIdentificationTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalIdentificationTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalIdentificationTypeCreateDto
        $AllProperties = ("id", "timestamp", "code", "name", "fiscalAuthorityId", "tenantId", "enrollmentId")
