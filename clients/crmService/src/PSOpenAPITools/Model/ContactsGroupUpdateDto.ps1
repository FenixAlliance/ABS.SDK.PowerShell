...
ContactsGroupUpdateDto<PSCustomObject>
#>

function Initialize-ContactsGroupUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactsGroupUpdateDto' | Write-Debug
...
Convert from JSON to ContactsGroupUpdateDto<PSCustomObject>
...
ContactsGroupUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactsGroupUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactsGroupUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactsGroupUpdateDto
