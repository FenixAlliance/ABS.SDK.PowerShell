...
TenantTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTypeDtoListEnvelope<PSCustomObject>
...
TenantTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTypeDtoListEnvelope
