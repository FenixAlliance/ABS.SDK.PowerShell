...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for PaymentsService'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{1FC02B82-D244-4971-B97F-6B17A1140736}' # Has to be static, otherwise each new build will be considered different module
