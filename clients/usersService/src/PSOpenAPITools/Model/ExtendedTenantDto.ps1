...
ExtendedTenantDto<PSCustomObject>
#>

function Initialize-ExtendedTenantDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantDto' | Write-Debug
...
Convert from JSON to ExtendedTenantDto<PSCustomObject>
...
ExtendedTenantDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantDto
        $AllProperties = ("id", "timestamp", "qualifiedName", "kind", "taxId", "about", "walletId", "socialFeedId", "businessIndustryId", "businessSegmentId", "socialProfileId", "languageId", "name", "duns", "slogan", "legalName", "coverUrl", "avatarUrl", "cartId", "currencyId", "timezoneId", "countryId", "stateId", "cityId", "email", "phone", "webUrl", "facebookUrl", "twitterUrl", "gitHubUrl", "linkedInUrl", "instagramUrl", "youTubeUrl", "whatsAppNumber", "supportPhoneNumber", "verified", "businessName", "businessLegalName", "twitterUsername", "cart", "wallet", "socialProfile")
