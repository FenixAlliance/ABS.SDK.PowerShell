...
SupportRequestDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportRequestDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportRequestDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportRequestDtoEnvelope<PSCustomObject>
...
SupportRequestDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportRequestDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportRequestDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportRequestDtoEnvelope
