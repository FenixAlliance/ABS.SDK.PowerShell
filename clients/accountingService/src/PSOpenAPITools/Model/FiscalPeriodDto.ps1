...
function Initialize-FiscalPeriodDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalPeriodDto' | Write-Debug
...
Convert from JSON to FiscalPeriodDto<PSCustomObject>
...
FiscalPeriodDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalPeriodDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalPeriodDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
