...
# Patch an email template
try {
    $Result = Invoke-PatchEmailTemplateAsync -TenantId $TenantId -EmailTemplateId $EmailTemplateId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
