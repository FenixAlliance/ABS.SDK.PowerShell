...
WalletWithdrawRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-WalletWithdrawRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WalletWithdrawRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to WalletWithdrawRequestDtoListEnvelope<PSCustomObject>
...
WalletWithdrawRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWalletWithdrawRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WalletWithdrawRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WalletWithdrawRequestDtoListEnvelope
