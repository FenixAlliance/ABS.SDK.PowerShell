...
[**Invoke-PatchPaymentModeAsync**](PaymentModesApi.md#Invoke-PatchPaymentModeAsync) | **PATCH** /api/v2/PaymentsService/PaymentModes/{paymentModeId} | Patch a payment mode
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PaymentModeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$PaymentModeDtoCollectionQueryParameters = Initialize-PaymentModeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # PaymentModeDtoCollectionQueryParameters |  (optional)

# Retrieves all payment modes
try {
    $Result = Get-PaymentModesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PaymentModeDtoCollectionQueryParameters $PaymentModeDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **PaymentModeDtoCollectionQueryParameters** | [**PaymentModeDtoCollectionQueryParameters**](PaymentModeDtoCollectionQueryParameters.md)|  | [optional] 
...
# Counts payment modes
try {
    $Result = Get-PaymentModesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PaymentModeDtoCollectionQueryParameters $PaymentModeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchPaymentModeAsync"></a>
# **Invoke-PatchPaymentModeAsync**
> EmptyEnvelope Invoke-PatchPaymentModeAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PaymentModeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a payment mode
try {
    $Result = Invoke-PatchPaymentModeAsync -TenantId $TenantId -PaymentModeId $PaymentModeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchPaymentModeAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
