...
KnowledgeArticleDtoListEnvelope<PSCustomObject>
#>

function Initialize-KnowledgeArticleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KnowledgeArticleDtoListEnvelope' | Write-Debug
...
Convert from JSON to KnowledgeArticleDtoListEnvelope<PSCustomObject>
...
KnowledgeArticleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToKnowledgeArticleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KnowledgeArticleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KnowledgeArticleDtoListEnvelope
