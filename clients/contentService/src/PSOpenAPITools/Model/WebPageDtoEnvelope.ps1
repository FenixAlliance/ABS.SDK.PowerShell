...
WebPageDtoEnvelope<PSCustomObject>
#>

function Initialize-WebPageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageDtoEnvelope' | Write-Debug
...
Convert from JSON to WebPageDtoEnvelope<PSCustomObject>
...
WebPageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageDtoEnvelope
