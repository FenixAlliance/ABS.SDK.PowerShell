...
ShiftDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShiftDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShiftDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShiftDtoListEnvelope<PSCustomObject>
...
ShiftDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShiftDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShiftDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShiftDtoListEnvelope
