...
BudgetDtoEnvelope<PSCustomObject>
#>

function Initialize-BudgetDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BudgetDtoEnvelope' | Write-Debug
...
Convert from JSON to BudgetDtoEnvelope<PSCustomObject>
...
BudgetDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBudgetDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BudgetDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BudgetDtoEnvelope
