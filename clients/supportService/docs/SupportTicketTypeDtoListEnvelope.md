...
```powershell
$SupportTicketTypeDtoListEnvelope = Initialize-PSOpenAPIToolsSupportTicketTypeDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$SupportTicketTypeDtoListEnvelope | ConvertTo-JSON
```
