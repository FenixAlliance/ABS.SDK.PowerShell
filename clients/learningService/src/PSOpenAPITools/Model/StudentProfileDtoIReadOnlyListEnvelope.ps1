...
StudentProfileDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-StudentProfileDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StudentProfileDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to StudentProfileDtoIReadOnlyListEnvelope<PSCustomObject>
...
StudentProfileDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStudentProfileDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StudentProfileDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StudentProfileDtoIReadOnlyListEnvelope
