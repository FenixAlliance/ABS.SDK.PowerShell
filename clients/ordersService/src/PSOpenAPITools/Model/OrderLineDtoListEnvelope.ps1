...
OrderLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-OrderLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to OrderLineDtoListEnvelope<PSCustomObject>
...
OrderLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOrderLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderLineDtoListEnvelope
