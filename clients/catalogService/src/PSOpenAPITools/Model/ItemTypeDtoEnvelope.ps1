...
ItemTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemTypeDtoEnvelope<PSCustomObject>
...
ItemTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTypeDtoEnvelope
