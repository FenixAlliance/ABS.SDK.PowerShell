...
BlogPostDto<PSCustomObject>
#>

function Initialize-BlogPostDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostDto' | Write-Debug
...
Convert from JSON to BlogPostDto<PSCustomObject>
...
BlogPostDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
