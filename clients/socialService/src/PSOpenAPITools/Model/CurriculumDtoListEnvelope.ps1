...
CurriculumDtoListEnvelope<PSCustomObject>
#>

function Initialize-CurriculumDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurriculumDtoListEnvelope' | Write-Debug
...
Convert from JSON to CurriculumDtoListEnvelope<PSCustomObject>
...
CurriculumDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurriculumDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurriculumDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurriculumDtoListEnvelope
