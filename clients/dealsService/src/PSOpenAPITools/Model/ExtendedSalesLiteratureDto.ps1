...
function ConvertFrom-JsonToExtendedSalesLiteratureDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "title", "content", "description", "modifiedDate", "expirationDate", "tenantId", "enrollmentId", "salesLiteratureTypeId", "salesLiteratureType", "tenant")
