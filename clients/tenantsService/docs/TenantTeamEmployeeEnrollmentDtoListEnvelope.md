...
```powershell
$TenantTeamEmployeeEnrollmentDtoListEnvelope = Initialize-PSOpenAPIToolsTenantTeamEmployeeEnrollmentDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TenantTeamEmployeeEnrollmentDtoListEnvelope | ConvertTo-JSON
```
