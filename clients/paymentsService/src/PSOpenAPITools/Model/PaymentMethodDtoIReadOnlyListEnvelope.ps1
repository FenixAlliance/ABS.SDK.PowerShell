...
PaymentMethodDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-PaymentMethodDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentMethodDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to PaymentMethodDtoIReadOnlyListEnvelope<PSCustomObject>
...
PaymentMethodDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentMethodDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentMethodDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentMethodDtoIReadOnlyListEnvelope
