...
Int32Envelope
#>
function Invoke-CountCallingCodesByCountryAsync {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-CountCallingCodesByCountryAsync' | Write-Debug
...
Int32Envelope
#>
function Invoke-CountCitiesByStateAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-CountCitiesByStateAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$CountryId) {
            throw "Error! The required parameter `CountryId` missing when calling countCitiesByStateAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{countryId}', [System.Web.HTTPUtility]::UrlEncode($CountryId))
...
Int32Envelope
#>
function Invoke-CountCountryStatesAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-CountCountryStatesAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Int32Envelope
#>
function Invoke-CountTimezonesByCountryAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-CountTimezonesByCountryAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Int32Envelope
#>
function Invoke-CountTopLevelDomainsByCountryAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-CountTopLevelDomainsByCountryAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
