...
[**Invoke-PatchWebTemplateAsync**](WebTemplatesApi.md#Invoke-PatchWebTemplateAsync) | **PATCH** /api/v2/ContentService/WebTemplates/{webTemplateId} | Patch a web template
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WebTemplateDtoCollectionQueryParameters] <PSCustomObject><br>
...
$WebTemplateDtoCollectionQueryParameters = Initialize-WebTemplateDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # WebTemplateDtoCollectionQueryParameters |  (optional)

# Count web templates
try {
    $Result = Invoke-CountWebTemplatesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -WebTemplateDtoCollectionQueryParameters $WebTemplateDtoCollectionQueryParameters
} catch {
...
# Get web templates
try {
    $Result = Get-WebTemplatesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -WebTemplateDtoCollectionQueryParameters $WebTemplateDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchWebTemplateAsync"></a>
# **Invoke-PatchWebTemplateAsync**
> void Invoke-PatchWebTemplateAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WebTemplateId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a web template
try {
    $Result = Invoke-PatchWebTemplateAsync -TenantId $TenantId -WebTemplateId $WebTemplateId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchWebTemplateAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
