...
GrantDtoEnvelope<PSCustomObject>
#>

function Initialize-GrantDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GrantDtoEnvelope' | Write-Debug
...
Convert from JSON to GrantDtoEnvelope<PSCustomObject>
...
GrantDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGrantDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GrantDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GrantDtoEnvelope
