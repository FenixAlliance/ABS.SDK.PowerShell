...
RailWaybillDtoEnvelope<PSCustomObject>
#>

function Initialize-RailWaybillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RailWaybillDtoEnvelope' | Write-Debug
...
Convert from JSON to RailWaybillDtoEnvelope<PSCustomObject>
...
RailWaybillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRailWaybillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RailWaybillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RailWaybillDtoEnvelope
