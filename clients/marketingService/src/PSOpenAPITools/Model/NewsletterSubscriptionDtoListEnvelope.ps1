...
NewsletterSubscriptionDtoListEnvelope<PSCustomObject>
#>

function Initialize-NewsletterSubscriptionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NewsletterSubscriptionDtoListEnvelope' | Write-Debug
...
Convert from JSON to NewsletterSubscriptionDtoListEnvelope<PSCustomObject>
...
NewsletterSubscriptionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNewsletterSubscriptionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NewsletterSubscriptionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NewsletterSubscriptionDtoListEnvelope
