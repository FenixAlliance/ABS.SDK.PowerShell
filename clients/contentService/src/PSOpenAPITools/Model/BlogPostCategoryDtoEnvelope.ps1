...
BlogPostCategoryDtoEnvelope<PSCustomObject>
#>

function Initialize-BlogPostCategoryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostCategoryDtoEnvelope' | Write-Debug
...
Convert from JSON to BlogPostCategoryDtoEnvelope<PSCustomObject>
...
BlogPostCategoryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostCategoryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostCategoryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostCategoryDtoEnvelope
