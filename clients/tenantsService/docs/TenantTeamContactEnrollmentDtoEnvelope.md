...
```powershell
$TenantTeamContactEnrollmentDtoEnvelope = Initialize-PSOpenAPIToolsTenantTeamContactEnrollmentDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TenantTeamContactEnrollmentDtoEnvelope | ConvertTo-JSON
```
