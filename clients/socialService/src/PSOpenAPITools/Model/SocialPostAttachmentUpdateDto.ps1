...
SocialPostAttachmentUpdateDto<PSCustomObject>
#>

function Initialize-SocialPostAttachmentUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostAttachmentUpdateDto' | Write-Debug
...
Convert from JSON to SocialPostAttachmentUpdateDto<PSCustomObject>
...
SocialPostAttachmentUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostAttachmentUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostAttachmentUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostAttachmentUpdateDto
        $AllProperties = ("notes", "metadata", "title", "author", "isFolder", "fileName", "abstract", "keyWords", "validResponse", "parentFileUploadID", "filePath")
