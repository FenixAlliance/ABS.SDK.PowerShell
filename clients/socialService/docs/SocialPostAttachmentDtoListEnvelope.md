...
```powershell
$SocialPostAttachmentDtoListEnvelope = Initialize-PSOpenAPIToolsSocialPostAttachmentDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$SocialPostAttachmentDtoListEnvelope | ConvertTo-JSON
```
