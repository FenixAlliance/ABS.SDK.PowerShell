...
LoanDtoEnvelope<PSCustomObject>
#>

function Initialize-LoanDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanDtoEnvelope' | Write-Debug
...
Convert from JSON to LoanDtoEnvelope<PSCustomObject>
...
LoanDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoanDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanDtoEnvelope
