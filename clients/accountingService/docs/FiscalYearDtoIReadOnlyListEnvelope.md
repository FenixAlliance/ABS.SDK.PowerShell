...
```powershell
$FiscalYearDtoIReadOnlyListEnvelope = Initialize-PSOpenAPIToolsFiscalYearDtoIReadOnlyListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$FiscalYearDtoIReadOnlyListEnvelope | ConvertTo-JSON
```
