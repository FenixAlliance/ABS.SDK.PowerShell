...
AccountTypeUpdateDto<PSCustomObject>
#>

function Initialize-AccountTypeUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountTypeUpdateDto' | Write-Debug
...
Convert from JSON to AccountTypeUpdateDto<PSCustomObject>
...
AccountTypeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAccountTypeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountTypeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountTypeUpdateDto
        $AllProperties = ("name", "description", "tenantId", "enrollmentId")
