...
CostCentreBudgetDtoListEnvelope<PSCustomObject>
#>

function Initialize-CostCentreBudgetDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreBudgetDtoListEnvelope' | Write-Debug
...
Convert from JSON to CostCentreBudgetDtoListEnvelope<PSCustomObject>
...
CostCentreBudgetDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreBudgetDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreBudgetDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreBudgetDtoListEnvelope
