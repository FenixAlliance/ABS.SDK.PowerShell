...
ShippingZoneDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingZoneDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingZoneDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingZoneDtoEnvelope<PSCustomObject>
...
ShippingZoneDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingZoneDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingZoneDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingZoneDtoEnvelope
