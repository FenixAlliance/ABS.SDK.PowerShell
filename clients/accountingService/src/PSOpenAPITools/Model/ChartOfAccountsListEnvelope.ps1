...
ChartOfAccountsListEnvelope<PSCustomObject>
#>

function Initialize-ChartOfAccountsListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ChartOfAccountsListEnvelope' | Write-Debug
...
Convert from JSON to ChartOfAccountsListEnvelope<PSCustomObject>
...
ChartOfAccountsListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToChartOfAccountsListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ChartOfAccountsListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChartOfAccountsListEnvelope
