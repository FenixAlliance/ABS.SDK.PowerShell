...
function ConvertFrom-JsonToPriceListDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "name", "startDate", "endDate", "description", "currencyId", "tenantId", "unitId", "unitGroupId", "partnerVisible", "unitOfMeasureDependant", "enrollmentId")
