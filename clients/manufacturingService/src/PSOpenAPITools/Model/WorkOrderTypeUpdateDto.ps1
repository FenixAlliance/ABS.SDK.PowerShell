...
WorkOrderTypeUpdateDto<PSCustomObject>
#>

function Initialize-WorkOrderTypeUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WorkOrderTypeUpdateDto' | Write-Debug
...
Convert from JSON to WorkOrderTypeUpdateDto<PSCustomObject>
...
WorkOrderTypeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWorkOrderTypeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WorkOrderTypeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkOrderTypeUpdateDto
