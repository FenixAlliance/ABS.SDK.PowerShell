...
InquiryRequestDtoEnvelope<PSCustomObject>
#>

function Initialize-InquiryRequestDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InquiryRequestDtoEnvelope' | Write-Debug
...
Convert from JSON to InquiryRequestDtoEnvelope<PSCustomObject>
...
InquiryRequestDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInquiryRequestDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InquiryRequestDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InquiryRequestDtoEnvelope
