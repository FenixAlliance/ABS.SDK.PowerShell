...
CostCentreBudgetDtoEnvelope<PSCustomObject>
#>

function Initialize-CostCentreBudgetDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreBudgetDtoEnvelope' | Write-Debug
...
Convert from JSON to CostCentreBudgetDtoEnvelope<PSCustomObject>
...
CostCentreBudgetDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreBudgetDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreBudgetDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreBudgetDtoEnvelope
