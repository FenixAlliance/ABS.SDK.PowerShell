...
SupportEntitlementDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportEntitlementDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportEntitlementDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportEntitlementDtoListEnvelope<PSCustomObject>
...
SupportEntitlementDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportEntitlementDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportEntitlementDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportEntitlementDtoListEnvelope
