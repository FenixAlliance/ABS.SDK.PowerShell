...
ProofOfDeliveryLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProofOfDeliveryLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProofOfDeliveryLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProofOfDeliveryLineDtoListEnvelope<PSCustomObject>
...
ProofOfDeliveryLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProofOfDeliveryLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProofOfDeliveryLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProofOfDeliveryLineDtoListEnvelope
