...
ApplicationPrincipalDtoListEnvelope<PSCustomObject>
#>

function Initialize-ApplicationPrincipalDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationPrincipalDtoListEnvelope' | Write-Debug
...
Convert from JSON to ApplicationPrincipalDtoListEnvelope<PSCustomObject>
...
ApplicationPrincipalDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationPrincipalDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationPrincipalDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationPrincipalDtoListEnvelope
