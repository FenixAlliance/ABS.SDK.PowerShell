...
ProjectTaskDtoEnvelope<PSCustomObject>
#>

function Initialize-ProjectTaskDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectTaskDtoEnvelope' | Write-Debug
...
Convert from JSON to ProjectTaskDtoEnvelope<PSCustomObject>
...
ProjectTaskDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectTaskDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectTaskDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectTaskDtoEnvelope
