...
TenantTeamEmployeeEnrollmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTeamEmployeeEnrollmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTeamEmployeeEnrollmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTeamEmployeeEnrollmentDtoListEnvelope<PSCustomObject>
...
TenantTeamEmployeeEnrollmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTeamEmployeeEnrollmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTeamEmployeeEnrollmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTeamEmployeeEnrollmentDtoListEnvelope
