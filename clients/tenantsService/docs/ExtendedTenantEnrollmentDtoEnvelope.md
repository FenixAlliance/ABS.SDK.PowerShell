...
```powershell
$ExtendedTenantEnrollmentDtoEnvelope = Initialize-PSOpenAPIToolsExtendedTenantEnrollmentDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ExtendedTenantEnrollmentDtoEnvelope | ConvertTo-JSON
```
