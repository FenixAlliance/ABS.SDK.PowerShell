...
ReceiptDtoEnvelope<PSCustomObject>
#>

function Initialize-ReceiptDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReceiptDtoEnvelope' | Write-Debug
...
Convert from JSON to ReceiptDtoEnvelope<PSCustomObject>
...
ReceiptDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToReceiptDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReceiptDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReceiptDtoEnvelope
