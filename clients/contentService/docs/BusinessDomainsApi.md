...
# Get business domains
try {
    $Result = Get-BusinessDomainsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -BusinessDomainDtoCollectionQueryParameters $BusinessDomainDtoCollectionQueryParameters
} catch {
...
# Get business domains count
try {
    $Result = Get-BusinessDomainsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -BusinessDomainDtoCollectionQueryParameters $BusinessDomainDtoCollectionQueryParameters
} catch {
