...
OrderDtoListEnvelope<PSCustomObject>
#>

function Initialize-OrderDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderDtoListEnvelope' | Write-Debug
...
Convert from JSON to OrderDtoListEnvelope<PSCustomObject>
...
OrderDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOrderDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderDtoListEnvelope
