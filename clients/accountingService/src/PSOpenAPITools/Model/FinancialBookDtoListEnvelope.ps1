...
FinancialBookDtoListEnvelope<PSCustomObject>
#>

function Initialize-FinancialBookDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FinancialBookDtoListEnvelope' | Write-Debug
...
Convert from JSON to FinancialBookDtoListEnvelope<PSCustomObject>
...
FinancialBookDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFinancialBookDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FinancialBookDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FinancialBookDtoListEnvelope
