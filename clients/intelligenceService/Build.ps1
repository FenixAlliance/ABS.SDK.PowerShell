...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for IntelligenceService'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{DE1BFA24-7557-4F9C-9151-2BFA578ECA5F}' # Has to be static, otherwise each new build will be considered different module
