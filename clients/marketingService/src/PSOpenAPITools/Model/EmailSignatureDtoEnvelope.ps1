...
EmailSignatureDtoEnvelope<PSCustomObject>
#>

function Initialize-EmailSignatureDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailSignatureDtoEnvelope' | Write-Debug
...
Convert from JSON to EmailSignatureDtoEnvelope<PSCustomObject>
...
EmailSignatureDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailSignatureDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailSignatureDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailSignatureDtoEnvelope
