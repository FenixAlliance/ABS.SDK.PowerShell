...
InvoiceAdjustmentDtoEnvelope<PSCustomObject>
#>

function Initialize-InvoiceAdjustmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceAdjustmentDtoEnvelope' | Write-Debug
...
Convert from JSON to InvoiceAdjustmentDtoEnvelope<PSCustomObject>
...
InvoiceAdjustmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceAdjustmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceAdjustmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceAdjustmentDtoEnvelope
