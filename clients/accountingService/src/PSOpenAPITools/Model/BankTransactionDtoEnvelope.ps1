...
BankTransactionDtoEnvelope<PSCustomObject>
#>

function Initialize-BankTransactionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankTransactionDtoEnvelope' | Write-Debug
...
Convert from JSON to BankTransactionDtoEnvelope<PSCustomObject>
...
BankTransactionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankTransactionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankTransactionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankTransactionDtoEnvelope
