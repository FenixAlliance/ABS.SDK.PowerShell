...
CartDtoListEnvelope<PSCustomObject>
#>

function Initialize-CartDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CartDtoListEnvelope' | Write-Debug
...
Convert from JSON to CartDtoListEnvelope<PSCustomObject>
...
CartDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCartDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CartDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CartDtoListEnvelope
