...
.PARAMETER NetSalary
No description available.
.PARAMETER PayrollCurrency
No description available.
.PARAMETER MaxWorkHoursPerDay
No description available.
...
EmployeeProfileUpdateDto<PSCustomObject>
#>

function Initialize-EmployeeProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeProfileUpdateDto' | Write-Debug
...
Convert from JSON to EmployeeProfileUpdateDto<PSCustomObject>
...
EmployeeProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeProfileUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeProfileUpdateDto
        $AllProperties = ("type", "contactId", "about", "avatarUrl", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "grossPay", "netSalary", "payrollCurrency", "maxWorkHoursPerDay", "jobTitleId", "employeeTypeId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "payrollCurrency"))) { #optional property not found
            $PayrollCurrency = $null
        } else {
            $PayrollCurrency = $JsonParameters.PSobject.Properties["payrollCurrency"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "maxWorkHoursPerDay"))) { #optional property not found
            $MaxWorkHoursPerDay = $null
        } else {
            $MaxWorkHoursPerDay = $JsonParameters.PSobject.Properties["maxWorkHoursPerDay"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "jobTitleId"))) { #optional property not found
            $JobTitleId = $null
        } else {
            $JobTitleId = $JsonParameters.PSobject.Properties["jobTitleId"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "employeeTypeId"))) { #optional property not found
            $EmployeeTypeId = $null
        } else {
            $EmployeeTypeId = $JsonParameters.PSobject.Properties["employeeTypeId"].value
        }
