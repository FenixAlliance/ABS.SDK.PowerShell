...
ExtendedContactDtoEnvelope<PSCustomObject>
#>

function Initialize-ExtendedContactDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedContactDtoEnvelope' | Write-Debug
...
Convert from JSON to ExtendedContactDtoEnvelope<PSCustomObject>
...
ExtendedContactDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedContactDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedContactDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedContactDtoEnvelope
