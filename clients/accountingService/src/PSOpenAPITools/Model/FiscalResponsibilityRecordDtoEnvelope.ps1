...
FiscalResponsibilityRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalResponsibilityRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalResponsibilityRecordDtoEnvelope<PSCustomObject>
...
FiscalResponsibilityRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityRecordDtoEnvelope
