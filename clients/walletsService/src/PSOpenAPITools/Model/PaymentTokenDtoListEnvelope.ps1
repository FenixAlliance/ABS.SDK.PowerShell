...
PaymentTokenDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentTokenDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentTokenDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentTokenDtoListEnvelope<PSCustomObject>
...
PaymentTokenDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentTokenDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentTokenDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentTokenDtoListEnvelope
