...
TruckDtoListEnvelope<PSCustomObject>
#>

function Initialize-TruckDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TruckDtoListEnvelope' | Write-Debug
...
Convert from JSON to TruckDtoListEnvelope<PSCustomObject>
...
TruckDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTruckDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TruckDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TruckDtoListEnvelope
