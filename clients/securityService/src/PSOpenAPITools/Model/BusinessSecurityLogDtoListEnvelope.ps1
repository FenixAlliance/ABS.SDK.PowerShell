...
BusinessSecurityLogDtoListEnvelope<PSCustomObject>
#>

function Initialize-BusinessSecurityLogDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessSecurityLogDtoListEnvelope' | Write-Debug
...
Convert from JSON to BusinessSecurityLogDtoListEnvelope<PSCustomObject>
...
BusinessSecurityLogDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessSecurityLogDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessSecurityLogDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessSecurityLogDtoListEnvelope
