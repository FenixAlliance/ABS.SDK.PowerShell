...
SystemOverviewDtoEnvelope<PSCustomObject>
#>

function Initialize-SystemOverviewDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemOverviewDtoEnvelope' | Write-Debug
...
Convert from JSON to SystemOverviewDtoEnvelope<PSCustomObject>
...
SystemOverviewDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSystemOverviewDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemOverviewDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemOverviewDtoEnvelope
