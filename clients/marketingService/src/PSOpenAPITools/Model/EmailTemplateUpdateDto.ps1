...
EmailTemplateUpdateDto<PSCustomObject>
#>

function Initialize-EmailTemplateUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailTemplateUpdateDto' | Write-Debug
...
Convert from JSON to EmailTemplateUpdateDto<PSCustomObject>
...
EmailTemplateUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmailTemplateUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailTemplateUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailTemplateUpdateDto
