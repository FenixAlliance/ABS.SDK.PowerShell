...
**Result** | [**ModuleGrantDto[]**](ModuleGrantDto.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$ModuleGrantDtoListEnvelope = Initialize-PSOpenAPIToolsModuleGrantDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$ModuleGrantDtoListEnvelope | ConvertTo-JSON
```
