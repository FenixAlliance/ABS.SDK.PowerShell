...
BlogAuthorDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlogAuthorDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogAuthorDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlogAuthorDtoListEnvelope<PSCustomObject>
...
BlogAuthorDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogAuthorDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogAuthorDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogAuthorDtoListEnvelope
