...
```powershell
$SecurityPermissionDtoListEnvelope = Initialize-PSOpenAPIToolsSecurityPermissionDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$SecurityPermissionDtoListEnvelope | ConvertTo-JSON
```
