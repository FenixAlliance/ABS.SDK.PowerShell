...
```powershell
$ItemPickListEntryDtoListEnvelope = Initialize-PSOpenAPIToolsItemPickListEntryDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ItemPickListEntryDtoListEnvelope | ConvertTo-JSON
```
