...
function ConvertFrom-JsonToProjectTimeLogDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "projectId", "projectTaskId", "taskCategoryId", "projectPeriodId", "responsibleContactId", "creatorContactId", "recordType", "timeSpan", "logDate", "comments", "type")
