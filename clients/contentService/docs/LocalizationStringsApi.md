...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-LocalizationStringDtoCollectionQueryParameters] <PSCustomObject><br>
...
$LocalizationStringDtoCollectionQueryParameters = Initialize-LocalizationStringDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # LocalizationStringDtoCollectionQueryParameters |  (optional)

# Count localization strings
try {
    $Result = Invoke-CountLocalizationStringsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -LocalizationStringDtoCollectionQueryParameters $LocalizationStringDtoCollectionQueryParameters
} catch {
...
# Get localization strings
try {
    $Result = Get-LocalizationStringsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -LocalizationStringDtoCollectionQueryParameters $LocalizationStringDtoCollectionQueryParameters
} catch {
