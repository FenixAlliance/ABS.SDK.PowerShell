...
AirwayBillDtoEnvelope<PSCustomObject>
#>

function Initialize-AirwayBillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AirwayBillDtoEnvelope' | Write-Debug
...
Convert from JSON to AirwayBillDtoEnvelope<PSCustomObject>
...
AirwayBillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAirwayBillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AirwayBillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AirwayBillDtoEnvelope
