...
ShareTransferReasonDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShareTransferReasonDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferReasonDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShareTransferReasonDtoListEnvelope<PSCustomObject>
...
ShareTransferReasonDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferReasonDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferReasonDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareTransferReasonDtoListEnvelope
