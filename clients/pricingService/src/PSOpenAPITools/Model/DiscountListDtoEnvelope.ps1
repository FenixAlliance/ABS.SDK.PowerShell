...
DiscountListDtoEnvelope<PSCustomObject>
#>

function Initialize-DiscountListDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DiscountListDtoEnvelope' | Write-Debug
...
Convert from JSON to DiscountListDtoEnvelope<PSCustomObject>
...
DiscountListDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDiscountListDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DiscountListDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiscountListDtoEnvelope
