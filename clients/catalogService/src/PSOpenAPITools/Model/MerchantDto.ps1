...
No description available.
.PARAMETER MerchantRating
No description available.
.OUTPUTS

MerchantDto<PSCustomObject>
#>

function Initialize-MerchantDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MerchantDto' | Write-Debug
...
Convert from JSON to MerchantDto<PSCustomObject>
...
MerchantDto<PSCustomObject>
#>
function ConvertFrom-JsonToMerchantDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MerchantDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MerchantDto
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "productsCount"))) { #optional property not found
            $ProductsCount = $null
        } else {
            $ProductsCount = $JsonParameters.PSobject.Properties["productsCount"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "merchantRating"))) { #optional property not found
            $MerchantRating = $null
        } else {
            $MerchantRating = $JsonParameters.PSobject.Properties["merchantRating"].value
        }
