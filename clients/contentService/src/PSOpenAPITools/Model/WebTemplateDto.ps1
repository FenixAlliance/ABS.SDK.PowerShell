...
WebTemplateDto<PSCustomObject>
#>

function Initialize-WebTemplateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebTemplateDto' | Write-Debug
...
Convert from JSON to WebTemplateDto<PSCustomObject>
...
WebTemplateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebTemplateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebTemplateDto
        $AllProperties = ("id", "timestamp", "slug", "name", "title", "description", "content", "htmlContent", "cssContent", "jsContent", "razorContent", "highlightImage", "order", "tenantId", "enrollmentId")
