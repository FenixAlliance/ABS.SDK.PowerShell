...
function ConvertFrom-JsonToQuoteCreateDto {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "quoteLines"))) { #optional property not found
            $QuoteLines = $null
        } else {
            $QuoteLines = $JsonParameters.PSobject.Properties["quoteLines"].value
        }
