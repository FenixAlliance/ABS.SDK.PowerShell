...
UserCreateDtoEnvelope<PSCustomObject>
#>

function Initialize-UserCreateDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserCreateDtoEnvelope' | Write-Debug
...
Convert from JSON to UserCreateDtoEnvelope<PSCustomObject>
...
UserCreateDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUserCreateDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserCreateDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserCreateDtoEnvelope
