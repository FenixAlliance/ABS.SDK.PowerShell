...
SupplierProfileDtoEnvelope<PSCustomObject>
#>

function Initialize-SupplierProfileDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupplierProfileDtoEnvelope' | Write-Debug
...
Convert from JSON to SupplierProfileDtoEnvelope<PSCustomObject>
...
SupplierProfileDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupplierProfileDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupplierProfileDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupplierProfileDtoEnvelope
