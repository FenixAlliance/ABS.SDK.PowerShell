...
DiscountDtoListEnvelope<PSCustomObject>
#>

function Initialize-DiscountDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DiscountDtoListEnvelope' | Write-Debug
...
Convert from JSON to DiscountDtoListEnvelope<PSCustomObject>
...
DiscountDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDiscountDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DiscountDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiscountDtoListEnvelope
