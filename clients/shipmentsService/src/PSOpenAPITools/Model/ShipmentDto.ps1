...
function ConvertFrom-JsonToShipmentDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "trackingCode", "isInternational", "shipped", "delivered", "shipmentTimestamp", "deliveryTimestamp", "expectedShippingDate", "expectedDeliveryDate", "shippingTerms", "orderId", "tenantId", "sellerBillingProfileId", "buyerBillingProfileId")
