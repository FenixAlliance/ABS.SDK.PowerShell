...
SalesLiteratureDtoEnvelope<PSCustomObject>
#>

function Initialize-SalesLiteratureDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SalesLiteratureDtoEnvelope' | Write-Debug
...
Convert from JSON to SalesLiteratureDtoEnvelope<PSCustomObject>
...
SalesLiteratureDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSalesLiteratureDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SalesLiteratureDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SalesLiteratureDtoEnvelope
