...
# Retrieve a list of return policies
try {
    $Result = Get-ReturnPoliciesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemReturnPolicyDtoCollectionQueryParameters $ItemReturnPolicyDtoCollectionQueryParameters
} catch {
...
# Get the count of return policies
try {
    $Result = Get-ReturnPoliciesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemReturnPolicyDtoCollectionQueryParameters $ItemReturnPolicyDtoCollectionQueryParameters
} catch {
...
# Patch a return policy
try {
    $Result = Invoke-PatchReturnPolicyAsync -TenantId $TenantId -ReturnPolicyId $ReturnPolicyId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
