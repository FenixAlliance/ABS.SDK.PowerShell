...
**Result** | [**AiProviderDto[]**](AiProviderDto.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$AiProviderDtoListEnvelope = Initialize-PSOpenAPIToolsAiProviderDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$AiProviderDtoListEnvelope | ConvertTo-JSON
```
