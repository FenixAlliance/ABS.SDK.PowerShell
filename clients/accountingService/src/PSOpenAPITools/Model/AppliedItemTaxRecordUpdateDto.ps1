...
AppliedItemTaxRecordUpdateDto<PSCustomObject>
#>

function Initialize-AppliedItemTaxRecordUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppliedItemTaxRecordUpdateDto' | Write-Debug
...
Convert from JSON to AppliedItemTaxRecordUpdateDto<PSCustomObject>
...
AppliedItemTaxRecordUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAppliedItemTaxRecordUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppliedItemTaxRecordUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppliedItemTaxRecordUpdateDto
        $AllProperties = ("taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD", "billingItemRecordId")
