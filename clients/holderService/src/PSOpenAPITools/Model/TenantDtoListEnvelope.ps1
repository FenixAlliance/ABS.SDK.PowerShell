...
TenantDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantDtoListEnvelope<PSCustomObject>
...
TenantDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantDtoListEnvelope
