...
LogDtoListEnvelope<PSCustomObject>
#>

function Initialize-LogDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogDtoListEnvelope' | Write-Debug
...
Convert from JSON to LogDtoListEnvelope<PSCustomObject>
...
LogDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLogDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogDtoListEnvelope
