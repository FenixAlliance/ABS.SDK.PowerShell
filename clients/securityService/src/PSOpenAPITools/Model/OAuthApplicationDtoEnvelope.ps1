...
OAuthApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-OAuthApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OAuthApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to OAuthApplicationDtoEnvelope<PSCustomObject>
...
OAuthApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOAuthApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OAuthApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OAuthApplicationDtoEnvelope
