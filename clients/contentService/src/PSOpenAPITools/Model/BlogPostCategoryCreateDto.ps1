...
BlogPostCategoryCreateDto<PSCustomObject>
#>

function Initialize-BlogPostCategoryCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostCategoryCreateDto' | Write-Debug
...
Convert from JSON to BlogPostCategoryCreateDto<PSCustomObject>
...
BlogPostCategoryCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostCategoryCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostCategoryCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostCategoryCreateDto
