...
```powershell
$ServiceLevelDtoIReadOnlyListEnvelope = Initialize-PSOpenAPIToolsServiceLevelDtoIReadOnlyListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$ServiceLevelDtoIReadOnlyListEnvelope | ConvertTo-JSON
```
