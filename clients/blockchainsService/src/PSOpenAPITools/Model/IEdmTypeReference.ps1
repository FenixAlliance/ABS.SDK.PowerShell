...
function Initialize-IEdmTypeReference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEdmTypeReference' | Write-Debug
...
IEdmTypeReference<PSCustomObject>
#>
function ConvertFrom-JsonToIEdmTypeReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEdmTypeReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEdmTypeReference
