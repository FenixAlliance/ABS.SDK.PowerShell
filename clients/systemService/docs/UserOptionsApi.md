...
# Retrieve a list of user options (admin)
try {
    $Result = Get-SystemUserOptions -UserId $UserId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Get the count of user options (admin)
try {
    $Result = Get-SystemUserOptionsCount -UserId $UserId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Partially update a user option (admin)
try {
    $Result = Invoke-PatchSystemUserOption -UserId $UserId -OptionId $OptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
