...
ShareTransferReasonDtoEnvelope<PSCustomObject>
#>

function Initialize-ShareTransferReasonDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferReasonDtoEnvelope' | Write-Debug
...
Convert from JSON to ShareTransferReasonDtoEnvelope<PSCustomObject>
...
ShareTransferReasonDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferReasonDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferReasonDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareTransferReasonDtoEnvelope
