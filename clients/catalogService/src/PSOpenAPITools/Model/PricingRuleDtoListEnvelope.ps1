...
PricingRuleDtoListEnvelope<PSCustomObject>
#>

function Initialize-PricingRuleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PricingRuleDtoListEnvelope' | Write-Debug
...
Convert from JSON to PricingRuleDtoListEnvelope<PSCustomObject>
...
PricingRuleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPricingRuleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PricingRuleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PricingRuleDtoListEnvelope
