...
EmployeeTypeCreateDto<PSCustomObject>
#>

function Initialize-EmployeeTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeTypeCreateDto' | Write-Debug
...
Convert from JSON to EmployeeTypeCreateDto<PSCustomObject>
...
EmployeeTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeTypeCreateDto
