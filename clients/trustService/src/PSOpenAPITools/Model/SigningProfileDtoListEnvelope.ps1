...
SigningProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningProfileDtoListEnvelope<PSCustomObject>
...
SigningProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningProfileDtoListEnvelope
