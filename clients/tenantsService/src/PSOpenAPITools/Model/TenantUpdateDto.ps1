...
function ConvertFrom-JsonToTenantUpdateDto {
    ...
    Process {
        ...
        $AllProperties = ("kind", "name", "legalName", "email", "phone", "webUrl", "about", "slogan", "handler", "currencyId", "duns", "taxId", "avatarUrl", "twitterUsername", "facebookUrl", "twitterUrl", "gitHubUrl", "linkedInUrl", "instagramUrl", "youTubeUrl", "whatsAppNumber", "supportPhoneNumber", "countryId", "timezoneId", "languageId", "stateId", "cityId")
