...
[**Invoke-PatchCourseUnitAsync**](CourseUnitsApi.md#Invoke-PatchCourseUnitAsync) | **PATCH** /api/v2/LearningService/CourseUnits/{unitId} | Patch a course unit
...
# Get all course units
try {
    $Result = Get-CourseUnitsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseUnitDtoCollectionQueryParameters $CourseUnitDtoCollectionQueryParameters
} catch {
...
# Get course units count
try {
    $Result = Get-CourseUnitsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseUnitDtoCollectionQueryParameters $CourseUnitDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchCourseUnitAsync"></a>
# **Invoke-PatchCourseUnitAsync**
> EmptyEnvelope Invoke-PatchCourseUnitAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-UnitId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a course unit
try {
    $Result = Invoke-PatchCourseUnitAsync -TenantId $TenantId -UnitId $UnitId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchCourseUnitAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
