...
AccountTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-AccountTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to AccountTypeDtoListEnvelope<PSCustomObject>
...
AccountTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountTypeDtoListEnvelope
