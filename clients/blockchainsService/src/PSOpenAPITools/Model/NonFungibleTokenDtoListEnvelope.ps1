...
NonFungibleTokenDtoListEnvelope<PSCustomObject>
#>

function Initialize-NonFungibleTokenDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NonFungibleTokenDtoListEnvelope' | Write-Debug
...
Convert from JSON to NonFungibleTokenDtoListEnvelope<PSCustomObject>
...
NonFungibleTokenDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNonFungibleTokenDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NonFungibleTokenDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NonFungibleTokenDtoListEnvelope
