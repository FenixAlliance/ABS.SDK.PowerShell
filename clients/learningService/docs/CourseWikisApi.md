...
# Get all course wikis
try {
    $Result = Get-CourseWikisAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseWikiDtoCollectionQueryParameters $CourseWikiDtoCollectionQueryParameters
} catch {
...
# Get course wikis count
try {
    $Result = Get-CourseWikisCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseWikiDtoCollectionQueryParameters $CourseWikiDtoCollectionQueryParameters
} catch {
...
# Patch a course wiki
try {
    $Result = Invoke-PatchCourseWikiAsync -TenantId $TenantId -WikiId $WikiId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
