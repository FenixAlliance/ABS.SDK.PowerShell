...
ExtendedTenantEnrolmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExtendedTenantEnrolmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantEnrolmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExtendedTenantEnrolmentDtoListEnvelope<PSCustomObject>
...
ExtendedTenantEnrolmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantEnrolmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantEnrolmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantEnrolmentDtoListEnvelope
