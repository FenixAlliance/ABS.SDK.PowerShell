...
ContactSourceDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactSourceDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactSourceDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactSourceDtoListEnvelope<PSCustomObject>
...
ContactSourceDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactSourceDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactSourceDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactSourceDtoListEnvelope
