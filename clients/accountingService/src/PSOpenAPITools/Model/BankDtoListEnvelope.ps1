...
BankDtoListEnvelope<PSCustomObject>
#>

function Initialize-BankDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankDtoListEnvelope' | Write-Debug
...
Convert from JSON to BankDtoListEnvelope<PSCustomObject>
...
BankDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankDtoListEnvelope
