...
ExtendedOrderDto<PSCustomObject>
#>

function Initialize-ExtendedOrderDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedOrderDto' | Write-Debug
...
Convert from JSON to ExtendedOrderDto<PSCustomObject>
...
ExtendedOrderDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedOrderDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedOrderDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
