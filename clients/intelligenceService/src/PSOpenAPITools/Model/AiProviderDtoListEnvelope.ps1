...
AiProviderDtoListEnvelope<PSCustomObject>
#>

function Initialize-AiProviderDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AiProviderDtoListEnvelope' | Write-Debug
...
Convert from JSON to AiProviderDtoListEnvelope<PSCustomObject>
...
AiProviderDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAiProviderDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AiProviderDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AiProviderDtoListEnvelope
