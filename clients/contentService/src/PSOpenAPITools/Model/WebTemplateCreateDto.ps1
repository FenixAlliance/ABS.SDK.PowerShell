...
WebTemplateCreateDto<PSCustomObject>
#>

function Initialize-WebTemplateCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebTemplateCreateDto' | Write-Debug
...
Convert from JSON to WebTemplateCreateDto<PSCustomObject>
...
WebTemplateCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebTemplateCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebTemplateCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebTemplateCreateDto
