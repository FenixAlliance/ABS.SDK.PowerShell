...
ItemTaxPolicyRecordCreateDto<PSCustomObject>
#>

function Initialize-ItemTaxPolicyRecordCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordCreateDto' | Write-Debug
...
Convert from JSON to ItemTaxPolicyRecordCreateDto<PSCustomObject>
...
ItemTaxPolicyRecordCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyRecordCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyRecordCreateDto
