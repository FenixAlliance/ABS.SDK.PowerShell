...
WebPageCreateDto<PSCustomObject>
#>

function Initialize-WebPageCreateDto {
    [CmdletBinding()]
    Param (
...
Convert from JSON to WebPageCreateDto<PSCustomObject>
...
WebPageCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageCreateDto
        $AllProperties = ("id", "timestamp", "title", "published", "description", "code", "markup", "featuredImageUrl", "codeType", "slug", "webPortalId", "webTemplateId", "parentWebContentId")
