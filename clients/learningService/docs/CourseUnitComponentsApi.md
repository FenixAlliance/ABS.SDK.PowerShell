...
# Get all course unit components
try {
    $Result = Get-CourseUnitComponentsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseUnitComponentDtoCollectionQueryParameters $CourseUnitComponentDtoCollectionQueryParameters
} catch {
...
# Get course unit components count
try {
    $Result = Get-CourseUnitComponentsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseUnitComponentDtoCollectionQueryParameters $CourseUnitComponentDtoCollectionQueryParameters
} catch {
...
# Patch a course unit component
try {
    $Result = Invoke-PatchCourseUnitComponentAsync -TenantId $TenantId -ComponentId $ComponentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
