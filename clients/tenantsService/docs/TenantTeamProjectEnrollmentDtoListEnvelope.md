...
```powershell
$TenantTeamProjectEnrollmentDtoListEnvelope = Initialize-PSOpenAPIToolsTenantTeamProjectEnrollmentDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TenantTeamProjectEnrollmentDtoListEnvelope | ConvertTo-JSON
```
