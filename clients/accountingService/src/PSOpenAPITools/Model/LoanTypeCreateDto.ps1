...
LoanTypeCreateDto<PSCustomObject>
#>

function Initialize-LoanTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanTypeCreateDto' | Write-Debug
...
Convert from JSON to LoanTypeCreateDto<PSCustomObject>
...
LoanTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToLoanTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanTypeCreateDto
