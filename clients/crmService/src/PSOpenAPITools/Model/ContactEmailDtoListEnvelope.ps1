...
ContactEmailDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactEmailDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactEmailDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactEmailDtoListEnvelope<PSCustomObject>
...
ContactEmailDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactEmailDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactEmailDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactEmailDtoListEnvelope
