...
```powershell
$AppliedTaxPolicyRecordDtoEnvelope = Initialize-PSOpenAPIToolsAppliedTaxPolicyRecordDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$AppliedTaxPolicyRecordDtoEnvelope | ConvertTo-JSON
```
