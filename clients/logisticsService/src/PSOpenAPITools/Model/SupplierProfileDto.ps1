...
SupplierProfileDto<PSCustomObject>
#>

function Initialize-SupplierProfileDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupplierProfileDto' | Write-Debug
...
Convert from JSON to SupplierProfileDto<PSCustomObject>
...
SupplierProfileDto<PSCustomObject>
#>
function ConvertFrom-JsonToSupplierProfileDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupplierProfileDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupplierProfileDto
