...
TenantTeamProjectEnrollmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTeamProjectEnrollmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTeamProjectEnrollmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTeamProjectEnrollmentDtoListEnvelope<PSCustomObject>
...
TenantTeamProjectEnrollmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTeamProjectEnrollmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTeamProjectEnrollmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTeamProjectEnrollmentDtoListEnvelope
