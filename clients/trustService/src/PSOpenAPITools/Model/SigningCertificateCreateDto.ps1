...
SigningCertificateCreateDto<PSCustomObject>
#>

function Initialize-SigningCertificateCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningCertificateCreateDto' | Write-Debug
...
Convert from JSON to SigningCertificateCreateDto<PSCustomObject>
...
SigningCertificateCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSigningCertificateCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningCertificateCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningCertificateCreateDto
        $AllProperties = ("id", "timestamp", "title", "type", "url", "csr", "publicKey", "certificateType", "contactId", "securityCertificateId")
