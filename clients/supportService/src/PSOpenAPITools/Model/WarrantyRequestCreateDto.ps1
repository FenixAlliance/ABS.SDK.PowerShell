...
WarrantyRequestCreateDto<PSCustomObject>
#>

function Initialize-WarrantyRequestCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarrantyRequestCreateDto' | Write-Debug
...
Convert from JSON to WarrantyRequestCreateDto<PSCustomObject>
...
WarrantyRequestCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWarrantyRequestCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarrantyRequestCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarrantyRequestCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "contactId", "warrantyPolicyId")
