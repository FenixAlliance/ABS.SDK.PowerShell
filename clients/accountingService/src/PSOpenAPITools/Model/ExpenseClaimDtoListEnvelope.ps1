...
ExpenseClaimDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExpenseClaimDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExpenseClaimDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExpenseClaimDtoListEnvelope<PSCustomObject>
...
ExpenseClaimDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExpenseClaimDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExpenseClaimDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExpenseClaimDtoListEnvelope
