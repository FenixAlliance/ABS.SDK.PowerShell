...
EmployerProfileCreateDto<PSCustomObject>
#>

function Initialize-EmployerProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployerProfileCreateDto' | Write-Debug
...
Convert from JSON to EmployerProfileCreateDto<PSCustomObject>
...
EmployerProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmployerProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployerProfileCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployerProfileCreateDto
        $AllProperties = ("id", "timestamp", "type", "contactId", "contact", "about", "avatarUrl", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label")
