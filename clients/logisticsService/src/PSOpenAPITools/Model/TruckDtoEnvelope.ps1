...
TruckDtoEnvelope<PSCustomObject>
#>

function Initialize-TruckDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TruckDtoEnvelope' | Write-Debug
...
Convert from JSON to TruckDtoEnvelope<PSCustomObject>
...
TruckDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTruckDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TruckDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TruckDtoEnvelope
