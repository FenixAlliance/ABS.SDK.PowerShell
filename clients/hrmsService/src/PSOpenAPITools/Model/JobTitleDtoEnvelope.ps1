...
JobTitleDtoEnvelope<PSCustomObject>
#>

function Initialize-JobTitleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobTitleDtoEnvelope' | Write-Debug
...
Convert from JSON to JobTitleDtoEnvelope<PSCustomObject>
...
JobTitleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobTitleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobTitleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobTitleDtoEnvelope
