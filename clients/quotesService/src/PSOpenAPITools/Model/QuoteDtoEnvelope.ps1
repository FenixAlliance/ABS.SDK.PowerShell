...
QuoteDtoEnvelope<PSCustomObject>
#>

function Initialize-QuoteDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteDtoEnvelope' | Write-Debug
...
Convert from JSON to QuoteDtoEnvelope<PSCustomObject>
...
QuoteDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteDtoEnvelope
