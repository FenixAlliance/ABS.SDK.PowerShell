...
CapabilityDtoEnvelope<PSCustomObject>
#>

function Initialize-CapabilityDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CapabilityDtoEnvelope' | Write-Debug
...
Convert from JSON to CapabilityDtoEnvelope<PSCustomObject>
...
CapabilityDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCapabilityDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CapabilityDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapabilityDtoEnvelope
