...
OptionDtoListEnvelope<PSCustomObject>
#>

function Initialize-OptionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OptionDtoListEnvelope' | Write-Debug
...
Convert from JSON to OptionDtoListEnvelope<PSCustomObject>
...
OptionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOptionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OptionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OptionDtoListEnvelope
