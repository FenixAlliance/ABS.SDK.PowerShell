...
InquiryRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-InquiryRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InquiryRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to InquiryRequestDtoListEnvelope<PSCustomObject>
...
InquiryRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInquiryRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InquiryRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InquiryRequestDtoListEnvelope
