...
ProductionPlanDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProductionPlanDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductionPlanDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProductionPlanDtoListEnvelope<PSCustomObject>
...
ProductionPlanDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProductionPlanDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductionPlanDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductionPlanDtoListEnvelope
