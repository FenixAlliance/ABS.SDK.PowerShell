...
BooleanEnvelope<PSCustomObject>
#>

function Initialize-BooleanEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BooleanEnvelope' | Write-Debug
...
Convert from JSON to BooleanEnvelope<PSCustomObject>
...
BooleanEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBooleanEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BooleanEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BooleanEnvelope
