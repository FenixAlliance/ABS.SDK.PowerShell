...
AccountingPeriodDtoEnvelope<PSCustomObject>
#>

function Initialize-AccountingPeriodDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountingPeriodDtoEnvelope' | Write-Debug
...
Convert from JSON to AccountingPeriodDtoEnvelope<PSCustomObject>
...
AccountingPeriodDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountingPeriodDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountingPeriodDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountingPeriodDtoEnvelope
