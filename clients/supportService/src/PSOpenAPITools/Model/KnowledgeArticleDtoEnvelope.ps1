...
KnowledgeArticleDtoEnvelope<PSCustomObject>
#>

function Initialize-KnowledgeArticleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KnowledgeArticleDtoEnvelope' | Write-Debug
...
Convert from JSON to KnowledgeArticleDtoEnvelope<PSCustomObject>
...
KnowledgeArticleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToKnowledgeArticleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KnowledgeArticleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KnowledgeArticleDtoEnvelope
