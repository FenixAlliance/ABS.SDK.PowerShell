...
.PARAMETER ItemID
No description available.
.PARAMETER ShippingAddressID
No description available.
.OUTPUTS

ItemCartRecordDto<PSCustomObject>
#>

function Initialize-ItemCartRecordDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemCartRecordDto' | Write-Debug
...
Convert from JSON to ItemCartRecordDto<PSCustomObject>
...
ItemCartRecordDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemCartRecordDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemCartRecordDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemCartRecordDto
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "shippingAddressID"))) { #optional property not found
            $ShippingAddressID = $null
        } else {
            $ShippingAddressID = $JsonParameters.PSobject.Properties["shippingAddressID"].value
        }
