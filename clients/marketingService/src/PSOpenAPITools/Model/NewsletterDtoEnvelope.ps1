...
NewsletterDtoEnvelope<PSCustomObject>
#>

function Initialize-NewsletterDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NewsletterDtoEnvelope' | Write-Debug
...
Convert from JSON to NewsletterDtoEnvelope<PSCustomObject>
...
NewsletterDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNewsletterDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NewsletterDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NewsletterDtoEnvelope
