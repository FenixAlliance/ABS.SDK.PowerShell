...
WebTemplateDtoEnvelope<PSCustomObject>
#>

function Initialize-WebTemplateDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebTemplateDtoEnvelope' | Write-Debug
...
Convert from JSON to WebTemplateDtoEnvelope<PSCustomObject>
...
WebTemplateDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebTemplateDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebTemplateDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebTemplateDtoEnvelope
