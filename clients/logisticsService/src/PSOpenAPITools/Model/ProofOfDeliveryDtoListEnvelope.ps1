...
ProofOfDeliveryDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProofOfDeliveryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProofOfDeliveryDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProofOfDeliveryDtoListEnvelope<PSCustomObject>
...
ProofOfDeliveryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProofOfDeliveryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProofOfDeliveryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProofOfDeliveryDtoListEnvelope
