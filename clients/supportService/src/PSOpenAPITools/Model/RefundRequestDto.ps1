...
RefundRequestDto<PSCustomObject>
#>

function Initialize-RefundRequestDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RefundRequestDto' | Write-Debug
...
Convert from JSON to RefundRequestDto<PSCustomObject>
...
RefundRequestDto<PSCustomObject>
#>
function ConvertFrom-JsonToRefundRequestDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RefundRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RefundRequestDto
        $AllProperties = ("id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "businessProfileRecordId", "supportEntitlementId", "contactId", "accountHolderId", "refundPolicyId", "paymentId")
