...
BlockchainDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlockchainDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlockchainDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlockchainDtoListEnvelope<PSCustomObject>
...
BlockchainDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlockchainDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlockchainDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlockchainDtoListEnvelope
