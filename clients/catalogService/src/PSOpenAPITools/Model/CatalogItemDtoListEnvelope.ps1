...
CatalogItemDtoListEnvelope<PSCustomObject>
#>

function Initialize-CatalogItemDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogItemDtoListEnvelope' | Write-Debug
...
Convert from JSON to CatalogItemDtoListEnvelope<PSCustomObject>
...
CatalogItemDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogItemDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogItemDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogItemDtoListEnvelope
