...
NotificationDtoEnvelope<PSCustomObject>
#>

function Initialize-NotificationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NotificationDtoEnvelope' | Write-Debug
...
Convert from JSON to NotificationDtoEnvelope<PSCustomObject>
...
NotificationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNotificationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NotificationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NotificationDtoEnvelope
