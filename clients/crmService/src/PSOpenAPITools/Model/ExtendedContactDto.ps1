...
No description available.
.PARAMETER ParentContact
No description available.
.PARAMETER PrimaryContact
No description available.
.OUTPUTS

ExtendedContactDto<PSCustomObject>
#>

function Initialize-ExtendedContactDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedContactDto' | Write-Debug
...
Convert from JSON to ExtendedContactDto<PSCustomObject>
...
ExtendedContactDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedContactDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "parentContact"))) { #optional property not found
            $ParentContact = $null
        } else {
            $ParentContact = $JsonParameters.PSobject.Properties["parentContact"].value
        }
