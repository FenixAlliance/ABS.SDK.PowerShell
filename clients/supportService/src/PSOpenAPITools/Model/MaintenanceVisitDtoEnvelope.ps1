...
MaintenanceVisitDtoEnvelope<PSCustomObject>
#>

function Initialize-MaintenanceVisitDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MaintenanceVisitDtoEnvelope' | Write-Debug
...
Convert from JSON to MaintenanceVisitDtoEnvelope<PSCustomObject>
...
MaintenanceVisitDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMaintenanceVisitDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MaintenanceVisitDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MaintenanceVisitDtoEnvelope
