...
AssetRepairDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetRepairDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetRepairDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetRepairDtoEnvelope<PSCustomObject>
...
AssetRepairDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetRepairDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetRepairDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetRepairDtoEnvelope
