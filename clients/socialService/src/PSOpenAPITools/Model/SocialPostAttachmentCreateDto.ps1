...
SocialPostAttachmentCreateDto<PSCustomObject>
#>

function Initialize-SocialPostAttachmentCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostAttachmentCreateDto' | Write-Debug
...
Convert from JSON to SocialPostAttachmentCreateDto<PSCustomObject>
...
SocialPostAttachmentCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostAttachmentCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostAttachmentCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostAttachmentCreateDto
        $AllProperties = ("id", "timestamp", "notes", "title", "author", "isFolder", "fileName", "abstract", "keyWords", "validResponse", "parentFileUploadId", "filePath", "publicAccessType", "socialPostId")
