...
No description available.
.PARAMETER InvoiceReferences
No description available.
.PARAMETER InvoiceAdjustments
No description available.
.OUTPUTS

InvoiceCreateDto<PSCustomObject>
#>

function Initialize-InvoiceCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceCreateDto' | Write-Debug
...
Convert from JSON to InvoiceCreateDto<PSCustomObject>
...
InvoiceCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceCreateDto
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "invoiceReferences"))) { #optional property not found
            $InvoiceReferences = $null
        } else {
            $InvoiceReferences = $JsonParameters.PSobject.Properties["invoiceReferences"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "invoiceAdjustments"))) { #optional property not found
            $InvoiceAdjustments = $null
        } else {
            $InvoiceAdjustments = $JsonParameters.PSobject.Properties["invoiceAdjustments"].value
        }
