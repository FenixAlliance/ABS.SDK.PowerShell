...
ContactDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactDtoListEnvelope<PSCustomObject>
...
ContactDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactDtoListEnvelope
