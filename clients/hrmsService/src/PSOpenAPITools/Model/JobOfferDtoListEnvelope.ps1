...
JobOfferDtoListEnvelope<PSCustomObject>
#>

function Initialize-JobOfferDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobOfferDtoListEnvelope' | Write-Debug
...
Convert from JSON to JobOfferDtoListEnvelope<PSCustomObject>
...
JobOfferDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobOfferDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobOfferDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobOfferDtoListEnvelope
