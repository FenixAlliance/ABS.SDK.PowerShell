...
UnitGroupDtoListEnvelope<PSCustomObject>
#>

function Initialize-UnitGroupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UnitGroupDtoListEnvelope' | Write-Debug
...
Convert from JSON to UnitGroupDtoListEnvelope<PSCustomObject>
...
UnitGroupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUnitGroupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UnitGroupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UnitGroupDtoListEnvelope
