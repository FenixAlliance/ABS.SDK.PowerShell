...
**Result** | [**StudioModule[]**](StudioModule.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$StudioModuleListEnvelope = Initialize-PSOpenAPIToolsStudioModuleListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$StudioModuleListEnvelope | ConvertTo-JSON
```
