...
```powershell
$PaymentCommissionDtoListEnvelope = Initialize-PSOpenAPIToolsPaymentCommissionDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$PaymentCommissionDtoListEnvelope | ConvertTo-JSON
```
