...
DealUnitDtoListEnvelope<PSCustomObject>
#>

function Initialize-DealUnitDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitDtoListEnvelope' | Write-Debug
...
Convert from JSON to DealUnitDtoListEnvelope<PSCustomObject>
...
DealUnitDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitDtoListEnvelope
