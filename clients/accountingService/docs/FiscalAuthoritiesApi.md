...
[**Invoke-PatchFiscalAuthorityAsync**](FiscalAuthoritiesApi.md#Invoke-PatchFiscalAuthorityAsync) | **PATCH** /api/v2/AccountingService/Fiscals/Authorities/{authorityId} | Patch a fiscal authority
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FiscalAuthorityDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$FiscalAuthorityDtoCollectionQueryParameters = Initialize-FiscalAuthorityDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # FiscalAuthorityDtoCollectionQueryParameters |  (optional)

# Get fiscal authorities
try {
    $Result = Get-FiscalAuthorities -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -FiscalAuthorityDtoCollectionQueryParameters $FiscalAuthorityDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **FiscalAuthorityDtoCollectionQueryParameters** | [**FiscalAuthorityDtoCollectionQueryParameters**](FiscalAuthorityDtoCollectionQueryParameters.md)|  | [optional] 
...
# Get fiscal authorities count
try {
    $Result = Get-FiscalAuthoritiesCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -FiscalAuthorityDtoCollectionQueryParameters $FiscalAuthorityDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchFiscalAuthorityAsync"></a>
# **Invoke-PatchFiscalAuthorityAsync**
> EmptyEnvelope Invoke-PatchFiscalAuthorityAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AuthorityId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a fiscal authority
try {
    $Result = Invoke-PatchFiscalAuthorityAsync -TenantId $TenantId -AuthorityId $AuthorityId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchFiscalAuthorityAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
