...
SignatureDtoListEnvelope<PSCustomObject>
#>

function Initialize-SignatureDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SignatureDtoListEnvelope' | Write-Debug
...
Convert from JSON to SignatureDtoListEnvelope<PSCustomObject>
...
SignatureDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSignatureDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SignatureDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SignatureDtoListEnvelope
