...
WebPortalDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebPortalDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPortalDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebPortalDtoListEnvelope<PSCustomObject>
...
WebPortalDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPortalDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPortalDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPortalDtoListEnvelope
