...
TimeIntervalDtoListEnvelope<PSCustomObject>
#>

function Initialize-TimeIntervalDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TimeIntervalDtoListEnvelope' | Write-Debug
...
Convert from JSON to TimeIntervalDtoListEnvelope<PSCustomObject>
...
TimeIntervalDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTimeIntervalDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TimeIntervalDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TimeIntervalDtoListEnvelope
