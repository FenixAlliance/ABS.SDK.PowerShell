...
PortalSettingsEnvelope<PSCustomObject>
#>

function Initialize-PortalSettingsEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortalSettingsEnvelope' | Write-Debug
...
Convert from JSON to PortalSettingsEnvelope<PSCustomObject>
...
PortalSettingsEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPortalSettingsEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortalSettingsEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortalSettingsEnvelope
