...
function ConvertFrom-JsonToExtendedOrderDto {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "sellerBillingProfileId"))) { #optional property not found
            $SellerBillingProfileId = $null
        } else {
            $SellerBillingProfileId = $JsonParameters.PSobject.Properties["sellerBillingProfileId"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "buyerBillingProfileId"))) { #optional property not found
