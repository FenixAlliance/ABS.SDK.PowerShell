...
ItemAttributeUpdateDto<PSCustomObject>
#>

function Initialize-ItemAttributeUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeUpdateDto' | Write-Debug
...
Convert from JSON to ItemAttributeUpdateDto<PSCustomObject>
...
ItemAttributeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeUpdateDto
