...
MarketingListDtoEnvelope<PSCustomObject>
#>

function Initialize-MarketingListDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingListDtoEnvelope' | Write-Debug
...
Convert from JSON to MarketingListDtoEnvelope<PSCustomObject>
...
MarketingListDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingListDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingListDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingListDtoEnvelope
