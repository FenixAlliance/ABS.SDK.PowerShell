...
UnitDtoListEnvelope<PSCustomObject>
#>

function Initialize-UnitDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UnitDtoListEnvelope' | Write-Debug
...
Convert from JSON to UnitDtoListEnvelope<PSCustomObject>
...
UnitDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUnitDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UnitDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UnitDtoListEnvelope
