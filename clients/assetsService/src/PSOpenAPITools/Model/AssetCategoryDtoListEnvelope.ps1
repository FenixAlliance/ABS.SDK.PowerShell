...
AssetCategoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetCategoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetCategoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetCategoryDtoListEnvelope<PSCustomObject>
...
AssetCategoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetCategoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetCategoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetCategoryDtoListEnvelope
