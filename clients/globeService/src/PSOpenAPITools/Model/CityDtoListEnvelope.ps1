...
CityDtoListEnvelope<PSCustomObject>
#>

function Initialize-CityDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CityDtoListEnvelope' | Write-Debug
...
Convert from JSON to CityDtoListEnvelope<PSCustomObject>
...
CityDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCityDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CityDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CityDtoListEnvelope
