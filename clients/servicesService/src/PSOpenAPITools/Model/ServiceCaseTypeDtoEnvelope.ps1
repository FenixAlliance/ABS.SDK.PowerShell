...
ServiceCaseTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceCaseTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceCaseTypeDtoEnvelope<PSCustomObject>
...
ServiceCaseTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseTypeDtoEnvelope
