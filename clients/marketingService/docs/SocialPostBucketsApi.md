...
[**Invoke-PatchSocialPostBucketAsync**](SocialPostBucketsApi.md#Invoke-PatchSocialPostBucketAsync) | **PATCH** /api/v2/MarketingService/SocialPostBuckets/{socialpostbucketId} | Patch a social post bucket
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SocialPostBucketDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$SocialPostBucketDtoCollectionQueryParameters = Initialize-SocialPostBucketDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # SocialPostBucketDtoCollectionQueryParameters |  (optional)

# Get social post buckets count
try {
    $Result = Get-SocialPostBucketsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SocialPostBucketDtoCollectionQueryParameters $SocialPostBucketDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **SocialPostBucketDtoCollectionQueryParameters** | [**SocialPostBucketDtoCollectionQueryParameters**](SocialPostBucketDtoCollectionQueryParameters.md)|  | [optional] 
...
# Get social post buckets
try {
    $Result = Get-SocialPostBucketsODataAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SocialPostBucketDtoCollectionQueryParameters $SocialPostBucketDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSocialPostBucketAsync"></a>
# **Invoke-PatchSocialPostBucketAsync**
> EmptyEnvelope Invoke-PatchSocialPostBucketAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SocialpostbucketId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a social post bucket
try {
    $Result = Invoke-PatchSocialPostBucketAsync -TenantId $TenantId -SocialpostbucketId $SocialpostbucketId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSocialPostBucketAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
