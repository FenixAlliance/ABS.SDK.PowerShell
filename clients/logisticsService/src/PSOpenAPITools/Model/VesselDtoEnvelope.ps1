...
VesselDtoEnvelope<PSCustomObject>
#>

function Initialize-VesselDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VesselDtoEnvelope' | Write-Debug
...
Convert from JSON to VesselDtoEnvelope<PSCustomObject>
...
VesselDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToVesselDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VesselDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VesselDtoEnvelope
