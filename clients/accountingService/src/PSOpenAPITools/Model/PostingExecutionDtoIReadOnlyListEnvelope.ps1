...
PostingExecutionDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-PostingExecutionDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PostingExecutionDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to PostingExecutionDtoIReadOnlyListEnvelope<PSCustomObject>
...
PostingExecutionDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPostingExecutionDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PostingExecutionDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PostingExecutionDtoIReadOnlyListEnvelope
