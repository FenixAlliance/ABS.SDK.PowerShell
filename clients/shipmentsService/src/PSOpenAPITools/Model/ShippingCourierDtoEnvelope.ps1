...
ShippingCourierDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingCourierDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingCourierDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingCourierDtoEnvelope<PSCustomObject>
...
ShippingCourierDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingCourierDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingCourierDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingCourierDtoEnvelope
