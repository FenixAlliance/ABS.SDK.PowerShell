...
LeaveApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-LeaveApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LeaveApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to LeaveApplicationDtoEnvelope<PSCustomObject>
...
LeaveApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLeaveApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LeaveApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LeaveApplicationDtoEnvelope
