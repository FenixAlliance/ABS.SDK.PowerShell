...
function Initialize-IEdmEntityContainerElement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IEdmEntityContainerElement' | Write-Debug
...
IEdmEntityContainerElement<PSCustomObject>
#>
function ConvertFrom-JsonToIEdmEntityContainerElement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IEdmEntityContainerElement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IEdmEntityContainerElement
        $AllProperties = ("name", "containerElementKind", "container")
