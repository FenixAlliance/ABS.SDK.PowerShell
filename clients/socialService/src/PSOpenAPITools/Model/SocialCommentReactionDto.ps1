...
No description available.
.PARAMETER SocialCommentId
No description available.
.OUTPUTS

SocialCommentReactionDto<PSCustomObject>
#>

function Initialize-SocialCommentReactionDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialCommentReactionDto' | Write-Debug
...
Convert from JSON to SocialCommentReactionDto<PSCustomObject>
...
SocialCommentReactionDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialCommentReactionDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialCommentReactionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialCommentReactionDto
        $AllProperties = ("id", "timestamp", "reaction", "reactionValue", "socialProfileId", "socialProfileName", "socialProfileAvatarUrl", "socialProfileType", "socialCommentId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "socialCommentId"))) { #optional property not found
            $SocialCommentId = $null
        } else {
            $SocialCommentId = $JsonParameters.PSobject.Properties["socialCommentId"].value
        }
