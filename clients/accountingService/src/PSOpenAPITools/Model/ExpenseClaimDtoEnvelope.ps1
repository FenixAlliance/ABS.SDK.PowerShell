...
ExpenseClaimDtoEnvelope<PSCustomObject>
#>

function Initialize-ExpenseClaimDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExpenseClaimDtoEnvelope' | Write-Debug
...
Convert from JSON to ExpenseClaimDtoEnvelope<PSCustomObject>
...
ExpenseClaimDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExpenseClaimDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExpenseClaimDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExpenseClaimDtoEnvelope
