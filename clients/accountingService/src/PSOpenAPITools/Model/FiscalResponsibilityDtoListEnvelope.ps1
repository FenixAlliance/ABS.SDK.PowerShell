...
FiscalResponsibilityDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalResponsibilityDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalResponsibilityDtoListEnvelope<PSCustomObject>
...
FiscalResponsibilityDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityDtoListEnvelope
