...
VoyagePortCallDtoListEnvelope<PSCustomObject>
#>

function Initialize-VoyagePortCallDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VoyagePortCallDtoListEnvelope' | Write-Debug
...
Convert from JSON to VoyagePortCallDtoListEnvelope<PSCustomObject>
...
VoyagePortCallDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToVoyagePortCallDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VoyagePortCallDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VoyagePortCallDtoListEnvelope
