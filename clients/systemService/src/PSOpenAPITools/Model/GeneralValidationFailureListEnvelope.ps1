...
GeneralValidationFailureListEnvelope<PSCustomObject>
#>

function Initialize-GeneralValidationFailureListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GeneralValidationFailureListEnvelope' | Write-Debug
...
Convert from JSON to GeneralValidationFailureListEnvelope<PSCustomObject>
...
GeneralValidationFailureListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGeneralValidationFailureListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GeneralValidationFailureListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GeneralValidationFailureListEnvelope
