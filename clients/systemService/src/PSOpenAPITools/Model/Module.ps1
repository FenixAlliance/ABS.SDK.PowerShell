...
function Initialize-Module {
    ...
    Param (
        ...
        [ValidateSet("Module", "Integration", "StudioModule", "StudioIntegration")]
        [String]
        ${Type},
...
function ConvertFrom-JsonToModule {
    ...
    Process {
        ...
        $AllProperties = ("enable", "active", "order", "id", "name", "fullName", "description", "type", "configuration", "author", "authorUrl", "license", "requireLicenseAcceptance", "repository", "path", "icon", "image", "nuSpecPath", "manifest", "documentation", "website", "logo", "swaggerSpec", "swaggerSpecs", "url", "assemblyPaths", "requiredPermissions", "markedForDeletion", "version")
