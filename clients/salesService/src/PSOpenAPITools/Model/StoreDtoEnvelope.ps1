...
StoreDtoEnvelope<PSCustomObject>
#>

function Initialize-StoreDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StoreDtoEnvelope' | Write-Debug
...
Convert from JSON to StoreDtoEnvelope<PSCustomObject>
...
StoreDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStoreDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StoreDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StoreDtoEnvelope
