...
ProjectDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProjectDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProjectDtoListEnvelope<PSCustomObject>
...
ProjectDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectDtoListEnvelope
