...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SkillDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$SkillDtoCollectionQueryParameters = Initialize-SkillDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # SkillDtoCollectionQueryParameters |  (optional)

# Get skills
try {
    $Result = Get-SkillsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SkillDtoCollectionQueryParameters $SkillDtoCollectionQueryParameters
} catch {
...
# Count skills
try {
    $Result = Get-SkillsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SkillDtoCollectionQueryParameters $SkillDtoCollectionQueryParameters
} catch {
...
# Patch a skill
try {
    $Result = Invoke-PatchSkillAsync -TenantId $TenantId -SkillId $SkillId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
