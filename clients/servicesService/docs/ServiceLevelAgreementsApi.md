...
# Patch a service level agreement
try {
    $Result = Invoke-PatchServiceLevelAgreementAsync -TenantId $TenantId -ServiceLevelAgreementId $ServiceLevelAgreementId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
