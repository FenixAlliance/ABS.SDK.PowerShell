...
BlockchainCreateDto<PSCustomObject>
#>

function Initialize-BlockchainCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlockchainCreateDto' | Write-Debug
...
Convert from JSON to BlockchainCreateDto<PSCustomObject>
...
BlockchainCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlockchainCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlockchainCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlockchainCreateDto
        $AllProperties = ("id", "timestamp", "name", "logoUrl", "description", "difficulty")
