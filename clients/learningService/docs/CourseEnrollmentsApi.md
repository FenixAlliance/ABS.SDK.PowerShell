...
# Get all course enrollments
try {
    $Result = Get-EnrollmentsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseEnrollmentDtoCollectionQueryParameters $CourseEnrollmentDtoCollectionQueryParameters
} catch {
...
# Get course enrollments count
try {
    $Result = Get-EnrollmentsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseEnrollmentDtoCollectionQueryParameters $CourseEnrollmentDtoCollectionQueryParameters
} catch {
...
# Get enrollments by student
try {
    $Result = Get-StudentCourseEnrollmentsAsync -TenantId $TenantId -StudentProfileId $StudentProfileId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseEnrollmentDtoCollectionQueryParameters $CourseEnrollmentDtoCollectionQueryParameters
} catch {
...
# Patch a course enrollment
try {
    $Result = Invoke-PatchCourseEnrollmentAsync -TenantId $TenantId -CourseEnrollmentId $CourseEnrollmentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
