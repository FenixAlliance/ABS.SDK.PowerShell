...
NotificationDtoListEnvelope<PSCustomObject>
#>

function Initialize-NotificationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NotificationDtoListEnvelope' | Write-Debug
...
Convert from JSON to NotificationDtoListEnvelope<PSCustomObject>
...
NotificationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNotificationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NotificationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NotificationDtoListEnvelope
