...
DealUnitFlowStageDtoListEnvelope<PSCustomObject>
#>

function Initialize-DealUnitFlowStageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitFlowStageDtoListEnvelope' | Write-Debug
...
Convert from JSON to DealUnitFlowStageDtoListEnvelope<PSCustomObject>
...
DealUnitFlowStageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitFlowStageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitFlowStageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitFlowStageDtoListEnvelope
