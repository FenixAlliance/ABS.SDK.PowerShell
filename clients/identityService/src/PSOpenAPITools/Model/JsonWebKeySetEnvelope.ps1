...
JsonWebKeySetEnvelope<PSCustomObject>
#>

function Initialize-JsonWebKeySetEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonWebKeySetEnvelope' | Write-Debug
...
Convert from JSON to JsonWebKeySetEnvelope<PSCustomObject>
...
JsonWebKeySetEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJsonWebKeySetEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonWebKeySetEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonWebKeySetEnvelope
