...
WebContentDtoEnvelope<PSCustomObject>
#>

function Initialize-WebContentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebContentDtoEnvelope' | Write-Debug
...
Convert from JSON to WebContentDtoEnvelope<PSCustomObject>
...
WebContentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebContentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebContentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebContentDtoEnvelope
