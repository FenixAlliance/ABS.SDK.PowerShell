...
ItemTaxPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemTaxPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemTaxPolicyDtoEnvelope<PSCustomObject>
...
ItemTaxPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyDtoEnvelope
