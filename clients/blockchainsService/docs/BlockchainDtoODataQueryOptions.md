...
**IfMatch** | [**BlockchainDtoETag**](BlockchainDtoETag.md) |  | [optional] 
**IfNoneMatch** | [**BlockchainDtoETag**](BlockchainDtoETag.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$BlockchainDtoODataQueryOptions = Initialize-PSOpenAPIToolsBlockchainDtoODataQueryOptions  -Request null `
 -Context null `
 -RawValues null `
 -SelectExpand null `
 -Apply null `
...
```powershell
$BlockchainDtoODataQueryOptions | ConvertTo-JSON
```
