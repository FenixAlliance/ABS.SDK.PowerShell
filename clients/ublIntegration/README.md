# PSOpenAPITools - the PowerShell module for the UblIntegration
...
------------ | ------------- | ------------- | -------------
*CreditNotesApi* | [**Invoke-ApiV2UblServiceCreditNotesInvoiceIdGet**](docs/CreditNotesApi.md#Invoke-ApiV2UblServiceCreditNotesInvoiceIdGet) | **GET** /api/v2/UblService/CreditNotes/{invoiceId} | 
*DebitNotesApi* | [**Invoke-ApiV2UblServiceDebitNotesInvoiceIdGet**](docs/DebitNotesApi.md#Invoke-ApiV2UblServiceDebitNotesInvoiceIdGet) | **GET** /api/v2/UblService/DebitNotes/{invoiceId} | 
*DespatchAdvicesApi* | [**Invoke-ApiV2UblServiceDespatchAdvicesShipmentIdGet**](docs/DespatchAdvicesApi.md#Invoke-ApiV2UblServiceDespatchAdvicesShipmentIdGet) | **GET** /api/v2/UblService/DespatchAdvices/{shipmentId} | 
...
*InvoicesApi* | [**Invoke-ApiV2UblServiceInvoicesInvoiceIdGet**](docs/InvoicesApi.md#Invoke-ApiV2UblServiceInvoicesInvoiceIdGet) | **GET** /api/v2/UblService/Invoices/{invoiceId} | 
*ReceiptAdvicesApi* | [**Invoke-ApiV2UblServiceReceiptAdvicesItemRestockIdGet**](docs/ReceiptAdvicesApi.md#Invoke-ApiV2UblServiceReceiptAdvicesItemRestockIdGet) | **GET** /api/v2/UblService/ReceiptAdvices/{itemRestockId} | 
*ReceiptAdvicesApi* | [**Invoke-ApiV2UblServiceReceiptAdvicesItemRestockIdPartitionsGet**](docs/ReceiptAdvicesApi.md#Invoke-ApiV2UblServiceReceiptAdvicesItemRestockIdPartitionsGet) | **GET** /api/v2/UblService/ReceiptAdvices/{itemRestockId}/partitions | 
