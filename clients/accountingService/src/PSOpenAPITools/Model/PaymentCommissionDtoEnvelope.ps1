...
PaymentCommissionDtoEnvelope<PSCustomObject>
#>

function Initialize-PaymentCommissionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentCommissionDtoEnvelope' | Write-Debug
...
Convert from JSON to PaymentCommissionDtoEnvelope<PSCustomObject>
...
PaymentCommissionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentCommissionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentCommissionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentCommissionDtoEnvelope
