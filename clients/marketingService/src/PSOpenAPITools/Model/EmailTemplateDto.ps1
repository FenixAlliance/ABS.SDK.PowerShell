...
No description available.
.PARAMETER MarketingCampaignName
No description available.
.OUTPUTS

EmailTemplateDto<PSCustomObject>
#>

function Initialize-EmailTemplateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailTemplateDto' | Write-Debug
...
Convert from JSON to EmailTemplateDto<PSCustomObject>
...
EmailTemplateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmailTemplateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailTemplateDto
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "marketingCampaignName"))) { #optional property not found
            $MarketingCampaignName = $null
        } else {
            $MarketingCampaignName = $JsonParameters.PSobject.Properties["marketingCampaignName"].value
        }
