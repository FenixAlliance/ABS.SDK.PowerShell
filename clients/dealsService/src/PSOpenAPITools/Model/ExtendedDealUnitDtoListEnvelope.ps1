...
ExtendedDealUnitDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExtendedDealUnitDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedDealUnitDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExtendedDealUnitDtoListEnvelope<PSCustomObject>
...
ExtendedDealUnitDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedDealUnitDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedDealUnitDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedDealUnitDtoListEnvelope
