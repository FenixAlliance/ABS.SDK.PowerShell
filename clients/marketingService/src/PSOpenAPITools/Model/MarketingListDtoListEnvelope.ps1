...
MarketingListDtoListEnvelope<PSCustomObject>
#>

function Initialize-MarketingListDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingListDtoListEnvelope' | Write-Debug
...
Convert from JSON to MarketingListDtoListEnvelope<PSCustomObject>
...
MarketingListDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingListDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingListDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingListDtoListEnvelope
