...
WebContentDto<PSCustomObject>
#>

function Initialize-WebContentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebContentDto' | Write-Debug
...
Convert from JSON to WebContentDto<PSCustomObject>
...
WebContentDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebContentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebContentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebContentDto
