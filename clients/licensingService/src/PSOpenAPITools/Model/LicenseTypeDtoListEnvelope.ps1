...
LicenseTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-LicenseTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to LicenseTypeDtoListEnvelope<PSCustomObject>
...
LicenseTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseTypeDtoListEnvelope
