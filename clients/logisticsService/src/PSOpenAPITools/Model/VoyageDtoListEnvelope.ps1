...
VoyageDtoListEnvelope<PSCustomObject>
#>

function Initialize-VoyageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VoyageDtoListEnvelope' | Write-Debug
...
Convert from JSON to VoyageDtoListEnvelope<PSCustomObject>
...
VoyageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToVoyageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VoyageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VoyageDtoListEnvelope
