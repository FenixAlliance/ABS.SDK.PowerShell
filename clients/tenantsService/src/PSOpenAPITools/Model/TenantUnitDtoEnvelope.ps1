...
TenantUnitDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantUnitDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantUnitDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantUnitDtoEnvelope<PSCustomObject>
...
TenantUnitDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantUnitDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantUnitDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantUnitDtoEnvelope
