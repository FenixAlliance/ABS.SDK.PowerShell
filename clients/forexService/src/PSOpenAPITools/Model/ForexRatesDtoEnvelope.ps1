...
ForexRatesDtoEnvelope<PSCustomObject>
#>

function Initialize-ForexRatesDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ForexRatesDtoEnvelope' | Write-Debug
...
Convert from JSON to ForexRatesDtoEnvelope<PSCustomObject>
...
ForexRatesDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToForexRatesDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ForexRatesDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ForexRatesDtoEnvelope
