...
DealUnitFlowStageCreateDto<PSCustomObject>
#>

function Initialize-DealUnitFlowStageCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitFlowStageCreateDto' | Write-Debug
...
Convert from JSON to DealUnitFlowStageCreateDto<PSCustomObject>
...
DealUnitFlowStageCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitFlowStageCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitFlowStageCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
