...
OrderLineCreateDto<PSCustomObject>
#>

function Initialize-OrderLineCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderLineCreateDto' | Write-Debug
...
Convert from JSON to OrderLineCreateDto<PSCustomObject>
...
OrderLineCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToOrderLineCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderLineCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderLineCreateDto
