...
TaxClassCreateDto<PSCustomObject>
#>

function Initialize-TaxClassCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxClassCreateDto' | Write-Debug
...
Convert from JSON to TaxClassCreateDto<PSCustomObject>
...
TaxClassCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToTaxClassCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxClassCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxClassCreateDto
        $AllProperties = ("id", "timestamp", "name", "type", "fiscalAuthorityId")
