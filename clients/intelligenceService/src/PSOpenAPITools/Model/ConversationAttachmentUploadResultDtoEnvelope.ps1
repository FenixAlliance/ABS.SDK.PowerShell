...
ConversationAttachmentUploadResultDtoEnvelope<PSCustomObject>
#>

function Initialize-ConversationAttachmentUploadResultDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversationAttachmentUploadResultDtoEnvelope' | Write-Debug
...
Convert from JSON to ConversationAttachmentUploadResultDtoEnvelope<PSCustomObject>
...
ConversationAttachmentUploadResultDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToConversationAttachmentUploadResultDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversationAttachmentUploadResultDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversationAttachmentUploadResultDtoEnvelope
