...
RoadWaybillDtoListEnvelope<PSCustomObject>
#>

function Initialize-RoadWaybillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RoadWaybillDtoListEnvelope' | Write-Debug
...
Convert from JSON to RoadWaybillDtoListEnvelope<PSCustomObject>
...
RoadWaybillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRoadWaybillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RoadWaybillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoadWaybillDtoListEnvelope
