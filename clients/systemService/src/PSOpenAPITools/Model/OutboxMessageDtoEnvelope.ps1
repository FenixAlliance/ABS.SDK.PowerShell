...
OutboxMessageDtoEnvelope<PSCustomObject>
#>

function Initialize-OutboxMessageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OutboxMessageDtoEnvelope' | Write-Debug
...
Convert from JSON to OutboxMessageDtoEnvelope<PSCustomObject>
...
OutboxMessageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOutboxMessageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OutboxMessageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OutboxMessageDtoEnvelope
