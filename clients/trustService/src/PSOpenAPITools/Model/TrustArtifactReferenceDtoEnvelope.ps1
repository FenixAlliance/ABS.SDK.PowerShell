...
TrustArtifactReferenceDtoEnvelope<PSCustomObject>
#>

function Initialize-TrustArtifactReferenceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrustArtifactReferenceDtoEnvelope' | Write-Debug
...
Convert from JSON to TrustArtifactReferenceDtoEnvelope<PSCustomObject>
...
TrustArtifactReferenceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrustArtifactReferenceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrustArtifactReferenceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrustArtifactReferenceDtoEnvelope
