...
JobOfferFieldRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-JobOfferFieldRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobOfferFieldRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to JobOfferFieldRecordDtoEnvelope<PSCustomObject>
...
JobOfferFieldRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobOfferFieldRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobOfferFieldRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobOfferFieldRecordDtoEnvelope
