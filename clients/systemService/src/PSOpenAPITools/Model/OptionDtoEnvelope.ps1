...
OptionDtoEnvelope<PSCustomObject>
#>

function Initialize-OptionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OptionDtoEnvelope' | Write-Debug
...
Convert from JSON to OptionDtoEnvelope<PSCustomObject>
...
OptionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOptionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OptionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OptionDtoEnvelope
