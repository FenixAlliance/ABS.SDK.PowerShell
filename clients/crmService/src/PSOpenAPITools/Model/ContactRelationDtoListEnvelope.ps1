...
ContactRelationDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactRelationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactRelationDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactRelationDtoListEnvelope<PSCustomObject>
...
ContactRelationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactRelationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactRelationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactRelationDtoListEnvelope
