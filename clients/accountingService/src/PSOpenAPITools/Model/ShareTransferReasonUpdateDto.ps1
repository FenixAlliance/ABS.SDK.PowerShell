...
ShareTransferReasonUpdateDto<PSCustomObject>
#>

function Initialize-ShareTransferReasonUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferReasonUpdateDto' | Write-Debug
...
Convert from JSON to ShareTransferReasonUpdateDto<PSCustomObject>
...
ShareTransferReasonUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferReasonUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferReasonUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareTransferReasonUpdateDto
