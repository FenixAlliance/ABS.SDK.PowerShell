...
function Initialize-ShareTransferReasonCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferReasonCreateDto' | Write-Debug
...
Convert from JSON to ShareTransferReasonCreateDto<PSCustomObject>
...
ShareTransferReasonCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferReasonCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferReasonCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
