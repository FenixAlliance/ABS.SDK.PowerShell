...
PortDtoListEnvelope<PSCustomObject>
#>

function Initialize-PortDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortDtoListEnvelope' | Write-Debug
...
Convert from JSON to PortDtoListEnvelope<PSCustomObject>
...
PortDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPortDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortDtoListEnvelope
