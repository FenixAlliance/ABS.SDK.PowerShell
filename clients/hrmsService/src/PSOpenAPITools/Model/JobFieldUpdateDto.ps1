...
JobFieldUpdateDto<PSCustomObject>
#>

function Initialize-JobFieldUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobFieldUpdateDto' | Write-Debug
...
Convert from JSON to JobFieldUpdateDto<PSCustomObject>
...
JobFieldUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToJobFieldUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobFieldUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobFieldUpdateDto
        $AllProperties = ("name", "imageUrl", "description")
