...
TimeIntervalDtoEnvelope<PSCustomObject>
#>

function Initialize-TimeIntervalDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TimeIntervalDtoEnvelope' | Write-Debug
...
Convert from JSON to TimeIntervalDtoEnvelope<PSCustomObject>
...
TimeIntervalDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTimeIntervalDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TimeIntervalDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TimeIntervalDtoEnvelope
