...
QuoteLineUpsertDto<PSCustomObject>
#>

function Initialize-QuoteLineUpsertDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineUpsertDto' | Write-Debug
...
Convert from JSON to QuoteLineUpsertDto<PSCustomObject>
...
QuoteLineUpsertDto<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineUpsertDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineUpsertDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineUpsertDto
