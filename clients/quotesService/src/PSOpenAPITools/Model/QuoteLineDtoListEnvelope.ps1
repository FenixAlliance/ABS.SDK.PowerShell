...
QuoteLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-QuoteLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to QuoteLineDtoListEnvelope<PSCustomObject>
...
QuoteLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineDtoListEnvelope
