...
ActivityFeedDtoListEnvelope<PSCustomObject>
#>

function Initialize-ActivityFeedDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityFeedDtoListEnvelope' | Write-Debug
...
Convert from JSON to ActivityFeedDtoListEnvelope<PSCustomObject>
...
ActivityFeedDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityFeedDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityFeedDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityFeedDtoListEnvelope
