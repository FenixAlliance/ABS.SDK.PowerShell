...
ProjectTaskDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProjectTaskDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectTaskDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProjectTaskDtoListEnvelope<PSCustomObject>
...
ProjectTaskDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectTaskDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectTaskDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectTaskDtoListEnvelope
