...
StudentProfileCreateDto<PSCustomObject>
#>

function Initialize-StudentProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StudentProfileCreateDto' | Write-Debug
...
Convert from JSON to StudentProfileCreateDto<PSCustomObject>
...
StudentProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToStudentProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StudentProfileCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StudentProfileCreateDto
