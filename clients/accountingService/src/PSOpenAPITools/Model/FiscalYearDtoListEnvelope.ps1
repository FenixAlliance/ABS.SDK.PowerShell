...
FiscalYearDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalYearDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalYearDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalYearDtoListEnvelope<PSCustomObject>
...
FiscalYearDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalYearDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalYearDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalYearDtoListEnvelope
