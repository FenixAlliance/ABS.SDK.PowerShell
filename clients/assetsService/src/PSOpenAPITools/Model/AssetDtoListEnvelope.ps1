...
AssetDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetDtoListEnvelope<PSCustomObject>
...
AssetDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetDtoListEnvelope
