...
BankGuaranteeUpdateDto<PSCustomObject>
#>

function Initialize-BankGuaranteeUpdateDto {
    [CmdletBinding()]
    Param (
...
Convert from JSON to BankGuaranteeUpdateDto<PSCustomObject>
...
BankGuaranteeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBankGuaranteeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankGuaranteeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
