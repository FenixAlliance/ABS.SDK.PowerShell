...
CostCentreGroupDtoEnvelope<PSCustomObject>
#>

function Initialize-CostCentreGroupDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreGroupDtoEnvelope' | Write-Debug
...
Convert from JSON to CostCentreGroupDtoEnvelope<PSCustomObject>
...
CostCentreGroupDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreGroupDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreGroupDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreGroupDtoEnvelope
