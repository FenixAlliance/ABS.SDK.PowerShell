...
FiscalRegimeDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalRegimeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalRegimeDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalRegimeDtoEnvelope<PSCustomObject>
...
FiscalRegimeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalRegimeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalRegimeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalRegimeDtoEnvelope
