...
EmailGroupDtoEnvelope<PSCustomObject>
#>

function Initialize-EmailGroupDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailGroupDtoEnvelope' | Write-Debug
...
Convert from JSON to EmailGroupDtoEnvelope<PSCustomObject>
...
EmailGroupDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailGroupDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailGroupDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailGroupDtoEnvelope
