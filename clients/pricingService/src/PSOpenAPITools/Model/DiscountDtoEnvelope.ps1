...
DiscountDtoEnvelope<PSCustomObject>
#>

function Initialize-DiscountDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DiscountDtoEnvelope' | Write-Debug
...
Convert from JSON to DiscountDtoEnvelope<PSCustomObject>
...
DiscountDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDiscountDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DiscountDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiscountDtoEnvelope
