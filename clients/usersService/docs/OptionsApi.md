...
# Retrieve a list of user options
try {
    $Result = Get-UserOptions -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Get the count of user options
try {
    $Result = Get-UserOptionsCount -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Patch a user option
try {
    $Result = Invoke-PatchUserOption -OptionId $OptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
