...
ItemWarrantyPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemWarrantyPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemWarrantyPolicyDtoEnvelope<PSCustomObject>
...
ItemWarrantyPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemWarrantyPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemWarrantyPolicyDtoEnvelope
