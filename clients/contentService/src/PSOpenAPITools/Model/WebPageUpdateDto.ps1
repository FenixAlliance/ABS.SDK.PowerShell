...
WebPageUpdateDto<PSCustomObject>
#>

function Initialize-WebPageUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageUpdateDto' | Write-Debug
...
Convert from JSON to WebPageUpdateDto<PSCustomObject>
...
WebPageUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
