...
GrantUpdateDto<PSCustomObject>
#>

function Initialize-GrantUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GrantUpdateDto' | Write-Debug
...
Convert from JSON to GrantUpdateDto<PSCustomObject>
...
GrantUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToGrantUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GrantUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GrantUpdateDto
