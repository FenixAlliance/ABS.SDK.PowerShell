...
ShippingMethodDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingMethodDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingMethodDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingMethodDtoEnvelope<PSCustomObject>
...
ShippingMethodDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingMethodDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingMethodDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingMethodDtoEnvelope
