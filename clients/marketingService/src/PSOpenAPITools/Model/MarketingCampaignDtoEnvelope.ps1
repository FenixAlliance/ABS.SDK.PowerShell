...
MarketingCampaignDtoEnvelope<PSCustomObject>
#>

function Initialize-MarketingCampaignDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingCampaignDtoEnvelope' | Write-Debug
...
Convert from JSON to MarketingCampaignDtoEnvelope<PSCustomObject>
...
MarketingCampaignDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingCampaignDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingCampaignDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingCampaignDtoEnvelope
