...
ActivityFeedDtoEnvelope<PSCustomObject>
#>

function Initialize-ActivityFeedDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityFeedDtoEnvelope' | Write-Debug
...
Convert from JSON to ActivityFeedDtoEnvelope<PSCustomObject>
...
ActivityFeedDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityFeedDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityFeedDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityFeedDtoEnvelope
