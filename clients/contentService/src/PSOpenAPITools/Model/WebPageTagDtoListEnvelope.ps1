...
WebPageTagDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebPageTagDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageTagDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebPageTagDtoListEnvelope<PSCustomObject>
...
WebPageTagDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageTagDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageTagDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageTagDtoListEnvelope
