...
FiscalAuthorityDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalAuthorityDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalAuthorityDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalAuthorityDtoEnvelope<PSCustomObject>
...
FiscalAuthorityDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalAuthorityDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalAuthorityDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalAuthorityDtoEnvelope
