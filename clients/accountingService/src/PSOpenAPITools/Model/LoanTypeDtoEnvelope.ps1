...
LoanTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-LoanTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to LoanTypeDtoEnvelope<PSCustomObject>
...
LoanTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoanTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanTypeDtoEnvelope
