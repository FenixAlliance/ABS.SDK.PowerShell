...
SuiteLicenseFeatureDtoListEnvelope<PSCustomObject>
#>

function Initialize-SuiteLicenseFeatureDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuiteLicenseFeatureDtoListEnvelope' | Write-Debug
...
Convert from JSON to SuiteLicenseFeatureDtoListEnvelope<PSCustomObject>
...
SuiteLicenseFeatureDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSuiteLicenseFeatureDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuiteLicenseFeatureDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuiteLicenseFeatureDtoListEnvelope
