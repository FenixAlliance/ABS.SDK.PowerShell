...
WebComponentUpdateDto<PSCustomObject>
#>

function Initialize-WebComponentUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebComponentUpdateDto' | Write-Debug
...
Convert from JSON to WebComponentUpdateDto<PSCustomObject>
...
WebComponentUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebComponentUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebComponentUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebComponentUpdateDto
        $AllProperties = ("name", "title", "description", "code", "htmlContent", "cssContent", "jsContent", "codeType", "published", "enable", "featuredImageUrl")
