...
[**Invoke-PatchServiceCaseTypeAsync**](ServiceCaseTypesApi.md#Invoke-PatchServiceCaseTypeAsync) | **PATCH** /api/v2/ServicesService/ServiceCaseTypes/{serviceCaseTypeId} | Patch a service case type
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ServiceCaseTypeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$ServiceCaseTypeDtoCollectionQueryParameters = Initialize-ServiceCaseTypeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # ServiceCaseTypeDtoCollectionQueryParameters |  (optional)

# Get all service case types
try {
    $Result = Get-ServiceCaseTypesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ServiceCaseTypeDtoCollectionQueryParameters $ServiceCaseTypeDtoCollectionQueryParameters
} catch {
...
# Get service case types count
try {
    $Result = Get-ServiceCaseTypesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ServiceCaseTypeDtoCollectionQueryParameters $ServiceCaseTypeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchServiceCaseTypeAsync"></a>
# **Invoke-PatchServiceCaseTypeAsync**
> Envelope Invoke-PatchServiceCaseTypeAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ServiceCaseTypeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a service case type
try {
    $Result = Invoke-PatchServiceCaseTypeAsync -TenantId $TenantId -ServiceCaseTypeId $ServiceCaseTypeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchServiceCaseTypeAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
