...
AppliedItemTaxRecordDto<PSCustomObject>
#>

function Initialize-AppliedItemTaxRecordDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppliedItemTaxRecordDto' | Write-Debug
...
Convert from JSON to AppliedItemTaxRecordDto<PSCustomObject>
...
AppliedItemTaxRecordDto<PSCustomObject>
#>
function ConvertFrom-JsonToAppliedItemTaxRecordDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppliedItemTaxRecordDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppliedItemTaxRecordDto
        $AllProperties = ("id", "timestamp", "tenantId", "enrollmentId", "taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD", "billingItemRecordId")
