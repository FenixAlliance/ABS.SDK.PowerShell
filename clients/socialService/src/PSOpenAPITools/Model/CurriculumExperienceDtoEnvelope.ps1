...
CurriculumExperienceDtoEnvelope<PSCustomObject>
#>

function Initialize-CurriculumExperienceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurriculumExperienceDtoEnvelope' | Write-Debug
...
Convert from JSON to CurriculumExperienceDtoEnvelope<PSCustomObject>
...
CurriculumExperienceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurriculumExperienceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurriculumExperienceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurriculumExperienceDtoEnvelope
