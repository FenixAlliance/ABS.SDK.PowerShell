...
function Initialize-WarehouseDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarehouseDto' | Write-Debug
...
function ConvertFrom-JsonToWarehouseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarehouseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarehouseDto
        $AllProperties = ("id", "timestamp", "title", "address1", "address2", "address3", "postalCode", "phone", "countryId", "stateId", "cityId", "tenantId", "isGroup", "shipwireWarehouseId", "parentWarehouseId")
