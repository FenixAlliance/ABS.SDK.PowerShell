...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for TenantsService'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{0BF96FB5-0F4C-415A-B920-6DCF074454DF}' # Has to be static, otherwise each new build will be considered different module
