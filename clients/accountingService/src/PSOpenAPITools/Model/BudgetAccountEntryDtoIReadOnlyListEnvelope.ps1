...
BudgetAccountEntryDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-BudgetAccountEntryDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BudgetAccountEntryDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to BudgetAccountEntryDtoIReadOnlyListEnvelope<PSCustomObject>
...
BudgetAccountEntryDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBudgetAccountEntryDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BudgetAccountEntryDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BudgetAccountEntryDtoIReadOnlyListEnvelope
