...
ShipmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShipmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShipmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShipmentDtoListEnvelope<PSCustomObject>
...
ShipmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShipmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShipmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShipmentDtoListEnvelope
