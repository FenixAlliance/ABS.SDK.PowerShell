...
DealUnitLineDto<PSCustomObject>
#>

function Initialize-DealUnitLineDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitLineDto' | Write-Debug
...
Convert from JSON to DealUnitLineDto<PSCustomObject>
...
DealUnitLineDto<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitLineDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitLineDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitLineDto
