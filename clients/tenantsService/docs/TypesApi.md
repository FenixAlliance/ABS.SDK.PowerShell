...
[**Invoke-PatchTenantType**](TypesApi.md#Invoke-PatchTenantType) | **PATCH** /api/v2/TenantsService/Types/{tenantTypeId} | Patch a tenant type
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantTypeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantTypeDtoCollectionQueryParameters = Initialize-TenantTypeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TenantTypeDtoCollectionQueryParameters |  (optional)

# Retrieve a list of tenant types
try {
    $Result = Get-TenantTypes -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantTypeDtoCollectionQueryParameters $TenantTypeDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant types
try {
    $Result = Get-TenantTypesCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantTypeDtoCollectionQueryParameters $TenantTypeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTenantType"></a>
# **Invoke-PatchTenantType**
> EmptyEnvelope Invoke-PatchTenantType<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantTypeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tenant type
try {
    $Result = Invoke-PatchTenantType -TenantId $TenantId -TenantTypeId $TenantTypeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTenantType: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
