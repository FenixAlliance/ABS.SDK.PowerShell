...
CognitiveAgentConversationDtoListEnvelope<PSCustomObject>
#>

function Initialize-CognitiveAgentConversationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CognitiveAgentConversationDtoListEnvelope' | Write-Debug
...
Convert from JSON to CognitiveAgentConversationDtoListEnvelope<PSCustomObject>
...
CognitiveAgentConversationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCognitiveAgentConversationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CognitiveAgentConversationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CognitiveAgentConversationDtoListEnvelope
