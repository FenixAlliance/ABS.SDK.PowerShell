...
# Patch a marketing list
try {
    $Result = Invoke-PatchMarketingListAsync -TenantId $TenantId -MarketinglistId $MarketinglistId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
