...
AssetRepairDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetRepairDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetRepairDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetRepairDtoListEnvelope<PSCustomObject>
...
AssetRepairDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetRepairDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetRepairDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetRepairDtoListEnvelope
