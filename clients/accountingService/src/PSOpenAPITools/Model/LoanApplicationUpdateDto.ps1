...
LoanApplicationUpdateDto<PSCustomObject>
#>

function Initialize-LoanApplicationUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanApplicationUpdateDto' | Write-Debug
...
Convert from JSON to LoanApplicationUpdateDto<PSCustomObject>
...
LoanApplicationUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToLoanApplicationUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanApplicationUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanApplicationUpdateDto
        $AllProperties = ("tenantId", "enrollmentId")
