...
function ConvertFrom-JsonToDealUnitCreateDto {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "dealUnitLines"))) { #optional property not found
            $DealUnitLines = $null
        } else {
            $DealUnitLines = $JsonParameters.PSobject.Properties["dealUnitLines"].value
        }
