...
TenantIndustryDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantIndustryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantIndustryDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantIndustryDtoListEnvelope<PSCustomObject>
...
TenantIndustryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantIndustryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantIndustryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantIndustryDtoListEnvelope
