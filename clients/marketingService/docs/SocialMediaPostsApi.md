...
[**Invoke-PatchSocialMediaPostAsync**](SocialMediaPostsApi.md#Invoke-PatchSocialMediaPostAsync) | **PATCH** /api/v2/MarketingService/SocialMediaPosts/{socialmediapostId} | Patch a social media post
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SocialMediaPostDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$SocialMediaPostDtoCollectionQueryParameters = Initialize-SocialMediaPostDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # SocialMediaPostDtoCollectionQueryParameters |  (optional)

# Get social media posts count
try {
    $Result = Get-SocialMediaPostsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SocialMediaPostDtoCollectionQueryParameters $SocialMediaPostDtoCollectionQueryParameters
} catch {
...
# Get social media posts
try {
    $Result = Get-SocialMediaPostsODataAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SocialMediaPostDtoCollectionQueryParameters $SocialMediaPostDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSocialMediaPostAsync"></a>
# **Invoke-PatchSocialMediaPostAsync**
> EmptyEnvelope Invoke-PatchSocialMediaPostAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SocialmediapostId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a social media post
try {
    $Result = Invoke-PatchSocialMediaPostAsync -TenantId $TenantId -SocialmediapostId $SocialmediapostId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSocialMediaPostAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
