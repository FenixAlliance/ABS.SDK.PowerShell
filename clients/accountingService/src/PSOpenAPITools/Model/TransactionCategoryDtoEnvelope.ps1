...
TransactionCategoryDtoEnvelope<PSCustomObject>
#>

function Initialize-TransactionCategoryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TransactionCategoryDtoEnvelope' | Write-Debug
...
Convert from JSON to TransactionCategoryDtoEnvelope<PSCustomObject>
...
TransactionCategoryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTransactionCategoryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TransactionCategoryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TransactionCategoryDtoEnvelope
