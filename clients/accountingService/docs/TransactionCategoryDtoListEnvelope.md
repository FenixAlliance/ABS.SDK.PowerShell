...
```powershell
$TransactionCategoryDtoListEnvelope = Initialize-PSOpenAPIToolsTransactionCategoryDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TransactionCategoryDtoListEnvelope | ConvertTo-JSON
```
