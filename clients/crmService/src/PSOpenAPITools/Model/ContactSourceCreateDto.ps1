...
ContactSourceCreateDto<PSCustomObject>
#>

function Initialize-ContactSourceCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactSourceCreateDto' | Write-Debug
...
Convert from JSON to ContactSourceCreateDto<PSCustomObject>
...
ContactSourceCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactSourceCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactSourceCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactSourceCreateDto
