...
SupportEntitlementDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportEntitlementDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportEntitlementDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportEntitlementDtoEnvelope<PSCustomObject>
...
SupportEntitlementDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportEntitlementDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportEntitlementDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportEntitlementDtoEnvelope
