...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InquiryRequestDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$InquiryRequestDtoCollectionQueryParameters = Initialize-InquiryRequestDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # InquiryRequestDtoCollectionQueryParameters |  (optional)

# Retrieve inquiry requests
try {
    $Result = Get-InquiryRequestsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -InquiryRequestDtoCollectionQueryParameters $InquiryRequestDtoCollectionQueryParameters
} catch {
...
# Get inquiry requests count
try {
    $Result = Get-InquiryRequestsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -InquiryRequestDtoCollectionQueryParameters $InquiryRequestDtoCollectionQueryParameters
} catch {
...
# Patch an inquiry request
try {
    $Result = Invoke-PatchInquiryRequestAsync -TenantId $TenantId -InquiryRequestId $InquiryRequestId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
