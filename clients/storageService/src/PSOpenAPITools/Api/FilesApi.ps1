...
.PARAMETER SocialProfileIdValue
No description available.
...
function New-FileAsync {
    ...
    Param (
        ...
        [ValidateSet("Unknown", "IdentityAvatar", "IdentityBanner", "ProfileAsset", "EngagementInline", "EngagementAttachment", "MessageAttachment", "SocialPost", "RecordAttachment", "AiGenerated", "SystemArtifact", "Temporary")]
        [String]
        ${Purpose},
        [Parameter(Position = 16, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
        ${SocialProfileIdValue},
    ...
    Process {
        ...
        if ($PublicAccessType) {
            $LocalVarFormParameters['publicAccessType'] = $PublicAccessType
        }
        ...
        if ($SocialProfileIdValue) {
            $LocalVarFormParameters['socialProfileId.value'] = $SocialProfileIdValue
        }
...
System.IO.FileInfo
#>
function Get-FileThumbnailAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-FileThumbnailAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/StorageService/Files/{fileId}/Thumbnail'
        if (!$FileId) {
            throw "Error! The required parameter `FileId` missing when calling getFileThumbnailAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{fileId}', [System.Web.HTTPUtility]::UrlEncode($FileId))
...
function Get-FilesCountAsync {
    ...
    Process {
        'Calling method: Get-FilesCountAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
