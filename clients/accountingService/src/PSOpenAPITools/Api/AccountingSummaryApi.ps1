...
function Get-CreditsSumAsync {
    ...
    Process {
        'Calling method: Get-CreditsSumAsync' | Write-Debug
        ...
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getCreditsSumAsync."
        }
...
function Get-DebitsSumAsync {
    ...
    Process {
        'Calling method: Get-DebitsSumAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getDebitsSumAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
...
function Get-ExpensesSumAsync {
    ...
    Process {
        'Calling method: Get-ExpensesSumAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getExpensesSumAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
...
function Get-IncomesSumAsync {
    ...
    Process {
        'Calling method: Get-IncomesSumAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getIncomesSumAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
