...
```powershell
$LocalizationStringDtoListEnvelope = Initialize-PSOpenAPIToolsLocalizationStringDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$LocalizationStringDtoListEnvelope | ConvertTo-JSON
```
