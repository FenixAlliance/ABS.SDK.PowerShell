...
ReturnRequestDtoEnvelope<PSCustomObject>
#>

function Initialize-ReturnRequestDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReturnRequestDtoEnvelope' | Write-Debug
...
Convert from JSON to ReturnRequestDtoEnvelope<PSCustomObject>
...
ReturnRequestDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToReturnRequestDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReturnRequestDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReturnRequestDtoEnvelope
