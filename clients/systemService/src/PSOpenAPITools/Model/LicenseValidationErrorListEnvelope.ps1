...
LicenseValidationErrorListEnvelope<PSCustomObject>
#>

function Initialize-LicenseValidationErrorListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseValidationErrorListEnvelope' | Write-Debug
...
Convert from JSON to LicenseValidationErrorListEnvelope<PSCustomObject>
...
LicenseValidationErrorListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseValidationErrorListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseValidationErrorListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseValidationErrorListEnvelope
