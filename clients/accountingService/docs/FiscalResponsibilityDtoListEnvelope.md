...
```powershell
$FiscalResponsibilityDtoListEnvelope = Initialize-PSOpenAPIToolsFiscalResponsibilityDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$FiscalResponsibilityDtoListEnvelope | ConvertTo-JSON
```
