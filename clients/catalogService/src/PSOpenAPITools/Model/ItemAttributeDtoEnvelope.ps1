...
ItemAttributeDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemAttributeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemAttributeDtoEnvelope<PSCustomObject>
...
ItemAttributeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeDtoEnvelope
