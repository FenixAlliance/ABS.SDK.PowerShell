...
ItemImageDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemImageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemImageDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemImageDtoListEnvelope<PSCustomObject>
...
ItemImageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemImageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemImageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemImageDtoListEnvelope
