...
FileUploadDtoEnvelope<PSCustomObject>
#>

function Initialize-FileUploadDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FileUploadDtoEnvelope' | Write-Debug
...
Convert from JSON to FileUploadDtoEnvelope<PSCustomObject>
...
FileUploadDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFileUploadDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FileUploadDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FileUploadDtoEnvelope
