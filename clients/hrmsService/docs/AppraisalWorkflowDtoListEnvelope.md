...
```powershell
$AppraisalWorkflowDtoListEnvelope = Initialize-PSOpenAPIToolsAppraisalWorkflowDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$AppraisalWorkflowDtoListEnvelope | ConvertTo-JSON
```
