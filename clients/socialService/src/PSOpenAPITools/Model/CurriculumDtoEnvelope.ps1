...
CurriculumDtoEnvelope<PSCustomObject>
#>

function Initialize-CurriculumDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurriculumDtoEnvelope' | Write-Debug
...
Convert from JSON to CurriculumDtoEnvelope<PSCustomObject>
...
CurriculumDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurriculumDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurriculumDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurriculumDtoEnvelope
