...
JobOfferApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-JobOfferApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobOfferApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to JobOfferApplicationDtoEnvelope<PSCustomObject>
...
JobOfferApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobOfferApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobOfferApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobOfferApplicationDtoEnvelope
