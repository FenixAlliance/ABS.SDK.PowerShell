...
WebTemplateDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebTemplateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebTemplateDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebTemplateDtoListEnvelope<PSCustomObject>
...
WebTemplateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebTemplateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebTemplateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebTemplateDtoListEnvelope
