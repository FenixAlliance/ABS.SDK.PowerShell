...
QuoteLineDto<PSCustomObject>
#>

function Initialize-QuoteLineDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineDto' | Write-Debug
...
Convert from JSON to QuoteLineDto<PSCustomObject>
...
QuoteLineDto<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineDto
