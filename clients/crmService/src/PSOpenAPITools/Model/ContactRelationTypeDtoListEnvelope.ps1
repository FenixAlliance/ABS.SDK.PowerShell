...
ContactRelationTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactRelationTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactRelationTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactRelationTypeDtoListEnvelope<PSCustomObject>
...
ContactRelationTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactRelationTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactRelationTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactRelationTypeDtoListEnvelope
