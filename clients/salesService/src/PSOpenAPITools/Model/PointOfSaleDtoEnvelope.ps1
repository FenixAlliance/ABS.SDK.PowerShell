...
PointOfSaleDtoEnvelope<PSCustomObject>
#>

function Initialize-PointOfSaleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PointOfSaleDtoEnvelope' | Write-Debug
...
Convert from JSON to PointOfSaleDtoEnvelope<PSCustomObject>
...
PointOfSaleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPointOfSaleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PointOfSaleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PointOfSaleDtoEnvelope
