...
ShippingClassDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingClassDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingClassDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingClassDtoEnvelope<PSCustomObject>
...
ShippingClassDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingClassDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingClassDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingClassDtoEnvelope
