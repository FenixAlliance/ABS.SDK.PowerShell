...
UnitDtoEnvelope<PSCustomObject>
#>

function Initialize-UnitDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UnitDtoEnvelope' | Write-Debug
...
Convert from JSON to UnitDtoEnvelope<PSCustomObject>
...
UnitDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUnitDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UnitDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UnitDtoEnvelope
