...
CountryLanguageDtoEnvelope<PSCustomObject>
#>

function Initialize-CountryLanguageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryLanguageDtoEnvelope' | Write-Debug
...
Convert from JSON to CountryLanguageDtoEnvelope<PSCustomObject>
...
CountryLanguageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryLanguageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryLanguageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryLanguageDtoEnvelope
