...
ExchangeRateEnvelope<PSCustomObject>
#>

function Initialize-ExchangeRateEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExchangeRateEnvelope' | Write-Debug
...
Convert from JSON to ExchangeRateEnvelope<PSCustomObject>
...
ExchangeRateEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExchangeRateEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExchangeRateEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExchangeRateEnvelope
