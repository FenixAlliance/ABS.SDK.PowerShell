...
TruckDriverDtoListEnvelope<PSCustomObject>
#>

function Initialize-TruckDriverDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TruckDriverDtoListEnvelope' | Write-Debug
...
Convert from JSON to TruckDriverDtoListEnvelope<PSCustomObject>
...
TruckDriverDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTruckDriverDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TruckDriverDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TruckDriverDtoListEnvelope
