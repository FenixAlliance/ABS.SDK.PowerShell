...
MarketingAreaDtoEnvelope<PSCustomObject>
#>

function Initialize-MarketingAreaDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingAreaDtoEnvelope' | Write-Debug
...
Convert from JSON to MarketingAreaDtoEnvelope<PSCustomObject>
...
MarketingAreaDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingAreaDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingAreaDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingAreaDtoEnvelope
