...
SubscriptionDtoEnvelope<PSCustomObject>
#>

function Initialize-SubscriptionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SubscriptionDtoEnvelope' | Write-Debug
...
Convert from JSON to SubscriptionDtoEnvelope<PSCustomObject>
...
SubscriptionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSubscriptionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SubscriptionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SubscriptionDtoEnvelope
