...
BlogPostCategoryDto<PSCustomObject>
#>

function Initialize-BlogPostCategoryDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostCategoryDto' | Write-Debug
...
Convert from JSON to BlogPostCategoryDto<PSCustomObject>
...
BlogPostCategoryDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostCategoryDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostCategoryDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostCategoryDto
        $AllProperties = ("id", "timestamp", "slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalID", "businessID", "businessProfileRecordID")
