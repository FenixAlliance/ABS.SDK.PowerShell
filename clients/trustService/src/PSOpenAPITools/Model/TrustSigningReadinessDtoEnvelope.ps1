...
TrustSigningReadinessDtoEnvelope<PSCustomObject>
#>

function Initialize-TrustSigningReadinessDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrustSigningReadinessDtoEnvelope' | Write-Debug
...
Convert from JSON to TrustSigningReadinessDtoEnvelope<PSCustomObject>
...
TrustSigningReadinessDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrustSigningReadinessDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrustSigningReadinessDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrustSigningReadinessDtoEnvelope
