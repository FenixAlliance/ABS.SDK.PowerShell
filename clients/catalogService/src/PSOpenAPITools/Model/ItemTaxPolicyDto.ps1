...
ItemTaxPolicyDto<PSCustomObject>
#>

function Initialize-ItemTaxPolicyDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyDto' | Write-Debug
...
Convert from JSON to ItemTaxPolicyDto<PSCustomObject>
...
ItemTaxPolicyDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyDto
        $AllProperties = ("id", "timestamp", "zero", "reduced", "withholding", "fiscalAuthorityID", "type", "code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyID", "countryID", "countryStateID", "customState", "customCity", "cityID", "businessID", "businessProfileRecordID")
