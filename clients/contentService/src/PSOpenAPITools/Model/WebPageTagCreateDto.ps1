...
WebPageTagCreateDto<PSCustomObject>
#>

function Initialize-WebPageTagCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageTagCreateDto' | Write-Debug
...
Convert from JSON to WebPageTagCreateDto<PSCustomObject>
...
WebPageTagCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageTagCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageTagCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageTagCreateDto
