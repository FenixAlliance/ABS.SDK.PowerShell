...
ExtendedTenantEnrollmentDto<PSCustomObject>
#>

function Initialize-ExtendedTenantEnrollmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDto' | Write-Debug
...
Convert from JSON to ExtendedTenantEnrollmentDto<PSCustomObject>
...
ExtendedTenantEnrollmentDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantEnrollmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantEnrollmentDto
        $AllProperties = ("id", "timestamp", "tenantId", "userId", "isRoot", "isOwner", "isAdmin", "isDisabled", "tenant", "user")
