...
```powershell
$ItemShippingPolicyDtoListEnvelope = Initialize-PSOpenAPIToolsItemShippingPolicyDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ItemShippingPolicyDtoListEnvelope | ConvertTo-JSON
```
