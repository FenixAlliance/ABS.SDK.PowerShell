...
PaymentMethodUpdateDto<PSCustomObject>
#>

function Initialize-PaymentMethodUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentMethodUpdateDto' | Write-Debug
...
Convert from JSON to PaymentMethodUpdateDto<PSCustomObject>
...
PaymentMethodUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentMethodUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentMethodUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentMethodUpdateDto
