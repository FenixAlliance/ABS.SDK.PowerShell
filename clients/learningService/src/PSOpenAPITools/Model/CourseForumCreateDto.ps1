...
CourseForumCreateDto<PSCustomObject>
#>

function Initialize-CourseForumCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseForumCreateDto' | Write-Debug
...
Convert from JSON to CourseForumCreateDto<PSCustomObject>
...
CourseForumCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToCourseForumCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseForumCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseForumCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "courseID", "businessID")
