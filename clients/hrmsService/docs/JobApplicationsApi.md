...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JobOfferApplicationDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$JobOfferApplicationDtoCollectionQueryParameters = Initialize-JobOfferApplicationDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # JobOfferApplicationDtoCollectionQueryParameters |  (optional)

# Get job applications
try {
    $Result = Get-JobApplicationsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JobOfferApplicationDtoCollectionQueryParameters $JobOfferApplicationDtoCollectionQueryParameters
} catch {
...
# Count job applications
try {
    $Result = Get-JobApplicationsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JobOfferApplicationDtoCollectionQueryParameters $JobOfferApplicationDtoCollectionQueryParameters
} catch {
...
# Patch a job application
try {
    $Result = Invoke-PatchJobApplicationAsync -TenantId $TenantId -JobApplicationId $JobApplicationId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
