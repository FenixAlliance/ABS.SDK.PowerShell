...
JobTitleDtoListEnvelope<PSCustomObject>
#>

function Initialize-JobTitleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobTitleDtoListEnvelope' | Write-Debug
...
Convert from JSON to JobTitleDtoListEnvelope<PSCustomObject>
...
JobTitleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobTitleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobTitleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobTitleDtoListEnvelope
