...
AppliedTaxPolicyRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-AppliedTaxPolicyRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to AppliedTaxPolicyRecordDtoListEnvelope<PSCustomObject>
...
AppliedTaxPolicyRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppliedTaxPolicyRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppliedTaxPolicyRecordDtoListEnvelope
