...
BlogPostDtoEnvelope<PSCustomObject>
#>

function Initialize-BlogPostDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostDtoEnvelope' | Write-Debug
...
Convert from JSON to BlogPostDtoEnvelope<PSCustomObject>
...
BlogPostDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostDtoEnvelope
