...
ItemTaxPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemTaxPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemTaxPolicyDtoListEnvelope<PSCustomObject>
...
ItemTaxPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyDtoListEnvelope
