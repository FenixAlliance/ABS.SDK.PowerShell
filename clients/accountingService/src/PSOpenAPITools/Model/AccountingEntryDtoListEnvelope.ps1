...
AccountingEntryDtoListEnvelope<PSCustomObject>
#>

function Initialize-AccountingEntryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountingEntryDtoListEnvelope' | Write-Debug
...
Convert from JSON to AccountingEntryDtoListEnvelope<PSCustomObject>
...
AccountingEntryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountingEntryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountingEntryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountingEntryDtoListEnvelope
