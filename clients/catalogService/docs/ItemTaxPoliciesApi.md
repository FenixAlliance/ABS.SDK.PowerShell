...
# Count item tax policies
try {
    $Result = Invoke-CountItemTaxPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemTaxPolicyDtoCollectionQueryParameters $ItemTaxPolicyDtoCollectionQueryParameters
} catch {
...
# Get item tax policies
try {
    $Result = Get-ItemTaxPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemTaxPolicyDtoCollectionQueryParameters $ItemTaxPolicyDtoCollectionQueryParameters
} catch {
...
# Get item tax policy by ID
try {
    $Result = Get-ItemTaxPolicyByIdAsync -ItemTaxPolicyId $ItemTaxPolicyId -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
