...
InvoiceLineDtoEnvelope<PSCustomObject>
#>

function Initialize-InvoiceLineDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceLineDtoEnvelope' | Write-Debug
...
Convert from JSON to InvoiceLineDtoEnvelope<PSCustomObject>
...
InvoiceLineDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceLineDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceLineDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceLineDtoEnvelope
