...
ModuleGrantDtoListEnvelope<PSCustomObject>
#>

function Initialize-ModuleGrantDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleGrantDtoListEnvelope' | Write-Debug
...
Convert from JSON to ModuleGrantDtoListEnvelope<PSCustomObject>
...
ModuleGrantDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToModuleGrantDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleGrantDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleGrantDtoListEnvelope
