...
```powershell
$TenantTeamContactEnrollmentDtoListEnvelope = Initialize-PSOpenAPIToolsTenantTeamContactEnrollmentDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TenantTeamContactEnrollmentDtoListEnvelope | ConvertTo-JSON
```
