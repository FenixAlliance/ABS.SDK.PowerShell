...
BillOfLadingDtoListEnvelope<PSCustomObject>
#>

function Initialize-BillOfLadingDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillOfLadingDtoListEnvelope' | Write-Debug
...
Convert from JSON to BillOfLadingDtoListEnvelope<PSCustomObject>
...
BillOfLadingDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBillOfLadingDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillOfLadingDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillOfLadingDtoListEnvelope
