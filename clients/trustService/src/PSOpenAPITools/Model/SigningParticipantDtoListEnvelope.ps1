...
SigningParticipantDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningParticipantDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningParticipantDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningParticipantDtoListEnvelope<PSCustomObject>
...
SigningParticipantDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningParticipantDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningParticipantDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningParticipantDtoListEnvelope
