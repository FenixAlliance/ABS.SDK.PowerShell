...
AuthResultEnvelope<PSCustomObject>
#>

function Initialize-AuthResultEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthResultEnvelope' | Write-Debug
...
Convert from JSON to AuthResultEnvelope<PSCustomObject>
...
AuthResultEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAuthResultEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthResultEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthResultEnvelope
