...
[**Invoke-PatchTimeIntervalAsync**](TimeIntervalsApi.md#Invoke-PatchTimeIntervalAsync) | **PATCH** /api/v2/HrmsService/TimeIntervals/{timeIntervalId} | Patch a time interval
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TimeIntervalDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TimeIntervalDtoCollectionQueryParameters = Initialize-TimeIntervalDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TimeIntervalDtoCollectionQueryParameters |  (optional)

# Get time intervals
try {
    $Result = Get-TimeIntervalsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TimeIntervalDtoCollectionQueryParameters $TimeIntervalDtoCollectionQueryParameters
} catch {
...
# Count time intervals
try {
    $Result = Get-TimeIntervalsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TimeIntervalDtoCollectionQueryParameters $TimeIntervalDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTimeIntervalAsync"></a>
# **Invoke-PatchTimeIntervalAsync**
> EmptyEnvelope Invoke-PatchTimeIntervalAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TimeIntervalId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a time interval
try {
    $Result = Invoke-PatchTimeIntervalAsync -TenantId $TenantId -TimeIntervalId $TimeIntervalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTimeIntervalAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
