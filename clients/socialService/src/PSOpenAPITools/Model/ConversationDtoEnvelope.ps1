...
ConversationDtoEnvelope<PSCustomObject>
#>

function Initialize-ConversationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversationDtoEnvelope' | Write-Debug
...
Convert from JSON to ConversationDtoEnvelope<PSCustomObject>
...
ConversationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToConversationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversationDtoEnvelope
