...
SupplierProfileCreateDto<PSCustomObject>
#>

function Initialize-SupplierProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupplierProfileCreateDto' | Write-Debug
...
Convert from JSON to SupplierProfileCreateDto<PSCustomObject>
...
SupplierProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSupplierProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupplierProfileCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupplierProfileCreateDto
