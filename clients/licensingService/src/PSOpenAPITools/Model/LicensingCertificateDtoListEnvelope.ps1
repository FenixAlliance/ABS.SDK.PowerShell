...
LicensingCertificateDtoListEnvelope<PSCustomObject>
#>

function Initialize-LicensingCertificateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicensingCertificateDtoListEnvelope' | Write-Debug
...
Convert from JSON to LicensingCertificateDtoListEnvelope<PSCustomObject>
...
LicensingCertificateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicensingCertificateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicensingCertificateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicensingCertificateDtoListEnvelope
