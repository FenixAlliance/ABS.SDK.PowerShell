...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RoundingPolicyDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$RoundingPolicyDtoCollectionQueryParameters = Initialize-RoundingPolicyDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # RoundingPolicyDtoCollectionQueryParameters |  (optional)

# Gets all rounding policies
try {
    $Result = Get-RoundingPoliciesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -RoundingPolicyDtoCollectionQueryParameters $RoundingPolicyDtoCollectionQueryParameters
} catch {
...
# Counts rounding policies
try {
    $Result = Get-RoundingPoliciesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -RoundingPolicyDtoCollectionQueryParameters $RoundingPolicyDtoCollectionQueryParameters
} catch {
...
# Patches a rounding policy
try {
    $Result = Invoke-PatchRoundingPolicyAsync -TenantId $TenantId -RoundingPolicyId $RoundingPolicyId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
