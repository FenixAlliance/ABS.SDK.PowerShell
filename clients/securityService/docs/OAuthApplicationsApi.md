...
[**Invoke-PatchOAuthApplicationAsync**](OAuthApplicationsApi.md#Invoke-PatchOAuthApplicationAsync) | **PATCH** /api/v2/SecurityService/OAuthApplications/{applicationId} | Patch an existing OAuth application
...
<a id="Invoke-PatchOAuthApplicationAsync"></a>
# **Invoke-PatchOAuthApplicationAsync**
