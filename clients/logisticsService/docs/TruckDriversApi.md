...
[**Invoke-PatchTruckDriverAsync**](TruckDriversApi.md#Invoke-PatchTruckDriverAsync) | **PATCH** /api/v2/LogisticsService/TruckDrivers/{driverId} | Patch a truck driver
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TruckDriverDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TruckDriverDtoCollectionQueryParameters = Initialize-TruckDriverDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TruckDriverDtoCollectionQueryParameters |  (optional)

# Get all truck drivers
try {
    $Result = Get-TruckDriversAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TruckDriverDtoCollectionQueryParameters $TruckDriverDtoCollectionQueryParameters
} catch {
...
# Get truck drivers count
try {
    $Result = Get-TruckDriversCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TruckDriverDtoCollectionQueryParameters $TruckDriverDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTruckDriverAsync"></a>
# **Invoke-PatchTruckDriverAsync**
> EmptyEnvelope Invoke-PatchTruckDriverAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-DriverId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a truck driver
try {
    $Result = Invoke-PatchTruckDriverAsync -TenantId $TenantId -DriverId $DriverId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTruckDriverAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
