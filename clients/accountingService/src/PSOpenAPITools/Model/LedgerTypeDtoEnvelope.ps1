...
LedgerTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-LedgerTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LedgerTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to LedgerTypeDtoEnvelope<PSCustomObject>
...
LedgerTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLedgerTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LedgerTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LedgerTypeDtoEnvelope
