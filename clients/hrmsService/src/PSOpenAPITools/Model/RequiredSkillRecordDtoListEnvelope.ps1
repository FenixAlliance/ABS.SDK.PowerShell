...
RequiredSkillRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-RequiredSkillRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RequiredSkillRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to RequiredSkillRecordDtoListEnvelope<PSCustomObject>
...
RequiredSkillRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRequiredSkillRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RequiredSkillRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequiredSkillRecordDtoListEnvelope
