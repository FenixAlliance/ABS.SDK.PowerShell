...
InstructorProfileDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-InstructorProfileDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InstructorProfileDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to InstructorProfileDtoIReadOnlyListEnvelope<PSCustomObject>
...
InstructorProfileDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInstructorProfileDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InstructorProfileDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InstructorProfileDtoIReadOnlyListEnvelope
