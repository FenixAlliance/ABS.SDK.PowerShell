...
CountryStateDtoListEnvelope<PSCustomObject>
#>

function Initialize-CountryStateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryStateDtoListEnvelope' | Write-Debug
...
Convert from JSON to CountryStateDtoListEnvelope<PSCustomObject>
...
CountryStateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryStateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryStateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryStateDtoListEnvelope
