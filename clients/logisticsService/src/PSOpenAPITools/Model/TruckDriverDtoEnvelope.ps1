...
TruckDriverDtoEnvelope<PSCustomObject>
#>

function Initialize-TruckDriverDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TruckDriverDtoEnvelope' | Write-Debug
...
Convert from JSON to TruckDriverDtoEnvelope<PSCustomObject>
...
TruckDriverDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTruckDriverDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TruckDriverDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TruckDriverDtoEnvelope
