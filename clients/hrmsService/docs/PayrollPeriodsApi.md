...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PayrollPeriodDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$PayrollPeriodDtoCollectionQueryParameters = Initialize-PayrollPeriodDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # PayrollPeriodDtoCollectionQueryParameters |  (optional)

# Get payroll periods
try {
    $Result = Get-PayrollPeriodsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PayrollPeriodDtoCollectionQueryParameters $PayrollPeriodDtoCollectionQueryParameters
} catch {
...
# Count payroll periods
try {
    $Result = Get-PayrollPeriodsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PayrollPeriodDtoCollectionQueryParameters $PayrollPeriodDtoCollectionQueryParameters
} catch {
