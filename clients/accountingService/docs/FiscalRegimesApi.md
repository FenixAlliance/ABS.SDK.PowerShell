...
[**Invoke-PatchFiscalRegimeAsync**](FiscalRegimesApi.md#Invoke-PatchFiscalRegimeAsync) | **PATCH** /api/v2/AccountingService/Fiscals/Authorities/FiscalRegimes/{regimeId} | Patch a fiscal regime
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FiscalRegimeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$FiscalRegimeDtoCollectionQueryParameters = Initialize-FiscalRegimeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # FiscalRegimeDtoCollectionQueryParameters |  (optional)

# Get fiscal regimes for an authority
try {
    $Result = Get-FiscalRegimes -TenantId $TenantId -FiscalAuthorityId $FiscalAuthorityId -AuthorityId $AuthorityId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -FiscalRegimeDtoCollectionQueryParameters $FiscalRegimeDtoCollectionQueryParameters
} catch {
...
# Get fiscal regimes count
try {
    $Result = Get-FiscalRegimesCount -TenantId $TenantId -FiscalAuthorityId $FiscalAuthorityId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -FiscalRegimeDtoCollectionQueryParameters $FiscalRegimeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchFiscalRegimeAsync"></a>
# **Invoke-PatchFiscalRegimeAsync**
> EmptyEnvelope Invoke-PatchFiscalRegimeAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RegimeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a fiscal regime
try {
    $Result = Invoke-PatchFiscalRegimeAsync -TenantId $TenantId -RegimeId $RegimeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchFiscalRegimeAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
