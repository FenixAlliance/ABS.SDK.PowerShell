...
```powershell
$SupportEntitlementDtoListEnvelope = Initialize-PSOpenAPIToolsSupportEntitlementDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$SupportEntitlementDtoListEnvelope | ConvertTo-JSON
```
