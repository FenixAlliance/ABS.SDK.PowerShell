...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-CurriculumDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$CurriculumDtoCollectionQueryParameters = Initialize-CurriculumDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # CurriculumDtoCollectionQueryParameters |  (optional)

# Get curricula
try {
    $Result = Get-CurriculumsAsync -SocialProfileId $SocialProfileId -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CurriculumDtoCollectionQueryParameters $CurriculumDtoCollectionQueryParameters
} catch {
...
# Count curricula
try {
    $Result = Get-CurriculumsCountAsync -SocialProfileId $SocialProfileId -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CurriculumDtoCollectionQueryParameters $CurriculumDtoCollectionQueryParameters
} catch {
...
# Patch a curriculum
try {
    $Result = Invoke-PatchCurriculumAsync -SocialProfileId $SocialProfileId -CurriculumId $CurriculumId -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
