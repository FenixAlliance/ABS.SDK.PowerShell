...
PaymentTokenDtoEnvelope<PSCustomObject>
#>

function Initialize-PaymentTokenDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentTokenDtoEnvelope' | Write-Debug
...
Convert from JSON to PaymentTokenDtoEnvelope<PSCustomObject>
...
PaymentTokenDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentTokenDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentTokenDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentTokenDtoEnvelope
