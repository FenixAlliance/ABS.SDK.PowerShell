...
WaybillLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-WaybillLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WaybillLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to WaybillLineDtoListEnvelope<PSCustomObject>
...
WaybillLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWaybillLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WaybillLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WaybillLineDtoListEnvelope
