...
SocialGroupCreateDto<PSCustomObject>
#>

function Initialize-SocialGroupCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialGroupCreateDto' | Write-Debug
...
Convert from JSON to SocialGroupCreateDto<PSCustomObject>
...
SocialGroupCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialGroupCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialGroupCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
