...
PricingRuleDtoEnvelope<PSCustomObject>
#>

function Initialize-PricingRuleDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PricingRuleDtoEnvelope' | Write-Debug
...
Convert from JSON to PricingRuleDtoEnvelope<PSCustomObject>
...
PricingRuleDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPricingRuleDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PricingRuleDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PricingRuleDtoEnvelope
