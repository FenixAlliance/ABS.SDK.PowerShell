...
SupportTicketDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketDtoEnvelope<PSCustomObject>
...
SupportTicketDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketDtoEnvelope
