...
OrderDtoEnvelope<PSCustomObject>
#>

function Initialize-OrderDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderDtoEnvelope' | Write-Debug
...
Convert from JSON to OrderDtoEnvelope<PSCustomObject>
...
OrderDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOrderDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderDtoEnvelope
