...
ExtendedTenantEnrollmentDtoEnvelope<PSCustomObject>
#>

function Initialize-ExtendedTenantEnrollmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDtoEnvelope' | Write-Debug
...
Convert from JSON to ExtendedTenantEnrollmentDtoEnvelope<PSCustomObject>
...
ExtendedTenantEnrollmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantEnrollmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantEnrollmentDtoEnvelope
