...
function ConvertFrom-JsonToRefundRequestDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "enrollmentId", "supportEntitlementId", "contactId", "userId", "refundPolicyId", "paymentId")
