...
AssetCategoryCreateDto<PSCustomObject>
#>

function Initialize-AssetCategoryCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetCategoryCreateDto' | Write-Debug
...
Convert from JSON to AssetCategoryCreateDto<PSCustomObject>
...
AssetCategoryCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAssetCategoryCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetCategoryCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetCategoryCreateDto
