...
function ConvertFrom-JsonToExtendedInvoiceDto {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "invoiceLines"))) { #optional property not found
            $InvoiceLines = $null
        } else {
            $InvoiceLines = $JsonParameters.PSobject.Properties["invoiceLines"].value
        }
