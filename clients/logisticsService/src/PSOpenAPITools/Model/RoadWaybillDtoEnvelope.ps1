...
RoadWaybillDtoEnvelope<PSCustomObject>
#>

function Initialize-RoadWaybillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RoadWaybillDtoEnvelope' | Write-Debug
...
Convert from JSON to RoadWaybillDtoEnvelope<PSCustomObject>
...
RoadWaybillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRoadWaybillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RoadWaybillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoadWaybillDtoEnvelope
