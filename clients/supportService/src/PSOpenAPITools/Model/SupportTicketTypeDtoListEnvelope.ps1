...
SupportTicketTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketTypeDtoListEnvelope<PSCustomObject>
...
SupportTicketTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketTypeDtoListEnvelope
