...
SupportRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportRequestDtoListEnvelope<PSCustomObject>
...
SupportRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportRequestDtoListEnvelope
