...
[**Invoke-PatchSubscriptionAsync**](SubscriptionsApi.md#Invoke-PatchSubscriptionAsync) | **PATCH** /api/v2/SubscriptionsService/Subscriptions/{subscriptionId} | Patch a subscription
...
# Get all subscriptions
try {
    $Result = Get-SubscriptionsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SubscriptionDtoCollectionQueryParameters $SubscriptionDtoCollectionQueryParameters
} catch {
...
# Get subscriptions count
try {
    $Result = Get-SubscriptionsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SubscriptionDtoCollectionQueryParameters $SubscriptionDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSubscriptionAsync"></a>
# **Invoke-PatchSubscriptionAsync**
> EmptyEnvelope Invoke-PatchSubscriptionAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SubscriptionId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a subscription
try {
    $Result = Invoke-PatchSubscriptionAsync -TenantId $TenantId -SubscriptionId $SubscriptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSubscriptionAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
