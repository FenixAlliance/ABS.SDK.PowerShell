...
CartDtoEnvelope<PSCustomObject>
#>

function Initialize-CartDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CartDtoEnvelope' | Write-Debug
...
Convert from JSON to CartDtoEnvelope<PSCustomObject>
...
CartDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCartDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CartDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CartDtoEnvelope
