...
function ConvertFrom-JsonToInvoiceAdjustmentCreateDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "currencyId", "priority", "code", "description", "surchargePercent", "surchargeAmount", "discountPercent", "discountAmount", "totalSurcharge", "totalDiscount", "type")
