...
ItemTaxPolicyRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemTaxPolicyRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemTaxPolicyRecordDtoListEnvelope<PSCustomObject>
...
ItemTaxPolicyRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyRecordDtoListEnvelope
