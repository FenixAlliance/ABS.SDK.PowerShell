...
ContactsGroupDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactsGroupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactsGroupDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactsGroupDtoListEnvelope<PSCustomObject>
...
ContactsGroupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactsGroupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactsGroupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactsGroupDtoListEnvelope
