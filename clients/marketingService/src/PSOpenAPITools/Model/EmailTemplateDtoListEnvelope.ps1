...
EmailTemplateDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmailTemplateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailTemplateDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmailTemplateDtoListEnvelope<PSCustomObject>
...
EmailTemplateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailTemplateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailTemplateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailTemplateDtoListEnvelope
