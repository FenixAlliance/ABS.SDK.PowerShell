...
ExtendedOrderDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExtendedOrderDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedOrderDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExtendedOrderDtoListEnvelope<PSCustomObject>
...
ExtendedOrderDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedOrderDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedOrderDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedOrderDtoListEnvelope
