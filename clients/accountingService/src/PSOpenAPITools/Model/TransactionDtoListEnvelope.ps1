...
TransactionDtoListEnvelope<PSCustomObject>
#>

function Initialize-TransactionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TransactionDtoListEnvelope' | Write-Debug
...
Convert from JSON to TransactionDtoListEnvelope<PSCustomObject>
...
TransactionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTransactionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TransactionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TransactionDtoListEnvelope
