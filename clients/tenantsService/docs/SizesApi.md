...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantSizeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantSizeDtoCollectionQueryParameters = Initialize-TenantSizeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TenantSizeDtoCollectionQueryParameters |  (optional)

# Retrieve a list of tenant sizes
try {
    $Result = Get-TenantSizes -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantSizeDtoCollectionQueryParameters $TenantSizeDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant sizes
try {
    $Result = Get-TenantSizesCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantSizeDtoCollectionQueryParameters $TenantSizeDtoCollectionQueryParameters
} catch {
...
# Patch a tenant size
try {
    $Result = Invoke-PatchTenantSize -TenantId $TenantId -TenantSizeId $TenantSizeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
