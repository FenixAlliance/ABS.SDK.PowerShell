...
GigDto<PSCustomObject>
#>

function Initialize-GigDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GigDto' | Write-Debug
...
Convert from JSON to GigDto<PSCustomObject>
...
GigDto<PSCustomObject>
#>
function ConvertFrom-JsonToGigDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GigDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GigDto
        $AllProperties = ("id", "timestamp", "remote", "type", "title", "description", "expectedDeliveryDate", "minBudget", "maxBudget", "location", "viewsCount", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "externalUrl", "tenantId", "enrollmentId", "employerProfileId", "currencyId", "countryId", "countryStateId", "cityId")
