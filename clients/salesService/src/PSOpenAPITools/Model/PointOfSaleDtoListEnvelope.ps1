...
PointOfSaleDtoListEnvelope<PSCustomObject>
#>

function Initialize-PointOfSaleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PointOfSaleDtoListEnvelope' | Write-Debug
...
Convert from JSON to PointOfSaleDtoListEnvelope<PSCustomObject>
...
PointOfSaleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPointOfSaleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PointOfSaleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PointOfSaleDtoListEnvelope
