...
PaymentChargebackDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentChargebackDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentChargebackDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentChargebackDtoListEnvelope<PSCustomObject>
...
PaymentChargebackDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentChargebackDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentChargebackDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentChargebackDtoListEnvelope
