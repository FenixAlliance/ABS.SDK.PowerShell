...
CountryDtoEnvelope<PSCustomObject>
#>

function Initialize-CountryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryDtoEnvelope' | Write-Debug
...
Convert from JSON to CountryDtoEnvelope<PSCustomObject>
...
CountryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryDtoEnvelope
