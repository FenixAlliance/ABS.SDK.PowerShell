...
LicenseDtoListEnvelope<PSCustomObject>
#>

function Initialize-LicenseDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseDtoListEnvelope' | Write-Debug
...
Convert from JSON to LicenseDtoListEnvelope<PSCustomObject>
...
LicenseDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseDtoListEnvelope
