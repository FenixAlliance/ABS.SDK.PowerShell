...
ShipmentDtoEnvelope<PSCustomObject>
#>

function Initialize-ShipmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShipmentDtoEnvelope' | Write-Debug
...
Convert from JSON to ShipmentDtoEnvelope<PSCustomObject>
...
ShipmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShipmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShipmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShipmentDtoEnvelope
