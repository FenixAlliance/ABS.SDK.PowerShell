...
AccountDtoEnvelope<PSCustomObject>
#>

function Initialize-AccountDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountDtoEnvelope' | Write-Debug
...
Convert from JSON to AccountDtoEnvelope<PSCustomObject>
...
AccountDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountDtoEnvelope
