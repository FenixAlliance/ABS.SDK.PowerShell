...
TrainingProgramCourseDtoEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramCourseDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramCourseDtoEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramCourseDtoEnvelope<PSCustomObject>
...
TrainingProgramCourseDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramCourseDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramCourseDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramCourseDtoEnvelope
