...
ProofOfDeliveryDtoEnvelope<PSCustomObject>
#>

function Initialize-ProofOfDeliveryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProofOfDeliveryDtoEnvelope' | Write-Debug
...
Convert from JSON to ProofOfDeliveryDtoEnvelope<PSCustomObject>
...
ProofOfDeliveryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProofOfDeliveryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProofOfDeliveryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProofOfDeliveryDtoEnvelope
