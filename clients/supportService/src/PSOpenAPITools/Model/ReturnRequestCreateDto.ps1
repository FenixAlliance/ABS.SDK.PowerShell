...
ReturnRequestCreateDto<PSCustomObject>
#>

function Initialize-ReturnRequestCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReturnRequestCreateDto' | Write-Debug
...
Convert from JSON to ReturnRequestCreateDto<PSCustomObject>
...
ReturnRequestCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToReturnRequestCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReturnRequestCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReturnRequestCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "contactId", "returnPolicyId")
