...
PayrollPeriodDtoListEnvelope<PSCustomObject>
#>

function Initialize-PayrollPeriodDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PayrollPeriodDtoListEnvelope' | Write-Debug
...
Convert from JSON to PayrollPeriodDtoListEnvelope<PSCustomObject>
...
PayrollPeriodDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPayrollPeriodDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PayrollPeriodDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PayrollPeriodDtoListEnvelope
