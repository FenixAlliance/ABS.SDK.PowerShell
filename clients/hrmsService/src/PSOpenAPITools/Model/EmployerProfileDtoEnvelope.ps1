...
EmployerProfileDtoEnvelope<PSCustomObject>
#>

function Initialize-EmployerProfileDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployerProfileDtoEnvelope' | Write-Debug
...
Convert from JSON to EmployerProfileDtoEnvelope<PSCustomObject>
...
EmployerProfileDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployerProfileDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployerProfileDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployerProfileDtoEnvelope
