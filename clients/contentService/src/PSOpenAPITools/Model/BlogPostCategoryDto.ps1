...
function ConvertFrom-JsonToBlogPostCategoryDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "slug", "type", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalId", "tenantId", "enrollmentId")
