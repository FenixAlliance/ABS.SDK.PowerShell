...
BillOfLadingDtoEnvelope<PSCustomObject>
#>

function Initialize-BillOfLadingDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillOfLadingDtoEnvelope' | Write-Debug
...
Convert from JSON to BillOfLadingDtoEnvelope<PSCustomObject>
...
BillOfLadingDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBillOfLadingDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillOfLadingDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillOfLadingDtoEnvelope
