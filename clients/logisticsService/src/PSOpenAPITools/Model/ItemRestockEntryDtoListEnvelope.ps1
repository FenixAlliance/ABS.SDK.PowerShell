...
ItemRestockEntryDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemRestockEntryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRestockEntryDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemRestockEntryDtoListEnvelope<PSCustomObject>
...
ItemRestockEntryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemRestockEntryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRestockEntryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRestockEntryDtoListEnvelope
