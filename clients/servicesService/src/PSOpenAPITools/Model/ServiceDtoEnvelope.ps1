...
ServiceDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceDtoEnvelope<PSCustomObject>
...
ServiceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceDtoEnvelope
