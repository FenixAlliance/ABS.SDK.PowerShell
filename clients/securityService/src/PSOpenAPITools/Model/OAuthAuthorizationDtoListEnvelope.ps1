...
OAuthAuthorizationDtoListEnvelope<PSCustomObject>
#>

function Initialize-OAuthAuthorizationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OAuthAuthorizationDtoListEnvelope' | Write-Debug
...
Convert from JSON to OAuthAuthorizationDtoListEnvelope<PSCustomObject>
...
OAuthAuthorizationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOAuthAuthorizationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OAuthAuthorizationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OAuthAuthorizationDtoListEnvelope
