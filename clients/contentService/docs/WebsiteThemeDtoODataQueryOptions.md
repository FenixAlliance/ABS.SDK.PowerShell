...
**IfMatch** | [**WebsiteThemeDtoETag**](WebsiteThemeDtoETag.md) |  | [optional] 
**IfNoneMatch** | [**WebsiteThemeDtoETag**](WebsiteThemeDtoETag.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$WebsiteThemeDtoODataQueryOptions = Initialize-PSOpenAPIToolsWebsiteThemeDtoODataQueryOptions  -Request null `
 -Context null `
 -RawValues null `
 -SelectExpand null `
 -Apply null `
...
```powershell
$WebsiteThemeDtoODataQueryOptions | ConvertTo-JSON
```
