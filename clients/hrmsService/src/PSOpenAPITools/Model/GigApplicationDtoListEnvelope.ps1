...
GigApplicationDtoListEnvelope<PSCustomObject>
#>

function Initialize-GigApplicationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GigApplicationDtoListEnvelope' | Write-Debug
...
Convert from JSON to GigApplicationDtoListEnvelope<PSCustomObject>
...
GigApplicationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGigApplicationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GigApplicationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GigApplicationDtoListEnvelope
