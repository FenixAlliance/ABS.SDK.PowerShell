...
StringListEnvelope<PSCustomObject>
#>

function Initialize-StringListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StringListEnvelope' | Write-Debug
...
Convert from JSON to StringListEnvelope<PSCustomObject>
...
StringListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStringListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StringListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StringListEnvelope
