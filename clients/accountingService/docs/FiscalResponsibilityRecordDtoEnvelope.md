...
```powershell
$FiscalResponsibilityRecordDtoEnvelope = Initialize-PSOpenAPIToolsFiscalResponsibilityRecordDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$FiscalResponsibilityRecordDtoEnvelope | ConvertTo-JSON
```
