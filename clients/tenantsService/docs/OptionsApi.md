...
[**Invoke-PatchTenantOption**](OptionsApi.md#Invoke-PatchTenantOption) | **PATCH** /api/v2/TenantsService/Options/{optionId} | Patch a tenant option
...
# Retrieve a list of tenant options
try {
    $Result = Get-TenantOptions -TenantId $TenantId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant options
try {
    $Result = Get-TenantOptionsCount -TenantId $TenantId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTenantOption"></a>
# **Invoke-PatchTenantOption**
> EmptyEnvelope Invoke-PatchTenantOption<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OptionId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tenant option
try {
    $Result = Invoke-PatchTenantOption -TenantId $TenantId -OptionId $OptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTenantOption: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
