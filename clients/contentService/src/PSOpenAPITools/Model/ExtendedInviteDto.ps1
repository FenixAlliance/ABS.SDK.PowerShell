...
ExtendedInviteDto<PSCustomObject>
#>

function Initialize-ExtendedInviteDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedInviteDto' | Write-Debug
...
Convert from JSON to ExtendedInviteDto<PSCustomObject>
...
ExtendedInviteDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedInviteDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedInviteDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedInviteDto
        $AllProperties = ("id", "timestamp", "tenantId", "revoked", "redeemed", "redeemedTimestamp", "userEmail", "creatorEnrollmentId", "relatedEnrollmentId", "tenant")
