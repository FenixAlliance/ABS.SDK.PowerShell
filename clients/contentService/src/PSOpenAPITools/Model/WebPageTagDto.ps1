...
WebPageTagDto<PSCustomObject>
#>

function Initialize-WebPageTagDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageTagDto' | Write-Debug
...
Convert from JSON to WebPageTagDto<PSCustomObject>
...
WebPageTagDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageTagDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageTagDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageTagDto
