...
SkillDtoListEnvelope<PSCustomObject>
#>

function Initialize-SkillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SkillDtoListEnvelope' | Write-Debug
...
Convert from JSON to SkillDtoListEnvelope<PSCustomObject>
...
SkillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSkillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SkillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SkillDtoListEnvelope
