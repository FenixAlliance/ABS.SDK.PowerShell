...
StudioModuleListEnvelope<PSCustomObject>
#>

function Initialize-StudioModuleListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StudioModuleListEnvelope' | Write-Debug
...
Convert from JSON to StudioModuleListEnvelope<PSCustomObject>
...
StudioModuleListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStudioModuleListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StudioModuleListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StudioModuleListEnvelope
