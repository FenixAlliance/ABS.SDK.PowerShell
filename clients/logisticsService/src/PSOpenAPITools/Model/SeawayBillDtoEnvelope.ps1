...
SeawayBillDtoEnvelope<PSCustomObject>
#>

function Initialize-SeawayBillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SeawayBillDtoEnvelope' | Write-Debug
...
Convert from JSON to SeawayBillDtoEnvelope<PSCustomObject>
...
SeawayBillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSeawayBillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SeawayBillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SeawayBillDtoEnvelope
