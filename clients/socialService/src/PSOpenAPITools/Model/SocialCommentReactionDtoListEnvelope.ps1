...
SocialCommentReactionDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialCommentReactionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialCommentReactionDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialCommentReactionDtoListEnvelope<PSCustomObject>
...
SocialCommentReactionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialCommentReactionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialCommentReactionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialCommentReactionDtoListEnvelope
