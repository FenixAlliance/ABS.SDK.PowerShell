...
ExtendedTenantDtoEnvelope<PSCustomObject>
#>

function Initialize-ExtendedTenantDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantDtoEnvelope' | Write-Debug
...
Convert from JSON to ExtendedTenantDtoEnvelope<PSCustomObject>
...
ExtendedTenantDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantDtoEnvelope
