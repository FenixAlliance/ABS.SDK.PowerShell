...
# Retrieve a list of refund policies
try {
    $Result = Get-RefundPoliciesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRefundPolicyDtoCollectionQueryParameters $ItemRefundPolicyDtoCollectionQueryParameters
} catch {
...
# Get the count of refund policies
try {
    $Result = Get-RefundPoliciesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRefundPolicyDtoCollectionQueryParameters $ItemRefundPolicyDtoCollectionQueryParameters
} catch {
...
# Patch a refund policy
try {
    $Result = Invoke-PatchRefundPolicyAsync -TenantId $TenantId -RefundPolicyId $RefundPolicyId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
