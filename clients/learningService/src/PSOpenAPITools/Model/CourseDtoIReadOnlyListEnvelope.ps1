...
CourseDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-CourseDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to CourseDtoIReadOnlyListEnvelope<PSCustomObject>
...
CourseDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCourseDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseDtoIReadOnlyListEnvelope
