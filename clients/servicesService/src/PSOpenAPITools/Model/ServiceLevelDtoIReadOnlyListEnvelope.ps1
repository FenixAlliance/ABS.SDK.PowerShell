...
ServiceLevelDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-ServiceLevelDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceLevelDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to ServiceLevelDtoIReadOnlyListEnvelope<PSCustomObject>
...
ServiceLevelDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceLevelDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceLevelDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceLevelDtoIReadOnlyListEnvelope
