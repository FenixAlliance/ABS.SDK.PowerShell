...
TaxRateCreateDto<PSCustomObject>
#>

function Initialize-TaxRateCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxRateCreateDto' | Write-Debug
...
Convert from JSON to TaxRateCreateDto<PSCustomObject>
...
TaxRateCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToTaxRateCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxRateCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxRateCreateDto
