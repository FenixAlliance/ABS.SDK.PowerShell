...
BusinessApplicationDtoListEnvelope<PSCustomObject>
#>

function Initialize-BusinessApplicationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessApplicationDtoListEnvelope' | Write-Debug
...
Convert from JSON to BusinessApplicationDtoListEnvelope<PSCustomObject>
...
BusinessApplicationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessApplicationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessApplicationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessApplicationDtoListEnvelope
