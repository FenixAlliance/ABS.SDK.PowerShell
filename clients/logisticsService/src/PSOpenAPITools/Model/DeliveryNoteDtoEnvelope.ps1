...
DeliveryNoteDtoEnvelope<PSCustomObject>
#>

function Initialize-DeliveryNoteDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeliveryNoteDtoEnvelope' | Write-Debug
...
Convert from JSON to DeliveryNoteDtoEnvelope<PSCustomObject>
...
DeliveryNoteDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDeliveryNoteDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeliveryNoteDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeliveryNoteDtoEnvelope
