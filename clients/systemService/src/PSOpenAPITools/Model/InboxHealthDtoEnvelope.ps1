...
InboxHealthDtoEnvelope<PSCustomObject>
#>

function Initialize-InboxHealthDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InboxHealthDtoEnvelope' | Write-Debug
...
Convert from JSON to InboxHealthDtoEnvelope<PSCustomObject>
...
InboxHealthDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInboxHealthDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InboxHealthDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InboxHealthDtoEnvelope
