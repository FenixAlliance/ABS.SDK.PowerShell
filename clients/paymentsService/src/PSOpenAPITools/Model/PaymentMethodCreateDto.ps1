...
PaymentMethodCreateDto<PSCustomObject>
#>

function Initialize-PaymentMethodCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentMethodCreateDto' | Write-Debug
...
Convert from JSON to PaymentMethodCreateDto<PSCustomObject>
...
PaymentMethodCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentMethodCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentMethodCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentMethodCreateDto
