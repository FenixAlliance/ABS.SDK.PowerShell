...
BankTransactionDtoListEnvelope<PSCustomObject>
#>

function Initialize-BankTransactionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankTransactionDtoListEnvelope' | Write-Debug
...
Convert from JSON to BankTransactionDtoListEnvelope<PSCustomObject>
...
BankTransactionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankTransactionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankTransactionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankTransactionDtoListEnvelope
