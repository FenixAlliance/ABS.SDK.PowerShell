...
SkillDtoEnvelope<PSCustomObject>
#>

function Initialize-SkillDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SkillDtoEnvelope' | Write-Debug
...
Convert from JSON to SkillDtoEnvelope<PSCustomObject>
...
SkillDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSkillDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SkillDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SkillDtoEnvelope
