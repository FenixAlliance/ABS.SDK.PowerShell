...
# Patch an existing permission
try {
    $Result = Invoke-PatchPermissionAsync -TenantId $TenantId -SecurityPermissionId $SecurityPermissionId -Operation $Operation -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
