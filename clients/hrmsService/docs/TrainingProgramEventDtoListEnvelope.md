...
```powershell
$TrainingProgramEventDtoListEnvelope = Initialize-PSOpenAPIToolsTrainingProgramEventDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$TrainingProgramEventDtoListEnvelope | ConvertTo-JSON
```
