...
BlogPostTagDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlogPostTagDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostTagDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlogPostTagDtoListEnvelope<PSCustomObject>
...
BlogPostTagDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostTagDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostTagDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostTagDtoListEnvelope
