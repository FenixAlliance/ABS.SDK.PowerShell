...
SupportTicketConversationDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketConversationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketConversationDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketConversationDtoListEnvelope<PSCustomObject>
...
SupportTicketConversationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketConversationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketConversationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketConversationDtoListEnvelope
