...
WebContentUpdateDto<PSCustomObject>
#>

function Initialize-WebContentUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebContentUpdateDto' | Write-Debug
...
Convert from JSON to WebContentUpdateDto<PSCustomObject>
...
WebContentUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebContentUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebContentUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebContentUpdateDto
