...
ShippingCourierDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShippingCourierDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingCourierDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShippingCourierDtoListEnvelope<PSCustomObject>
...
ShippingCourierDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingCourierDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingCourierDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingCourierDtoListEnvelope
