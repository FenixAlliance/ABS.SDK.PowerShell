...
FiscalYearCreateDto<PSCustomObject>
#>

function Initialize-FiscalYearCreateDto {
    [CmdletBinding()]
    Param (
...
Convert from JSON to FiscalYearCreateDto<PSCustomObject>
...
FiscalYearCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalYearCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalYearCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
