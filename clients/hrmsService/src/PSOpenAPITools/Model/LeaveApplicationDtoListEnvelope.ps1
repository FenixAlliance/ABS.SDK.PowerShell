...
LeaveApplicationDtoListEnvelope<PSCustomObject>
#>

function Initialize-LeaveApplicationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LeaveApplicationDtoListEnvelope' | Write-Debug
...
Convert from JSON to LeaveApplicationDtoListEnvelope<PSCustomObject>
...
LeaveApplicationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLeaveApplicationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LeaveApplicationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LeaveApplicationDtoListEnvelope
