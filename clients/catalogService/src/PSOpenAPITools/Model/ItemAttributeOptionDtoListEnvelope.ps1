...
ItemAttributeOptionDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemAttributeOptionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeOptionDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemAttributeOptionDtoListEnvelope<PSCustomObject>
...
ItemAttributeOptionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeOptionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeOptionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeOptionDtoListEnvelope
