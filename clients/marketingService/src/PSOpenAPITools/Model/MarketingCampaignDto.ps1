...
MarketingCampaignDto<PSCustomObject>
#>

function Initialize-MarketingCampaignDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingCampaignDto' | Write-Debug
...
Convert from JSON to MarketingCampaignDto<PSCustomObject>
...
MarketingCampaignDto<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingCampaignDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingCampaignDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingCampaignDto
