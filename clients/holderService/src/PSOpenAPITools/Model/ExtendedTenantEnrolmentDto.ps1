...
ExtendedTenantEnrolmentDto<PSCustomObject>
#>

function Initialize-ExtendedTenantEnrolmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantEnrolmentDto' | Write-Debug
...
Convert from JSON to ExtendedTenantEnrolmentDto<PSCustomObject>
...
ExtendedTenantEnrolmentDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantEnrolmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantEnrolmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantEnrolmentDto
