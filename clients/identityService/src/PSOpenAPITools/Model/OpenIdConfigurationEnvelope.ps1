...
OpenIdConfigurationEnvelope<PSCustomObject>
#>

function Initialize-OpenIdConfigurationEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OpenIdConfigurationEnvelope' | Write-Debug
...
Convert from JSON to OpenIdConfigurationEnvelope<PSCustomObject>
...
OpenIdConfigurationEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOpenIdConfigurationEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OpenIdConfigurationEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OpenIdConfigurationEnvelope
