...
WebPageCategoryDto<PSCustomObject>
#>

function Initialize-WebPageCategoryDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageCategoryDto' | Write-Debug
...
Convert from JSON to WebPageCategoryDto<PSCustomObject>
...
WebPageCategoryDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageCategoryDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageCategoryDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageCategoryDto
