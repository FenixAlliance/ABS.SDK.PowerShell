...
.PARAMETER AuthorId
No description available.
.PARAMETER IsHomePage
No description available.
.PARAMETER IsStorePage
No description available.
.PARAMETER IsCartPage
No description available.
.PARAMETER IsBlogPage
No description available.
.PARAMETER IsAccountPage
No description available.
.PARAMETER IsCheckoutPage
No description available.
.PARAMETER IsWishListsPage
No description available.
.PARAMETER IsContactPage
No description available.
.PARAMETER IsPrivacyPolicyPage
No description available.
.PARAMETER IsTermsOfServicePage
No description available.
.OUTPUTS

WebPageDto<PSCustomObject>
#>

function Initialize-WebPageDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageDto' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "isWishListsPage" = ${IsWishListsPage}
            "isContactPage" = ${IsContactPage}
            "isPrivacyPolicyPage" = ${IsPrivacyPolicyPage}
            "isTermsOfServicePage" = ${IsTermsOfServicePage}
        }
...
Convert from JSON to WebPageDto<PSCustomObject>
...
WebPageDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageDto
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "emitResult"))) { #optional property not found
            $EmitResult = $null
        } else {
            $EmitResult = $JsonParameters.PSobject.Properties["emitResult"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isHomePage"))) { #optional property not found
            $IsHomePage = $null
        } else {
            $IsHomePage = $JsonParameters.PSobject.Properties["isHomePage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isStorePage"))) { #optional property not found
            $IsStorePage = $null
        } else {
            $IsStorePage = $JsonParameters.PSobject.Properties["isStorePage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isCartPage"))) { #optional property not found
            $IsCartPage = $null
        } else {
            $IsCartPage = $JsonParameters.PSobject.Properties["isCartPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isBlogPage"))) { #optional property not found
            $IsBlogPage = $null
        } else {
            $IsBlogPage = $JsonParameters.PSobject.Properties["isBlogPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isAccountPage"))) { #optional property not found
            $IsAccountPage = $null
        } else {
            $IsAccountPage = $JsonParameters.PSobject.Properties["isAccountPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isCheckoutPage"))) { #optional property not found
            $IsCheckoutPage = $null
        } else {
            $IsCheckoutPage = $JsonParameters.PSobject.Properties["isCheckoutPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isWishListsPage"))) { #optional property not found
            $IsWishListsPage = $null
        } else {
            $IsWishListsPage = $JsonParameters.PSobject.Properties["isWishListsPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isContactPage"))) { #optional property not found
            $IsContactPage = $null
        } else {
            $IsContactPage = $JsonParameters.PSobject.Properties["isContactPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isPrivacyPolicyPage"))) { #optional property not found
            $IsPrivacyPolicyPage = $null
        } else {
            $IsPrivacyPolicyPage = $JsonParameters.PSobject.Properties["isPrivacyPolicyPage"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "isTermsOfServicePage"))) { #optional property not found
            $IsTermsOfServicePage = $null
        } else {
            $IsTermsOfServicePage = $JsonParameters.PSobject.Properties["isTermsOfServicePage"].value
        }
