...
TaxClassDtoListEnvelope<PSCustomObject>
#>

function Initialize-TaxClassDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxClassDtoListEnvelope' | Write-Debug
...
Convert from JSON to TaxClassDtoListEnvelope<PSCustomObject>
...
TaxClassDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxClassDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxClassDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxClassDtoListEnvelope
