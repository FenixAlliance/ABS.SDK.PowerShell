...
PaymentRefundDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentRefundDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentRefundDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentRefundDtoListEnvelope<PSCustomObject>
...
PaymentRefundDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentRefundDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentRefundDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentRefundDtoListEnvelope
