...
ServiceQueueDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceQueueDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceQueueDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceQueueDtoEnvelope<PSCustomObject>
...
ServiceQueueDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceQueueDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceQueueDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceQueueDtoEnvelope
