...
DealUnitLineDtoListEnvelope<PSCustomObject>
#>

function Initialize-DealUnitLineDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitLineDtoListEnvelope' | Write-Debug
...
Convert from JSON to DealUnitLineDtoListEnvelope<PSCustomObject>
...
DealUnitLineDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitLineDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitLineDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitLineDtoListEnvelope
