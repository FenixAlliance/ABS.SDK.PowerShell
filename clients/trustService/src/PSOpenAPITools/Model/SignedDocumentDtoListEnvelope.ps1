...
SignedDocumentDtoListEnvelope<PSCustomObject>
#>

function Initialize-SignedDocumentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SignedDocumentDtoListEnvelope' | Write-Debug
...
Convert from JSON to SignedDocumentDtoListEnvelope<PSCustomObject>
...
SignedDocumentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSignedDocumentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SignedDocumentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SignedDocumentDtoListEnvelope
