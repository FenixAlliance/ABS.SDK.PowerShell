...
AverageDtoEnvelope<PSCustomObject>
#>

function Initialize-AverageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AverageDtoEnvelope' | Write-Debug
...
Convert from JSON to AverageDtoEnvelope<PSCustomObject>
...
AverageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAverageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AverageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AverageDtoEnvelope
