...
function ConvertFrom-JsonToPriceListDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "name", "startDate", "endDate", "description", "context", "currencyId", "tenantId", "unitId", "unitGroupId", "partnerVisible", "unitOfMeasureDependant", "enrollmentId")
