...
AirwayBillDtoListEnvelope<PSCustomObject>
#>

function Initialize-AirwayBillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AirwayBillDtoListEnvelope' | Write-Debug
...
Convert from JSON to AirwayBillDtoListEnvelope<PSCustomObject>
...
AirwayBillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAirwayBillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AirwayBillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AirwayBillDtoListEnvelope
