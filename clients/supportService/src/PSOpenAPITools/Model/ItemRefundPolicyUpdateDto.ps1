...
ItemRefundPolicyUpdateDto<PSCustomObject>
#>

function Initialize-ItemRefundPolicyUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRefundPolicyUpdateDto' | Write-Debug
...
Convert from JSON to ItemRefundPolicyUpdateDto<PSCustomObject>
...
ItemRefundPolicyUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemRefundPolicyUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRefundPolicyUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRefundPolicyUpdateDto
        $AllProperties = ("title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId")
