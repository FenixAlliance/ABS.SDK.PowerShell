...
QuoteDto<PSCustomObject>
#>

function Initialize-QuoteDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteDto' | Write-Debug
...
Convert from JSON to QuoteDto<PSCustomObject>
...
QuoteDto<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteDto
