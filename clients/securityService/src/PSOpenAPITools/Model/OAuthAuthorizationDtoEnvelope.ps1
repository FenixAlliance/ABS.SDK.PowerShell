...
OAuthAuthorizationDtoEnvelope<PSCustomObject>
#>

function Initialize-OAuthAuthorizationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OAuthAuthorizationDtoEnvelope' | Write-Debug
...
Convert from JSON to OAuthAuthorizationDtoEnvelope<PSCustomObject>
...
OAuthAuthorizationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOAuthAuthorizationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OAuthAuthorizationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OAuthAuthorizationDtoEnvelope
