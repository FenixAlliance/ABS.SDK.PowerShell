...
ContactProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-ContactProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to ContactProfileDtoListEnvelope<PSCustomObject>
...
ContactProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactProfileDtoListEnvelope
