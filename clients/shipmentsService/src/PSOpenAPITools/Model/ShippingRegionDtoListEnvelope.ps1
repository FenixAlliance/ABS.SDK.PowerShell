...
ShippingRegionDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShippingRegionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingRegionDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShippingRegionDtoListEnvelope<PSCustomObject>
...
ShippingRegionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingRegionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingRegionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingRegionDtoListEnvelope
