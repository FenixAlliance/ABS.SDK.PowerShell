...
ServiceCaseDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceCaseDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceCaseDtoEnvelope<PSCustomObject>
...
ServiceCaseDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseDtoEnvelope
