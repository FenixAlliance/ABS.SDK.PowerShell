...
SalaryDtoEnvelope<PSCustomObject>
#>

function Initialize-SalaryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SalaryDtoEnvelope' | Write-Debug
...
Convert from JSON to SalaryDtoEnvelope<PSCustomObject>
...
SalaryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSalaryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SalaryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SalaryDtoEnvelope
