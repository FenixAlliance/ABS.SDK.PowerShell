...
# Patch a payment method
try {
    $Result = Invoke-PatchPaymentMethodAsync -TenantId $TenantId -PaymentMethodId $PaymentMethodId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
