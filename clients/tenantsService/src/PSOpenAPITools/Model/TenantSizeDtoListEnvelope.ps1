...
TenantSizeDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantSizeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantSizeDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantSizeDtoListEnvelope<PSCustomObject>
...
TenantSizeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantSizeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantSizeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantSizeDtoListEnvelope
