...
BudgetAccountEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-BudgetAccountEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BudgetAccountEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to BudgetAccountEntryDtoEnvelope<PSCustomObject>
...
BudgetAccountEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBudgetAccountEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BudgetAccountEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BudgetAccountEntryDtoEnvelope
