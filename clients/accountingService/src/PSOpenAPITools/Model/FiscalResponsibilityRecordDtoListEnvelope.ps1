...
FiscalResponsibilityRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalResponsibilityRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalResponsibilityRecordDtoListEnvelope<PSCustomObject>
...
FiscalResponsibilityRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityRecordDtoListEnvelope
