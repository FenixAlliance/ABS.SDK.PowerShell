...
AppliedTaxPolicyRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-AppliedTaxPolicyRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to AppliedTaxPolicyRecordDtoEnvelope<PSCustomObject>
...
AppliedTaxPolicyRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppliedTaxPolicyRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppliedTaxPolicyRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppliedTaxPolicyRecordDtoEnvelope
