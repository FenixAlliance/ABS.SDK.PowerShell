...
InboxMessageDtoEnvelope<PSCustomObject>
#>

function Initialize-InboxMessageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InboxMessageDtoEnvelope' | Write-Debug
...
Convert from JSON to InboxMessageDtoEnvelope<PSCustomObject>
...
InboxMessageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInboxMessageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InboxMessageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InboxMessageDtoEnvelope
