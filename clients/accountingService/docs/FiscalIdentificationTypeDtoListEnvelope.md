...
```powershell
$FiscalIdentificationTypeDtoListEnvelope = Initialize-PSOpenAPIToolsFiscalIdentificationTypeDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$FiscalIdentificationTypeDtoListEnvelope | ConvertTo-JSON
```
