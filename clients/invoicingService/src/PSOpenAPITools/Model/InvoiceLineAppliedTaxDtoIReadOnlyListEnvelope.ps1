...
InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope<PSCustomObject>
...
InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceLineAppliedTaxDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope
