...
# Patch an existing business application
try {
    $Result = Invoke-PatchBusinessApplicationAsync -TenantId $TenantId -ApplicationId $ApplicationId -Operation $Operation -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
