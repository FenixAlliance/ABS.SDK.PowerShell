...
SocialPostCommentDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialPostCommentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostCommentDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialPostCommentDtoListEnvelope<PSCustomObject>
...
SocialPostCommentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostCommentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostCommentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostCommentDtoListEnvelope
