...
ItemRestockDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemRestockDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRestockDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemRestockDtoListEnvelope<PSCustomObject>
...
ItemRestockDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemRestockDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRestockDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRestockDtoListEnvelope
