...
function Initialize-AccountUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountUpdateDto' | Write-Debug
...
Convert from JSON to AccountUpdateDto<PSCustomObject>
...
AccountUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAccountUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountUpdateDto
        $AllProperties = ("group", "frozen", "name", "code", "path", "prefix", "currencyId", "accountTypeId", "parentAccountId", "accountCategory")
