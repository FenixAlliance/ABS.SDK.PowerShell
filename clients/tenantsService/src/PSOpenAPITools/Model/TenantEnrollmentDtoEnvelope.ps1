...
TenantEnrollmentDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantEnrollmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantEnrollmentDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantEnrollmentDtoEnvelope<PSCustomObject>
...
TenantEnrollmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantEnrollmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantEnrollmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantEnrollmentDtoEnvelope
