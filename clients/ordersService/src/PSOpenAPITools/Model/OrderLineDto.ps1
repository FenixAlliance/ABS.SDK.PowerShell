...
OrderLineDto<PSCustomObject>
#>

function Initialize-OrderLineDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderLineDto' | Write-Debug
...
Convert from JSON to OrderLineDto<PSCustomObject>
...
OrderLineDto<PSCustomObject>
#>
function ConvertFrom-JsonToOrderLineDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderLineDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderLineDto
