...
SigningLogDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningLogDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningLogDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningLogDtoListEnvelope<PSCustomObject>
...
SigningLogDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningLogDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningLogDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningLogDtoListEnvelope
