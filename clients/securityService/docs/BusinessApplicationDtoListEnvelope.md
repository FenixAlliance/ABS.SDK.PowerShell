...
```powershell
$BusinessApplicationDtoListEnvelope = Initialize-PSOpenAPIToolsBusinessApplicationDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$BusinessApplicationDtoListEnvelope | ConvertTo-JSON
```
