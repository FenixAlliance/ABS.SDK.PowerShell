...
LoanTypeUpdateDto<PSCustomObject>
#>

function Initialize-LoanTypeUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanTypeUpdateDto' | Write-Debug
...
Convert from JSON to LoanTypeUpdateDto<PSCustomObject>
...
LoanTypeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToLoanTypeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanTypeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanTypeUpdateDto
