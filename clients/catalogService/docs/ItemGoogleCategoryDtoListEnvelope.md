...
```powershell
$ItemGoogleCategoryDtoListEnvelope = Initialize-PSOpenAPIToolsItemGoogleCategoryDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ItemGoogleCategoryDtoListEnvelope | ConvertTo-JSON
```
