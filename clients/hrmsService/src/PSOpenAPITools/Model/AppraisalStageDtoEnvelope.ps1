...
AppraisalStageDtoEnvelope<PSCustomObject>
#>

function Initialize-AppraisalStageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppraisalStageDtoEnvelope' | Write-Debug
...
Convert from JSON to AppraisalStageDtoEnvelope<PSCustomObject>
...
AppraisalStageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppraisalStageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppraisalStageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppraisalStageDtoEnvelope
