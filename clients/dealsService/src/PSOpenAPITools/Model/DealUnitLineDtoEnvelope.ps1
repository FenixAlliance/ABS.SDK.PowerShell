...
DealUnitLineDtoEnvelope<PSCustomObject>
#>

function Initialize-DealUnitLineDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitLineDtoEnvelope' | Write-Debug
...
Convert from JSON to DealUnitLineDtoEnvelope<PSCustomObject>
...
DealUnitLineDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitLineDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitLineDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitLineDtoEnvelope
