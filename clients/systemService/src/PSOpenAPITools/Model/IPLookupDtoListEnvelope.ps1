...
IPLookupDtoListEnvelope<PSCustomObject>
#>

function Initialize-IPLookupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPLookupDtoListEnvelope' | Write-Debug
...
Convert from JSON to IPLookupDtoListEnvelope<PSCustomObject>
...
IPLookupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToIPLookupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPLookupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPLookupDtoListEnvelope
