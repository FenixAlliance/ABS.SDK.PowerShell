...
CatalogItemDtoEnvelope<PSCustomObject>
#>

function Initialize-CatalogItemDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CatalogItemDtoEnvelope' | Write-Debug
...
Convert from JSON to CatalogItemDtoEnvelope<PSCustomObject>
...
CatalogItemDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCatalogItemDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CatalogItemDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CatalogItemDtoEnvelope
