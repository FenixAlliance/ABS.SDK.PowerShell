...
SupportTicketPriorityDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketPriorityDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketPriorityDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketPriorityDtoEnvelope<PSCustomObject>
...
SupportTicketPriorityDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketPriorityDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketPriorityDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketPriorityDtoEnvelope
