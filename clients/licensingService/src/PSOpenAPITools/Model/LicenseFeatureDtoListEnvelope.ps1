...
LicenseFeatureDtoListEnvelope<PSCustomObject>
#>

function Initialize-LicenseFeatureDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseFeatureDtoListEnvelope' | Write-Debug
...
Convert from JSON to LicenseFeatureDtoListEnvelope<PSCustomObject>
...
LicenseFeatureDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseFeatureDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseFeatureDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseFeatureDtoListEnvelope
