...
PayrollPeriodDtoEnvelope<PSCustomObject>
#>

function Initialize-PayrollPeriodDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PayrollPeriodDtoEnvelope' | Write-Debug
...
Convert from JSON to PayrollPeriodDtoEnvelope<PSCustomObject>
...
PayrollPeriodDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPayrollPeriodDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PayrollPeriodDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PayrollPeriodDtoEnvelope
