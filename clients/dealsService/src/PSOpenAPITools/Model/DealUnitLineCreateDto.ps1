...
DealUnitLineCreateDto<PSCustomObject>
#>

function Initialize-DealUnitLineCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitLineCreateDto' | Write-Debug
...
Convert from JSON to DealUnitLineCreateDto<PSCustomObject>
...
DealUnitLineCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitLineCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitLineCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
