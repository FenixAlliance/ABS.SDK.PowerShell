...
ItemRestockEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemRestockEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRestockEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemRestockEntryDtoEnvelope<PSCustomObject>
...
ItemRestockEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemRestockEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRestockEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRestockEntryDtoEnvelope
