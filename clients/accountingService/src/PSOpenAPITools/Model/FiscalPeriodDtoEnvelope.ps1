...
FiscalPeriodDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalPeriodDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalPeriodDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalPeriodDtoEnvelope<PSCustomObject>
...
FiscalPeriodDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalPeriodDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalPeriodDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalPeriodDtoEnvelope
