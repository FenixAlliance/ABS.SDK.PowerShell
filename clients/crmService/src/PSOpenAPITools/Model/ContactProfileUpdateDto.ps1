...
ContactProfileUpdateDto<PSCustomObject>
#>

function Initialize-ContactProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactProfileUpdateDto' | Write-Debug
...
Convert from JSON to ContactProfileUpdateDto<PSCustomObject>
...
ContactProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactProfileUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactProfileUpdateDto
