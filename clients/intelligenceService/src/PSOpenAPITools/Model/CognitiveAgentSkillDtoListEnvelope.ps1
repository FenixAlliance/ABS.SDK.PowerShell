...
CognitiveAgentSkillDtoListEnvelope<PSCustomObject>
#>

function Initialize-CognitiveAgentSkillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CognitiveAgentSkillDtoListEnvelope' | Write-Debug
...
Convert from JSON to CognitiveAgentSkillDtoListEnvelope<PSCustomObject>
...
CognitiveAgentSkillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCognitiveAgentSkillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CognitiveAgentSkillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CognitiveAgentSkillDtoListEnvelope
