...
# Patch a time interval
try {
    $Result = Invoke-PatchTimeIntervalAsync -TenantId $TenantId -TimeIntervalId $TimeIntervalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
