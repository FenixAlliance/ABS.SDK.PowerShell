...
PrivateMessageDtoListEnvelope<PSCustomObject>
#>

function Initialize-PrivateMessageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrivateMessageDtoListEnvelope' | Write-Debug
...
Convert from JSON to PrivateMessageDtoListEnvelope<PSCustomObject>
...
PrivateMessageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPrivateMessageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrivateMessageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrivateMessageDtoListEnvelope
