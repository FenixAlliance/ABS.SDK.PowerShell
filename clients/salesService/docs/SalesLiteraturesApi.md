...
------------- | ------------- | -------------
[**Invoke-CountSalesLiteraturesAsync**](SalesLiteraturesApi.md#Invoke-CountSalesLiteraturesAsync) | **GET** /api/v2/SalesService/SalesLiteratures/Count | Get sales literatures count
[**New-SalesLiteratureAsync**](SalesLiteraturesApi.md#New-SalesLiteratureAsync) | **POST** /api/v2/SalesService/SalesLiteratures | Create a sales literature
[**Invoke-DeleteSalesLiteratureAsync**](SalesLiteraturesApi.md#Invoke-DeleteSalesLiteratureAsync) | **DELETE** /api/v2/SalesService/SalesLiteratures/{salesLiteratureId} | Delete a sales literature
