...
[**Invoke-PatchSupportTicketTypeAsync**](SupportTicketTypesApi.md#Invoke-PatchSupportTicketTypeAsync) | **PATCH** /api/v2/SupportService/SupportTicketTypes/{supportTicketTypeId} | Patch a support ticket type
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SupportTicketTypeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$SupportTicketTypeDtoCollectionQueryParameters = Initialize-SupportTicketTypeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # SupportTicketTypeDtoCollectionQueryParameters |  (optional)

# Retrieve a list of support ticket types
try {
    $Result = Get-SupportTicketTypesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SupportTicketTypeDtoCollectionQueryParameters $SupportTicketTypeDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **SupportTicketTypeDtoCollectionQueryParameters** | [**SupportTicketTypeDtoCollectionQueryParameters**](SupportTicketTypeDtoCollectionQueryParameters.md)|  | [optional] 
...
# Get the count of support ticket types
try {
    $Result = Get-SupportTicketTypesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SupportTicketTypeDtoCollectionQueryParameters $SupportTicketTypeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSupportTicketTypeAsync"></a>
# **Invoke-PatchSupportTicketTypeAsync**
> EmptyEnvelope Invoke-PatchSupportTicketTypeAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SupportTicketTypeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a support ticket type
try {
    $Result = Invoke-PatchSupportTicketTypeAsync -TenantId $TenantId -SupportTicketTypeId $SupportTicketTypeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSupportTicketTypeAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
