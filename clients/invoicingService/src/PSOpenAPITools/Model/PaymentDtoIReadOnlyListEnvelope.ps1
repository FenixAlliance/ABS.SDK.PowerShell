...
PaymentDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-PaymentDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to PaymentDtoIReadOnlyListEnvelope<PSCustomObject>
...
PaymentDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentDtoIReadOnlyListEnvelope
