...
WebPortalDtoEnvelope<PSCustomObject>
#>

function Initialize-WebPortalDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPortalDtoEnvelope' | Write-Debug
...
Convert from JSON to WebPortalDtoEnvelope<PSCustomObject>
...
WebPortalDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPortalDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPortalDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPortalDtoEnvelope
