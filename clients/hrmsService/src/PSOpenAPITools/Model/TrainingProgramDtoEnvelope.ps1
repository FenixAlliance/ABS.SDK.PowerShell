...
TrainingProgramDtoEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramDtoEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramDtoEnvelope<PSCustomObject>
...
TrainingProgramDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramDtoEnvelope
