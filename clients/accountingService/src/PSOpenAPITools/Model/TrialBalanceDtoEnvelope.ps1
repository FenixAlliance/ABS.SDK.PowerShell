...
TrialBalanceDtoEnvelope<PSCustomObject>
#>

function Initialize-TrialBalanceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrialBalanceDtoEnvelope' | Write-Debug
...
Convert from JSON to TrialBalanceDtoEnvelope<PSCustomObject>
...
TrialBalanceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrialBalanceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrialBalanceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrialBalanceDtoEnvelope
