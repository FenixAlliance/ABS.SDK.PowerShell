...
TenantTeamDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTeamDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTeamDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTeamDtoListEnvelope<PSCustomObject>
...
TenantTeamDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTeamDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTeamDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTeamDtoListEnvelope
