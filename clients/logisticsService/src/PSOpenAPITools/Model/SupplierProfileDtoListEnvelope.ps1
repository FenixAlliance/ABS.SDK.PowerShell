...
SupplierProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupplierProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupplierProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupplierProfileDtoListEnvelope<PSCustomObject>
...
SupplierProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupplierProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupplierProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupplierProfileDtoListEnvelope
