...
SupportRequestAttachmentDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportRequestAttachmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportRequestAttachmentDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportRequestAttachmentDtoEnvelope<PSCustomObject>
...
SupportRequestAttachmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportRequestAttachmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportRequestAttachmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportRequestAttachmentDtoEnvelope
