...
[**Invoke-PatchEmailSignatureAsync**](EmailSignaturesApi.md#Invoke-PatchEmailSignatureAsync) | **PATCH** /api/v2/MarketingService/EmailSignatures/{emailsignatureId} | Patch an email signature
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmailSignatureDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$EmailSignatureDtoCollectionQueryParameters = Initialize-EmailSignatureDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # EmailSignatureDtoCollectionQueryParameters |  (optional)

# Get email signatures count
try {
    $Result = Get-EmailSignaturesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmailSignatureDtoCollectionQueryParameters $EmailSignatureDtoCollectionQueryParameters
} catch {
...
# Get email signatures
try {
    $Result = Get-EmailSignaturesODataAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmailSignatureDtoCollectionQueryParameters $EmailSignatureDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchEmailSignatureAsync"></a>
# **Invoke-PatchEmailSignatureAsync**
> EmptyEnvelope Invoke-PatchEmailSignatureAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmailsignatureId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch an email signature
try {
    $Result = Invoke-PatchEmailSignatureAsync -TenantId $TenantId -EmailsignatureId $EmailsignatureId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchEmailSignatureAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
