...
SuiteModuleListEnvelope<PSCustomObject>
#>

function Initialize-SuiteModuleListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuiteModuleListEnvelope' | Write-Debug
...
Convert from JSON to SuiteModuleListEnvelope<PSCustomObject>
...
SuiteModuleListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSuiteModuleListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuiteModuleListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuiteModuleListEnvelope
