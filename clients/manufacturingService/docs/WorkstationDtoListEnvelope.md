...
**Result** | [**WorkstationDto[]**](WorkstationDto.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$WorkstationDtoListEnvelope = Initialize-PSOpenAPIToolsWorkstationDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$WorkstationDtoListEnvelope | ConvertTo-JSON
```
