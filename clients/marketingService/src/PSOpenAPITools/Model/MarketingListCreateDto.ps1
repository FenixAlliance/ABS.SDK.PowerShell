...
function ConvertFrom-JsonToMarketingListCreateDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "locked", "name", "purpose", "description", "source", "cost", "modifiedOn", "lastUsedOn", "currencyId", "tenantId", "enrolmentId", "marketingListType", "marketingListTarget")
