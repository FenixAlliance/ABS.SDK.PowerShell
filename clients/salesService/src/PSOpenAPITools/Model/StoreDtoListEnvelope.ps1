...
StoreDtoListEnvelope<PSCustomObject>
#>

function Initialize-StoreDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StoreDtoListEnvelope' | Write-Debug
...
Convert from JSON to StoreDtoListEnvelope<PSCustomObject>
...
StoreDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStoreDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StoreDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StoreDtoListEnvelope
