...
ItemAttributeOptionUpdateDto<PSCustomObject>
#>

function Initialize-ItemAttributeOptionUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeOptionUpdateDto' | Write-Debug
...
Convert from JSON to ItemAttributeOptionUpdateDto<PSCustomObject>
...
ItemAttributeOptionUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeOptionUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeOptionUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeOptionUpdateDto
