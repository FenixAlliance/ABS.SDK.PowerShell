...
function ConvertFrom-JsonToSupportRequestAttachmentCreateDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "notes", "title", "author", "isFolder", "fileName", "abstract", "keyWords", "validResponse", "parentFileUploadId", "filePath", "publicAccessType", "metadata", "supportRequestId")
