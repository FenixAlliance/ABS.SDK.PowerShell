...
ConversationDtoListEnvelope<PSCustomObject>
#>

function Initialize-ConversationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ConversationDtoListEnvelope' | Write-Debug
...
Convert from JSON to ConversationDtoListEnvelope<PSCustomObject>
...
ConversationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToConversationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ConversationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConversationDtoListEnvelope
