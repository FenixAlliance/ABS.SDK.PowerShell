...
EmployeeAppraisalSessionDtoEnvelope<PSCustomObject>
#>

function Initialize-EmployeeAppraisalSessionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeAppraisalSessionDtoEnvelope' | Write-Debug
...
Convert from JSON to EmployeeAppraisalSessionDtoEnvelope<PSCustomObject>
...
EmployeeAppraisalSessionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeAppraisalSessionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeAppraisalSessionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeAppraisalSessionDtoEnvelope
