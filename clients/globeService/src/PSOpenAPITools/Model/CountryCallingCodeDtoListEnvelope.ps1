...
CountryCallingCodeDtoListEnvelope<PSCustomObject>
#>

function Initialize-CountryCallingCodeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryCallingCodeDtoListEnvelope' | Write-Debug
...
Convert from JSON to CountryCallingCodeDtoListEnvelope<PSCustomObject>
...
CountryCallingCodeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryCallingCodeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryCallingCodeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryCallingCodeDtoListEnvelope
