...
EmployeeProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmployeeProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmployeeProfileDtoListEnvelope<PSCustomObject>
...
EmployeeProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeProfileDtoListEnvelope
