...
RefundRequestDtoEnvelope<PSCustomObject>
#>

function Initialize-RefundRequestDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RefundRequestDtoEnvelope' | Write-Debug
...
Convert from JSON to RefundRequestDtoEnvelope<PSCustomObject>
...
RefundRequestDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRefundRequestDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RefundRequestDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RefundRequestDtoEnvelope
