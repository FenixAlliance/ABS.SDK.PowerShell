...
ItemReturnPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemReturnPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemReturnPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemReturnPolicyDtoListEnvelope<PSCustomObject>
...
ItemReturnPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemReturnPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemReturnPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemReturnPolicyDtoListEnvelope
