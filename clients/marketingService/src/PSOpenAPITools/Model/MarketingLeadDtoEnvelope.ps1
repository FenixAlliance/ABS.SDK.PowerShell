...
MarketingLeadDtoEnvelope<PSCustomObject>
#>

function Initialize-MarketingLeadDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingLeadDtoEnvelope' | Write-Debug
...
Convert from JSON to MarketingLeadDtoEnvelope<PSCustomObject>
...
MarketingLeadDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingLeadDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingLeadDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingLeadDtoEnvelope
