...
SupportTicketDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketDtoListEnvelope<PSCustomObject>
...
SupportTicketDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketDtoListEnvelope
