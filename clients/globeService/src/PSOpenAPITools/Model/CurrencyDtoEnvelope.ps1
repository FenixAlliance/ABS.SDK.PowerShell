...
CurrencyDtoEnvelope<PSCustomObject>
#>

function Initialize-CurrencyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurrencyDtoEnvelope' | Write-Debug
...
Convert from JSON to CurrencyDtoEnvelope<PSCustomObject>
...
CurrencyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurrencyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurrencyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurrencyDtoEnvelope
