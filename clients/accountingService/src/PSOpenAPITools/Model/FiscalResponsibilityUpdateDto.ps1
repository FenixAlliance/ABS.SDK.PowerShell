...
FiscalResponsibilityUpdateDto<PSCustomObject>
#>

function Initialize-FiscalResponsibilityUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalResponsibilityUpdateDto' | Write-Debug
...
Convert from JSON to FiscalResponsibilityUpdateDto<PSCustomObject>
...
FiscalResponsibilityUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalResponsibilityUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalResponsibilityUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalResponsibilityUpdateDto
