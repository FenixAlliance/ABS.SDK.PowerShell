...
LedgerDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-LedgerDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LedgerDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to LedgerDtoIReadOnlyListEnvelope<PSCustomObject>
...
LedgerDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLedgerDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LedgerDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LedgerDtoIReadOnlyListEnvelope
