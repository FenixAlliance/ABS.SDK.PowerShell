...
```powershell
$ItemAttributeOptionDtoListEnvelope = Initialize-PSOpenAPIToolsItemAttributeOptionDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ItemAttributeOptionDtoListEnvelope | ConvertTo-JSON
```
