...
ItemPackingSlipEntryDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemPackingSlipEntryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPackingSlipEntryDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemPackingSlipEntryDtoListEnvelope<PSCustomObject>
...
ItemPackingSlipEntryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPackingSlipEntryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPackingSlipEntryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPackingSlipEntryDtoListEnvelope
