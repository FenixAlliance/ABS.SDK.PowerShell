...
ContactProfileCreateDto<PSCustomObject>
#>

function Initialize-ContactProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactProfileCreateDto' | Write-Debug
...
Convert from JSON to ContactProfileCreateDto<PSCustomObject>
...
ContactProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToContactProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactProfileCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactProfileCreateDto
