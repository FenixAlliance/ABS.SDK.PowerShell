...
StringEnvelope<PSCustomObject>
#>

function Initialize-StringEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StringEnvelope' | Write-Debug
...
Convert from JSON to StringEnvelope<PSCustomObject>
...
StringEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToStringEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StringEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StringEnvelope
