...
TenantTeamContactEnrollmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantTeamContactEnrollmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTeamContactEnrollmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantTeamContactEnrollmentDtoListEnvelope<PSCustomObject>
...
TenantTeamContactEnrollmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTeamContactEnrollmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTeamContactEnrollmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTeamContactEnrollmentDtoListEnvelope
