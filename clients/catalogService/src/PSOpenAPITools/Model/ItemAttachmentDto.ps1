...
ItemAttachmentDto<PSCustomObject>
#>

function Initialize-ItemAttachmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttachmentDto' | Write-Debug
...
Convert from JSON to ItemAttachmentDto<PSCustomObject>
...
ItemAttachmentDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttachmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttachmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttachmentDto
