...
PaymentUpdateDto<PSCustomObject>
#>

function Initialize-PaymentUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentUpdateDto' | Write-Debug
...
Convert from JSON to PaymentUpdateDto<PSCustomObject>
...
PaymentUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
