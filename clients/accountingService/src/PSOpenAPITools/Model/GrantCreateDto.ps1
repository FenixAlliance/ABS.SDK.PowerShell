...
GrantCreateDto<PSCustomObject>
#>

function Initialize-GrantCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GrantCreateDto' | Write-Debug
...
Convert from JSON to GrantCreateDto<PSCustomObject>
...
GrantCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToGrantCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GrantCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GrantCreateDto
