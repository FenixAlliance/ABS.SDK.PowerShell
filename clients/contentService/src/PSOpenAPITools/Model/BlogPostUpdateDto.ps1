...
function Initialize-BlogPostUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostUpdateDto' | Write-Debug
...
Convert from JSON to BlogPostUpdateDto<PSCustomObject>
...
BlogPostUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
