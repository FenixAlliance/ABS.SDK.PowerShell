...
ActivityRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-ActivityRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to ActivityRecordDtoEnvelope<PSCustomObject>
...
ActivityRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityRecordDtoEnvelope
