...
DecimalEnvelope<PSCustomObject>
#>

function Initialize-DecimalEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DecimalEnvelope' | Write-Debug
...
Convert from JSON to DecimalEnvelope<PSCustomObject>
...
DecimalEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDecimalEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DecimalEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DecimalEnvelope
