...
FiscalRegimeDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalRegimeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalRegimeDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalRegimeDtoListEnvelope<PSCustomObject>
...
FiscalRegimeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalRegimeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalRegimeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalRegimeDtoListEnvelope
