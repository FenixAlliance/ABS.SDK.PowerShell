...
function ConvertFrom-JsonToSimpleUserDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "fullName", "qualifiedName", "publicName", "handler", "lastName", "firstName", "coverUrl", "avatarUrl", "gitHubUrl", "countryId", "timezoneId", "websiteUrl", "twitterUrl", "youTubeUrl", "linkedInUrl", "facebookUrl", "instagramUrl", "socialProfileId")
