...
[**Invoke-PatchCoursePageAsync**](CoursePagesApi.md#Invoke-PatchCoursePageAsync) | **PATCH** /api/v2/LearningService/CoursePages/{pageId} | Patch a course page
...
# Get all course pages
try {
    $Result = Get-CoursePagesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CoursePageDtoCollectionQueryParameters $CoursePageDtoCollectionQueryParameters
} catch {
...
# Get course pages count
try {
    $Result = Get-CoursePagesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CoursePageDtoCollectionQueryParameters $CoursePageDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchCoursePageAsync"></a>
# **Invoke-PatchCoursePageAsync**
> void Invoke-PatchCoursePageAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PageId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a course page
try {
    $Result = Invoke-PatchCoursePageAsync -TenantId $TenantId -PageId $PageId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchCoursePageAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
