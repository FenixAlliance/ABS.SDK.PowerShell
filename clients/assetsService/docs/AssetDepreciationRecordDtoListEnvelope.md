...
```powershell
$AssetDepreciationRecordDtoListEnvelope = Initialize-PSOpenAPIToolsAssetDepreciationRecordDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$AssetDepreciationRecordDtoListEnvelope | ConvertTo-JSON
```
