...
ContactDtoEnvelope<PSCustomObject>
#>

function Initialize-ContactDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactDtoEnvelope' | Write-Debug
...
Convert from JSON to ContactDtoEnvelope<PSCustomObject>
...
ContactDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToContactDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactDtoEnvelope
