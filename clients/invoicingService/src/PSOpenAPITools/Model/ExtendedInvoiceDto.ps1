...
ExtendedInvoiceDto<PSCustomObject>
#>

function Initialize-ExtendedInvoiceDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedInvoiceDto' | Write-Debug
...
Convert from JSON to ExtendedInvoiceDto<PSCustomObject>
...
ExtendedInvoiceDto<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedInvoiceDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedInvoiceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedInvoiceDto
