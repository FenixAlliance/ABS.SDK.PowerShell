...
BusinessApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-BusinessApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to BusinessApplicationDtoEnvelope<PSCustomObject>
...
BusinessApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessApplicationDtoEnvelope
