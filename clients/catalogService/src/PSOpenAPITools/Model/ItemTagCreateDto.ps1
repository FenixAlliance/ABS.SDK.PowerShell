...
ItemTagCreateDto<PSCustomObject>
#>

function Initialize-ItemTagCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTagCreateDto' | Write-Debug
...
Convert from JSON to ItemTagCreateDto<PSCustomObject>
...
ItemTagCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemTagCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTagCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTagCreateDto
