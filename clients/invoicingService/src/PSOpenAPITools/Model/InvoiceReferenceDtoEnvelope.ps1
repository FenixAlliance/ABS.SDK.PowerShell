...
InvoiceReferenceDtoEnvelope<PSCustomObject>
#>

function Initialize-InvoiceReferenceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceReferenceDtoEnvelope' | Write-Debug
...
Convert from JSON to InvoiceReferenceDtoEnvelope<PSCustomObject>
...
InvoiceReferenceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceReferenceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceReferenceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceReferenceDtoEnvelope
