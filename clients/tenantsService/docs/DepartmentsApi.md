...
[**Invoke-PatchTenantDepartmentAsync**](DepartmentsApi.md#Invoke-PatchTenantDepartmentAsync) | **PATCH** /api/v2/TenantsService/Departments/{tenantDepartmentId} | Patch a tenant department
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantDepartmentDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantDepartmentDtoCollectionQueryParameters = Initialize-TenantDepartmentDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TenantDepartmentDtoCollectionQueryParameters |  (optional)

# Retrieve a list of tenant departments
try {
    $Result = Get-TenantDepartments -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantDepartmentDtoCollectionQueryParameters $TenantDepartmentDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant departments
try {
    $Result = Get-TenantDepartmentsCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantDepartmentDtoCollectionQueryParameters $TenantDepartmentDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTenantDepartmentAsync"></a>
# **Invoke-PatchTenantDepartmentAsync**
> EmptyEnvelope Invoke-PatchTenantDepartmentAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantDepartmentId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tenant department
try {
    $Result = Invoke-PatchTenantDepartmentAsync -TenantId $TenantId -TenantDepartmentId $TenantDepartmentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTenantDepartmentAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
