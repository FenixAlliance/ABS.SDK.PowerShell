...
VesselDtoListEnvelope<PSCustomObject>
#>

function Initialize-VesselDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VesselDtoListEnvelope' | Write-Debug
...
Convert from JSON to VesselDtoListEnvelope<PSCustomObject>
...
VesselDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToVesselDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VesselDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VesselDtoListEnvelope
