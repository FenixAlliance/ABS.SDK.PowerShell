...
ItemPickListEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemPickListEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPickListEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemPickListEntryDtoEnvelope<PSCustomObject>
...
ItemPickListEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPickListEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPickListEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPickListEntryDtoEnvelope
