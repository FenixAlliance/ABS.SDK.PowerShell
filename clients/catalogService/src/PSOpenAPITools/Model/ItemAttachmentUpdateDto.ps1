...
ItemAttachmentUpdateDto<PSCustomObject>
#>

function Initialize-ItemAttachmentUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttachmentUpdateDto' | Write-Debug
...
Convert from JSON to ItemAttachmentUpdateDto<PSCustomObject>
...
ItemAttachmentUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttachmentUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttachmentUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttachmentUpdateDto
