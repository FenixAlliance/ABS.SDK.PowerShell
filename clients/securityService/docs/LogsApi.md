...
# Get tenant logs
try {
    $Result = Get-LogsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
...
# Get tenant logs count
try {
    $Result = Get-LogsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
