...
MerchantDtoEnvelope<PSCustomObject>
#>

function Initialize-MerchantDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MerchantDtoEnvelope' | Write-Debug
...
Convert from JSON to MerchantDtoEnvelope<PSCustomObject>
...
MerchantDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMerchantDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MerchantDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MerchantDtoEnvelope
