...
KnowledgeArticleDto<PSCustomObject>
#>

function Initialize-KnowledgeArticleDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KnowledgeArticleDto' | Write-Debug
...
Convert from JSON to KnowledgeArticleDto<PSCustomObject>
...
KnowledgeArticleDto<PSCustomObject>
#>
function ConvertFrom-JsonToKnowledgeArticleDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KnowledgeArticleDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KnowledgeArticleDto
        $AllProperties = ("id", "timestamp", "title", "slug", "excerpt", "description", "content", "highlightImage", "seoTitle", "seoKeyWords", "metaDescription", "published", "enable", "releaseDateTime", "lastModification", "tenantId", "businessProfileRecordId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "lastModification"))) { #optional property not found
            $LastModification = $null
        } else {
            $LastModification = $JsonParameters.PSobject.Properties["lastModification"].value
        }
