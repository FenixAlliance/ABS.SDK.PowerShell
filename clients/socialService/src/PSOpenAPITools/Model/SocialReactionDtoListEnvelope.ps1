...
SocialReactionDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialReactionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialReactionDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialReactionDtoListEnvelope<PSCustomObject>
...
SocialReactionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialReactionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialReactionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialReactionDtoListEnvelope
