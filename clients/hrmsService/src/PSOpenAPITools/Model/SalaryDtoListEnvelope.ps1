...
SalaryDtoListEnvelope<PSCustomObject>
#>

function Initialize-SalaryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SalaryDtoListEnvelope' | Write-Debug
...
Convert from JSON to SalaryDtoListEnvelope<PSCustomObject>
...
SalaryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSalaryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SalaryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SalaryDtoListEnvelope
