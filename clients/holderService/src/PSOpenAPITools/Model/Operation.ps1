...
function Initialize-Operation {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Operation' | Write-Debug
...
Operation<PSCustomObject>
#>
function ConvertFrom-JsonToOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Operation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Operation
