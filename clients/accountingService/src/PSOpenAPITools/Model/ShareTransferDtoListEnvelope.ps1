...
ShareTransferDtoListEnvelope<PSCustomObject>
#>

function Initialize-ShareTransferDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareTransferDtoListEnvelope' | Write-Debug
...
Convert from JSON to ShareTransferDtoListEnvelope<PSCustomObject>
...
ShareTransferDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareTransferDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareTransferDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareTransferDtoListEnvelope
