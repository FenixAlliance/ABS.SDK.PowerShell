...
AssetDepreciationRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetDepreciationRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetDepreciationRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetDepreciationRecordDtoListEnvelope<PSCustomObject>
...
AssetDepreciationRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetDepreciationRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetDepreciationRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetDepreciationRecordDtoListEnvelope
