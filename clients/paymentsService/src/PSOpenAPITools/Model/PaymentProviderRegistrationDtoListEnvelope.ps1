...
PaymentProviderRegistrationDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentProviderRegistrationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentProviderRegistrationDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentProviderRegistrationDtoListEnvelope<PSCustomObject>
...
PaymentProviderRegistrationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentProviderRegistrationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentProviderRegistrationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentProviderRegistrationDtoListEnvelope
