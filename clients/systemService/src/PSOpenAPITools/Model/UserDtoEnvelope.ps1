...
UserDtoEnvelope<PSCustomObject>
#>

function Initialize-UserDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserDtoEnvelope' | Write-Debug
...
Convert from JSON to UserDtoEnvelope<PSCustomObject>
...
UserDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUserDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserDtoEnvelope
