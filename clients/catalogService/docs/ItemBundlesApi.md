...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ItemBundleDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$ItemBundleDtoCollectionQueryParameters = Initialize-ItemBundleDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # ItemBundleDtoCollectionQueryParameters |  (optional)

# Get all item bundles
try {
    $Result = Get-ItemBundlesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemBundleDtoCollectionQueryParameters $ItemBundleDtoCollectionQueryParameters
} catch {
...
# Get item bundles count
try {
    $Result = Get-ItemBundlesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemBundleDtoCollectionQueryParameters $ItemBundleDtoCollectionQueryParameters
} catch {
...
# Patch an item bundle
try {
    $Result = Invoke-PatchItemBundleAsync -TenantId $TenantId -ItemBundleId $ItemBundleId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
