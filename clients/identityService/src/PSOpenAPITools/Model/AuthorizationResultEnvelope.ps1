...
AuthorizationResultEnvelope<PSCustomObject>
#>

function Initialize-AuthorizationResultEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthorizationResultEnvelope' | Write-Debug
...
Convert from JSON to AuthorizationResultEnvelope<PSCustomObject>
...
AuthorizationResultEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAuthorizationResultEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthorizationResultEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthorizationResultEnvelope
