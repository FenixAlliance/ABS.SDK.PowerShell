...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-CourseAssignmentComponentDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$CourseAssignmentComponentDtoCollectionQueryParameters = Initialize-CourseAssignmentComponentDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # CourseAssignmentComponentDtoCollectionQueryParameters |  (optional)

# Get all course assignment components
try {
    $Result = Get-CourseAssignmentComponentsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseAssignmentComponentDtoCollectionQueryParameters $CourseAssignmentComponentDtoCollectionQueryParameters
} catch {
...
# Get course assignment components count
try {
    $Result = Get-CourseAssignmentComponentsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseAssignmentComponentDtoCollectionQueryParameters $CourseAssignmentComponentDtoCollectionQueryParameters
} catch {
...
# Patch a course assignment component
try {
    $Result = Invoke-PatchCourseAssignmentComponentAsync -TenantId $TenantId -ComponentId $ComponentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
