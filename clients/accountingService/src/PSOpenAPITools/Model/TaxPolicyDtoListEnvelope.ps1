...
TaxPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-TaxPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to TaxPolicyDtoListEnvelope<PSCustomObject>
...
TaxPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxPolicyDtoListEnvelope
