...
OutboxHealthDtoEnvelope<PSCustomObject>
#>

function Initialize-OutboxHealthDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OutboxHealthDtoEnvelope' | Write-Debug
...
Convert from JSON to OutboxHealthDtoEnvelope<PSCustomObject>
...
OutboxHealthDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOutboxHealthDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OutboxHealthDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OutboxHealthDtoEnvelope
