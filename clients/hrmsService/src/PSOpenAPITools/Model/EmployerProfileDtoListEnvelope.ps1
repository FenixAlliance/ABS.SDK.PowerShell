...
EmployerProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmployerProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployerProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmployerProfileDtoListEnvelope<PSCustomObject>
...
EmployerProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployerProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployerProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployerProfileDtoListEnvelope
