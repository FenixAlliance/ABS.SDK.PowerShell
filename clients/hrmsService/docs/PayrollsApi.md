...
[**Invoke-PatchPayrollAsync**](PayrollsApi.md#Invoke-PatchPayrollAsync) | **PATCH** /api/v2/HrmsService/Payrolls/{payrollId} | Patch a payroll
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PayrollDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$PayrollDtoCollectionQueryParameters = Initialize-PayrollDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # PayrollDtoCollectionQueryParameters |  (optional)

# Get payrolls
try {
    $Result = Get-PayrollsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PayrollDtoCollectionQueryParameters $PayrollDtoCollectionQueryParameters
} catch {
 ...
 **ApiVersion** | **String**|  | [optional] 
 **XApiVersion** | **String**|  | [optional] 
 **PayrollDtoCollectionQueryParameters** | [**PayrollDtoCollectionQueryParameters**](PayrollDtoCollectionQueryParameters.md)|  | [optional] 
...
# Count payrolls
try {
    $Result = Get-PayrollsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PayrollDtoCollectionQueryParameters $PayrollDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchPayrollAsync"></a>
# **Invoke-PatchPayrollAsync**
> EmptyEnvelope Invoke-PatchPayrollAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PayrollId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a payroll
try {
    $Result = Invoke-PatchPayrollAsync -TenantId $TenantId -PayrollId $PayrollId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchPayrollAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
