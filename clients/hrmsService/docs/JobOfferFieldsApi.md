...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JobOfferFieldRecordDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$JobOfferFieldRecordDtoCollectionQueryParameters = Initialize-JobOfferFieldRecordDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # JobOfferFieldRecordDtoCollectionQueryParameters |  (optional)

# Get job offer fields
try {
    $Result = Get-JobOfferFieldsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JobOfferFieldRecordDtoCollectionQueryParameters $JobOfferFieldRecordDtoCollectionQueryParameters
} catch {
...
# Count job offer fields
try {
    $Result = Get-JobOfferFieldsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JobOfferFieldRecordDtoCollectionQueryParameters $JobOfferFieldRecordDtoCollectionQueryParameters
} catch {
...
# Patch a job offer field
try {
    $Result = Invoke-PatchJobOfferFieldAsync -TenantId $TenantId -JobOfferFieldId $JobOfferFieldId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
