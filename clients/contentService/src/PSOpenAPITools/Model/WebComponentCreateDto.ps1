...
WebComponentCreateDto<PSCustomObject>
#>

function Initialize-WebComponentCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebComponentCreateDto' | Write-Debug
...
Convert from JSON to WebComponentCreateDto<PSCustomObject>
...
WebComponentCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebComponentCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebComponentCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebComponentCreateDto
        $AllProperties = ("id", "timestamp", "name", "title", "description", "code", "htmlContent", "cssContent", "jsContent", "codeType", "published", "enable", "featuredImageUrl")
