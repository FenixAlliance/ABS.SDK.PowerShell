...
FiscalYearDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalYearDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalYearDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalYearDtoEnvelope<PSCustomObject>
...
FiscalYearDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalYearDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalYearDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalYearDtoEnvelope
