...
WalletWithdrawDtoListEnvelope<PSCustomObject>
#>

function Initialize-WalletWithdrawDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WalletWithdrawDtoListEnvelope' | Write-Debug
...
Convert from JSON to WalletWithdrawDtoListEnvelope<PSCustomObject>
...
WalletWithdrawDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWalletWithdrawDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WalletWithdrawDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WalletWithdrawDtoListEnvelope
