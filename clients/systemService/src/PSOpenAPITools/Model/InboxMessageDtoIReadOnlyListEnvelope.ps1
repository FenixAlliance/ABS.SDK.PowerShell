...
InboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-InboxMessageDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InboxMessageDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to InboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
...
InboxMessageDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInboxMessageDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InboxMessageDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InboxMessageDtoIReadOnlyListEnvelope
