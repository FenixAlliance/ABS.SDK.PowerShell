...
BlogPostCommentDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlogPostCommentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostCommentDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlogPostCommentDtoListEnvelope<PSCustomObject>
...
BlogPostCommentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostCommentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostCommentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostCommentDtoListEnvelope
