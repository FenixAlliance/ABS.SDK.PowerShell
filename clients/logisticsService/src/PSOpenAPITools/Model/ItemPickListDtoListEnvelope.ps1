...
ItemPickListDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemPickListDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPickListDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemPickListDtoListEnvelope<PSCustomObject>
...
ItemPickListDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPickListDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPickListDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPickListDtoListEnvelope
