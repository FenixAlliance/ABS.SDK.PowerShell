...
OrderLineUpdateDto<PSCustomObject>
#>

function Initialize-OrderLineUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderLineUpdateDto' | Write-Debug
...
Convert from JSON to OrderLineUpdateDto<PSCustomObject>
...
OrderLineUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToOrderLineUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderLineUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderLineUpdateDto
