...
EmailGroupDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmailGroupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailGroupDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmailGroupDtoListEnvelope<PSCustomObject>
...
EmailGroupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailGroupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailGroupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailGroupDtoListEnvelope
