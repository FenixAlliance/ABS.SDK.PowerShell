...
TaxRateDtoEnvelope<PSCustomObject>
#>

function Initialize-TaxRateDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxRateDtoEnvelope' | Write-Debug
...
Convert from JSON to TaxRateDtoEnvelope<PSCustomObject>
...
TaxRateDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxRateDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxRateDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxRateDtoEnvelope
