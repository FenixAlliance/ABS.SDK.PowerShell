...
[**Invoke-PatchJournalTypeAsync**](JournalTypesApi.md#Invoke-PatchJournalTypeAsync) | **PATCH** /api/v2/AccountingService/JournalTypes/{journalTypeId} | Patch a journal type
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JournalTypeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$JournalTypeDtoCollectionQueryParameters = Initialize-JournalTypeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # JournalTypeDtoCollectionQueryParameters |  (optional)

# Retrieves all journal types
try {
    $Result = Get-JournalTypesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JournalTypeDtoCollectionQueryParameters $JournalTypeDtoCollectionQueryParameters
} catch {
...
# Counts journal types
try {
    $Result = Get-JournalTypesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -JournalTypeDtoCollectionQueryParameters $JournalTypeDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchJournalTypeAsync"></a>
# **Invoke-PatchJournalTypeAsync**
> EmptyEnvelope Invoke-PatchJournalTypeAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JournalTypeId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a journal type
try {
    $Result = Invoke-PatchJournalTypeAsync -TenantId $TenantId -JournalTypeId $JournalTypeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchJournalTypeAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
