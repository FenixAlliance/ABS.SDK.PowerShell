...
[**Invoke-PatchTenantSegment**](SegmentsApi.md#Invoke-PatchTenantSegment) | **PATCH** /api/v2/TenantsService/Segments/{tenantSegmentId} | Patch a tenant segment
...
$TenantSegmentCreateDto = Initialize-TenantSegmentCreateDto -Id "MyId" -Timestamp (Get-Date) -MinEmployees 0 -MaxEmployees 0 # TenantSegmentCreateDto |  (optional)
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantSegmentDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantSegmentDtoCollectionQueryParameters = Initialize-TenantSegmentDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TenantSegmentDtoCollectionQueryParameters |  (optional)

# Retrieve a list of tenant segments
try {
    $Result = Get-TenantSegments -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantSegmentDtoCollectionQueryParameters $TenantSegmentDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant segments
try {
    $Result = Get-TenantSegmentsCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantSegmentDtoCollectionQueryParameters $TenantSegmentDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTenantSegment"></a>
# **Invoke-PatchTenantSegment**
> EmptyEnvelope Invoke-PatchTenantSegment<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantSegmentId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tenant segment
try {
    $Result = Invoke-PatchTenantSegment -TenantId $TenantId -TenantSegmentId $TenantSegmentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTenantSegment: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantSegmentUpdateDto = Initialize-TenantSegmentUpdateDto -MinEmployees 0 -MaxEmployees 0 # TenantSegmentUpdateDto |  (optional)
