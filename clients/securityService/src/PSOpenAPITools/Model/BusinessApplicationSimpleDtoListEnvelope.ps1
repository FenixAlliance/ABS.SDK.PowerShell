...
BusinessApplicationSimpleDtoListEnvelope<PSCustomObject>
#>

function Initialize-BusinessApplicationSimpleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessApplicationSimpleDtoListEnvelope' | Write-Debug
...
Convert from JSON to BusinessApplicationSimpleDtoListEnvelope<PSCustomObject>
...
BusinessApplicationSimpleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessApplicationSimpleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessApplicationSimpleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessApplicationSimpleDtoListEnvelope
