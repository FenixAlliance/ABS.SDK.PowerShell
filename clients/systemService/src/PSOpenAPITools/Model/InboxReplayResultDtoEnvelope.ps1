...
InboxReplayResultDtoEnvelope<PSCustomObject>
#>

function Initialize-InboxReplayResultDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InboxReplayResultDtoEnvelope' | Write-Debug
...
Convert from JSON to InboxReplayResultDtoEnvelope<PSCustomObject>
...
InboxReplayResultDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInboxReplayResultDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InboxReplayResultDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InboxReplayResultDtoEnvelope
