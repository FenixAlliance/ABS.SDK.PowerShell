...
AssetValueAmendDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetValueAmendDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetValueAmendDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetValueAmendDtoEnvelope<PSCustomObject>
...
AssetValueAmendDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetValueAmendDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetValueAmendDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetValueAmendDtoEnvelope
