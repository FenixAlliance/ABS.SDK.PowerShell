...
ItemWarrantyPolicyCreateDto<PSCustomObject>
#>

function Initialize-ItemWarrantyPolicyCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyCreateDto' | Write-Debug
...
Convert from JSON to ItemWarrantyPolicyCreateDto<PSCustomObject>
...
ItemWarrantyPolicyCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemWarrantyPolicyCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemWarrantyPolicyCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "isExtendedWarranty", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId")
