...
CapabilityDtoListEnvelope<PSCustomObject>
#>

function Initialize-CapabilityDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CapabilityDtoListEnvelope' | Write-Debug
...
Convert from JSON to CapabilityDtoListEnvelope<PSCustomObject>
...
CapabilityDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCapabilityDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CapabilityDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapabilityDtoListEnvelope
