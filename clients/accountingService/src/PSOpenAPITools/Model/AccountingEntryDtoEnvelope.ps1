...
AccountingEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-AccountingEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountingEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to AccountingEntryDtoEnvelope<PSCustomObject>
...
AccountingEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountingEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountingEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountingEntryDtoEnvelope
