...
ExpenseTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExpenseTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExpenseTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExpenseTypeDtoListEnvelope<PSCustomObject>
...
ExpenseTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExpenseTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExpenseTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExpenseTypeDtoListEnvelope
