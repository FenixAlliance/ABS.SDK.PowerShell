...
GigDtoListEnvelope<PSCustomObject>
#>

function Initialize-GigDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GigDtoListEnvelope' | Write-Debug
...
Convert from JSON to GigDtoListEnvelope<PSCustomObject>
...
GigDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGigDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GigDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GigDtoListEnvelope
