...
[**Invoke-PatchAccountingPeriodAsync**](AccountingPeriodsApi.md#Invoke-PatchAccountingPeriodAsync) | **PATCH** /api/v2/AccountingService/AccountingPeriods/{accountingPeriodId} | Patch an accounting period
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccountingPeriodDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$AccountingPeriodDtoCollectionQueryParameters = Initialize-AccountingPeriodDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # AccountingPeriodDtoCollectionQueryParameters |  (optional)

# Get all accounting periods for a tenant
try {
    $Result = Get-AccountingPeriods -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -AccountingPeriodDtoCollectionQueryParameters $AccountingPeriodDtoCollectionQueryParameters
} catch {
...
# Gets the current tenant accounting periods count
try {
    $Result = Get-AccountingPeriodsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -AccountingPeriodDtoCollectionQueryParameters $AccountingPeriodDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchAccountingPeriodAsync"></a>
# **Invoke-PatchAccountingPeriodAsync**
> EmptyEnvelope Invoke-PatchAccountingPeriodAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccountingPeriodId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch an accounting period
try {
    $Result = Invoke-PatchAccountingPeriodAsync -TenantId $TenantId -AccountingPeriodId $AccountingPeriodId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchAccountingPeriodAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
