...
function Get-AllModules {
    ...
    Process {
        'Calling method: Get-AllModules' | Write-Debug
        ...
        $LocalVarUri = '/api/v2/StudioService/Modules'
        ...
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getAllModules."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "StudioModuleListEnvelope" `
...
function Get-AvailableModules {
    ...
    Process {
        'Calling method: Get-AvailableModules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/StudioService/Modules/Data'
