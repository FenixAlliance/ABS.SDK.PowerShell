...
BillingProfileDtoEnvelope<PSCustomObject>
#>

function Initialize-BillingProfileDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingProfileDtoEnvelope' | Write-Debug
...
Convert from JSON to BillingProfileDtoEnvelope<PSCustomObject>
...
BillingProfileDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBillingProfileDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingProfileDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingProfileDtoEnvelope
