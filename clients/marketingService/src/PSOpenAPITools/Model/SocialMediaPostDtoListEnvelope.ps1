...
SocialMediaPostDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialMediaPostDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialMediaPostDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialMediaPostDtoListEnvelope<PSCustomObject>
...
SocialMediaPostDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialMediaPostDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialMediaPostDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialMediaPostDtoListEnvelope
