...
TenantUnitDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantUnitDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantUnitDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantUnitDtoListEnvelope<PSCustomObject>
...
TenantUnitDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantUnitDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantUnitDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantUnitDtoListEnvelope
