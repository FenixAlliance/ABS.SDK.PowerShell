...
ActivityRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-ActivityRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to ActivityRecordDtoListEnvelope<PSCustomObject>
...
ActivityRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityRecordDtoListEnvelope
