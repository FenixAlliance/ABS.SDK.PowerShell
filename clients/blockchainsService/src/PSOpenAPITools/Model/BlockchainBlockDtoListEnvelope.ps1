...
BlockchainBlockDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlockchainBlockDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlockchainBlockDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlockchainBlockDtoListEnvelope<PSCustomObject>
...
BlockchainBlockDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlockchainBlockDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlockchainBlockDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlockchainBlockDtoListEnvelope
