...
SecurityCertificateDtoListEnvelope<PSCustomObject>
#>

function Initialize-SecurityCertificateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityCertificateDtoListEnvelope' | Write-Debug
...
Convert from JSON to SecurityCertificateDtoListEnvelope<PSCustomObject>
...
SecurityCertificateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityCertificateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityCertificateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityCertificateDtoListEnvelope
