...
FiscalIdentificationTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalIdentificationTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalIdentificationTypeDtoListEnvelope<PSCustomObject>
...
FiscalIdentificationTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalIdentificationTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalIdentificationTypeDtoListEnvelope
