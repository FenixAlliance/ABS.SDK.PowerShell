...
# Patch an accounting period
try {
    $Result = Invoke-PatchAccountingPeriodAsync -TenantId $TenantId -AccountingPeriodId $AccountingPeriodId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
