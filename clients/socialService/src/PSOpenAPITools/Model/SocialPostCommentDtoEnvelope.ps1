...
SocialPostCommentDtoEnvelope<PSCustomObject>
#>

function Initialize-SocialPostCommentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostCommentDtoEnvelope' | Write-Debug
...
Convert from JSON to SocialPostCommentDtoEnvelope<PSCustomObject>
...
SocialPostCommentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostCommentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostCommentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostCommentDtoEnvelope
