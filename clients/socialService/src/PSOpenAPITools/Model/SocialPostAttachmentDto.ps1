...
SocialPostAttachmentDto<PSCustomObject>
#>

function Initialize-SocialPostAttachmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostAttachmentDto' | Write-Debug
...
Convert from JSON to SocialPostAttachmentDto<PSCustomObject>
...
SocialPostAttachmentDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostAttachmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
