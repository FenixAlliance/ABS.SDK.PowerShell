...
JournalTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-JournalTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to JournalTypeDtoEnvelope<PSCustomObject>
...
JournalTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJournalTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalTypeDtoEnvelope
