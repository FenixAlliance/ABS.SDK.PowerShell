...
SalesLiteratureDtoListEnvelope<PSCustomObject>
#>

function Initialize-SalesLiteratureDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SalesLiteratureDtoListEnvelope' | Write-Debug
...
Convert from JSON to SalesLiteratureDtoListEnvelope<PSCustomObject>
...
SalesLiteratureDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSalesLiteratureDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SalesLiteratureDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SalesLiteratureDtoListEnvelope
