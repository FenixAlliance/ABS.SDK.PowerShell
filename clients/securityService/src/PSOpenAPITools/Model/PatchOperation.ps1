...
function Initialize-PatchOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchOperation' | Write-Debug
...
Convert from JSON to PatchOperation<PSCustomObject>
...
PatchOperation<PSCustomObject>
#>
function ConvertFrom-JsonToPatchOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchOperation
        $AllProperties = ("op", "path", "from", "value")
