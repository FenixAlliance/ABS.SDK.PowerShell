...
SupportTicketTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketTypeDtoEnvelope<PSCustomObject>
...
SupportTicketTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketTypeDtoEnvelope
