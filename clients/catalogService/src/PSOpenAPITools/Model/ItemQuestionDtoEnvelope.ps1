...
ItemQuestionDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemQuestionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemQuestionDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemQuestionDtoEnvelope<PSCustomObject>
...
ItemQuestionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemQuestionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemQuestionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemQuestionDtoEnvelope
