...
**IsBlogPage** | **Boolean** |  | [optional] 
**IsAccountPage** | **Boolean** |  | [optional] 
**IsCheckoutPage** | **Boolean** |  | [optional] 
**IsWishListsPage** | **Boolean** |  | [optional] 
**IsContactPage** | **Boolean** |  | [optional] 
**IsPrivacyPolicyPage** | **Boolean** |  | [optional] 
**IsTermsOfServicePage** | **Boolean** |  | [optional] 

## Examples

- Prepare the resource
```powershell
$WebPageUpdateDto = Initialize-PSOpenAPIToolsWebPageUpdateDto  -Order null `
 -Slug null `
 -Name null `
 -Title null `
 -Excerpt null `
 ...
 -IsAccountPage null `
 -IsCheckoutPage null `
 -IsWishListsPage null `
 -IsContactPage null `
 -IsPrivacyPolicyPage null `
 -IsTermsOfServicePage null
```

- Convert the resource to JSON
```powershell
$WebPageUpdateDto | ConvertTo-JSON
```
