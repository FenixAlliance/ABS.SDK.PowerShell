...
ExtendedDealUnitDtoEnvelope<PSCustomObject>
#>

function Initialize-ExtendedDealUnitDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedDealUnitDtoEnvelope' | Write-Debug
...
Convert from JSON to ExtendedDealUnitDtoEnvelope<PSCustomObject>
...
ExtendedDealUnitDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedDealUnitDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedDealUnitDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedDealUnitDtoEnvelope
