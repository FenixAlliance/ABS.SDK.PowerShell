...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmployeeProfileDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$EmployeeProfileDtoCollectionQueryParameters = Initialize-EmployeeProfileDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # EmployeeProfileDtoCollectionQueryParameters |  (optional)

# Get employees
try {
    $Result = Get-EmployeesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmployeeProfileDtoCollectionQueryParameters $EmployeeProfileDtoCollectionQueryParameters
} catch {
...
# Count employees
try {
    $Result = Get-EmployeesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmployeeProfileDtoCollectionQueryParameters $EmployeeProfileDtoCollectionQueryParameters
} catch {
...
# Patch an employee
try {
    $Result = Invoke-PatchEmployeeAsync -TenantId $TenantId -EmployeeId $EmployeeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
