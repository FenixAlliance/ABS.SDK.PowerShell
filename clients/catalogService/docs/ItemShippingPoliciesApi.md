...
# Count item shipping policies
try {
    $Result = Invoke-CountItemShippingPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemShippingPolicyDtoCollectionQueryParameters $ItemShippingPolicyDtoCollectionQueryParameters
} catch {
...
# Get item shipping policies
try {
    $Result = Get-CatalogItemShippingPoliciesAsync -TenantId $TenantId -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemShippingPolicyDtoCollectionQueryParameters $ItemShippingPolicyDtoCollectionQueryParameters
} catch {
