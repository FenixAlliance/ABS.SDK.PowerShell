...
ServiceLevelAgreementDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceLevelAgreementDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceLevelAgreementDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceLevelAgreementDtoEnvelope<PSCustomObject>
...
ServiceLevelAgreementDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceLevelAgreementDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceLevelAgreementDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceLevelAgreementDtoEnvelope
