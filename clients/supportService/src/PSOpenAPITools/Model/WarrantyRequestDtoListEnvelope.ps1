...
WarrantyRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-WarrantyRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarrantyRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to WarrantyRequestDtoListEnvelope<PSCustomObject>
...
WarrantyRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWarrantyRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarrantyRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarrantyRequestDtoListEnvelope
