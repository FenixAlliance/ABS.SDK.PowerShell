...
QuoteLineUpdateDto<PSCustomObject>
#>

function Initialize-QuoteLineUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineUpdateDto' | Write-Debug
...
Convert from JSON to QuoteLineUpdateDto<PSCustomObject>
...
QuoteLineUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineUpdateDto
