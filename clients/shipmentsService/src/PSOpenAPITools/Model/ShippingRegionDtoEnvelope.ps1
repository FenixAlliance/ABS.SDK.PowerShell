...
ShippingRegionDtoEnvelope<PSCustomObject>
#>

function Initialize-ShippingRegionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingRegionDtoEnvelope' | Write-Debug
...
Convert from JSON to ShippingRegionDtoEnvelope<PSCustomObject>
...
ShippingRegionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShippingRegionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingRegionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingRegionDtoEnvelope
