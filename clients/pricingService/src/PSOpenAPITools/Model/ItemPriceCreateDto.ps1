...
ItemPriceCreateDto<PSCustomObject>
#>

function Initialize-ItemPriceCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPriceCreateDto' | Write-Debug
...
Convert from JSON to ItemPriceCreateDto<PSCustomObject>
...
ItemPriceCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemPriceCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPriceCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
