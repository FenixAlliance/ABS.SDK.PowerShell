...
function Initialize-TenantCreateDto {
    ...
    Param (
        ...
        [ValidateSet("Organization", "Individual")]
        [String]
        ${Kind},
...
function ConvertFrom-JsonToTenantCreateDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "kind", "name", "legalName", "email", "phone", "webUrl", "handler", "about", "slogan", "currencyId", "duns", "taxId", "avatarUrl", "countryId", "stateId", "cityId", "languageId", "timezoneId", "businessTypeId", "businessSegmentId", "businessIndustryId", "businessSizeId")
