...
EmployeeAppraisalSessionDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmployeeAppraisalSessionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeAppraisalSessionDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmployeeAppraisalSessionDtoListEnvelope<PSCustomObject>
...
EmployeeAppraisalSessionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeAppraisalSessionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeAppraisalSessionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeAppraisalSessionDtoListEnvelope
