...
AccountTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-AccountTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to AccountTypeDtoEnvelope<PSCustomObject>
...
AccountTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountTypeDtoEnvelope
