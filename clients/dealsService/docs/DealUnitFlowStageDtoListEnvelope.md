...
```powershell
$DealUnitFlowStageDtoListEnvelope = Initialize-PSOpenAPIToolsDealUnitFlowStageDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$DealUnitFlowStageDtoListEnvelope | ConvertTo-JSON
```
