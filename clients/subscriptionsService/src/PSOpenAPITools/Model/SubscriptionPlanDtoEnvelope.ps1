...
SubscriptionPlanDtoEnvelope<PSCustomObject>
#>

function Initialize-SubscriptionPlanDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SubscriptionPlanDtoEnvelope' | Write-Debug
...
Convert from JSON to SubscriptionPlanDtoEnvelope<PSCustomObject>
...
SubscriptionPlanDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSubscriptionPlanDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SubscriptionPlanDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SubscriptionPlanDtoEnvelope
