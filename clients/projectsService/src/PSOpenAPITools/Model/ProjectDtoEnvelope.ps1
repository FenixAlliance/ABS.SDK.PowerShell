...
ProjectDtoEnvelope<PSCustomObject>
#>

function Initialize-ProjectDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectDtoEnvelope' | Write-Debug
...
Convert from JSON to ProjectDtoEnvelope<PSCustomObject>
...
ProjectDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectDtoEnvelope
