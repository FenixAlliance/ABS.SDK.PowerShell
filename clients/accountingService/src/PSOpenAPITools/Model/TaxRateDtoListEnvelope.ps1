...
TaxRateDtoListEnvelope<PSCustomObject>
#>

function Initialize-TaxRateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxRateDtoListEnvelope' | Write-Debug
...
Convert from JSON to TaxRateDtoListEnvelope<PSCustomObject>
...
TaxRateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxRateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxRateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxRateDtoListEnvelope
