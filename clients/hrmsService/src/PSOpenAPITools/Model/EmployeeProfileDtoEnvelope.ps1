...
EmployeeProfileDtoEnvelope<PSCustomObject>
#>

function Initialize-EmployeeProfileDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeProfileDtoEnvelope' | Write-Debug
...
Convert from JSON to EmployeeProfileDtoEnvelope<PSCustomObject>
...
EmployeeProfileDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeProfileDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeProfileDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeProfileDtoEnvelope
