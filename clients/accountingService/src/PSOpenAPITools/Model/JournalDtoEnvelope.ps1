...
JournalDtoEnvelope<PSCustomObject>
#>

function Initialize-JournalDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalDtoEnvelope' | Write-Debug
...
Convert from JSON to JournalDtoEnvelope<PSCustomObject>
...
JournalDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJournalDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalDtoEnvelope
