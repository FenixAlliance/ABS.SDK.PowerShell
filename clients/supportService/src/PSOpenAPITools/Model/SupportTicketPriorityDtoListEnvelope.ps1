...
SupportTicketPriorityDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketPriorityDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketPriorityDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketPriorityDtoListEnvelope<PSCustomObject>
...
SupportTicketPriorityDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketPriorityDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketPriorityDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketPriorityDtoListEnvelope
