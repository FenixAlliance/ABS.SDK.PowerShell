...
ItemWarrantyPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemWarrantyPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemWarrantyPolicyDtoListEnvelope<PSCustomObject>
...
ItemWarrantyPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemWarrantyPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemWarrantyPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemWarrantyPolicyDtoListEnvelope
