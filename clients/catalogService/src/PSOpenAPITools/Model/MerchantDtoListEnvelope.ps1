...
MerchantDtoListEnvelope<PSCustomObject>
#>

function Initialize-MerchantDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MerchantDtoListEnvelope' | Write-Debug
...
Convert from JSON to MerchantDtoListEnvelope<PSCustomObject>
...
MerchantDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMerchantDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MerchantDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MerchantDtoListEnvelope
