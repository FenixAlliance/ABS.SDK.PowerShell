...
SeawayBillDtoListEnvelope<PSCustomObject>
#>

function Initialize-SeawayBillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SeawayBillDtoListEnvelope' | Write-Debug
...
Convert from JSON to SeawayBillDtoListEnvelope<PSCustomObject>
...
SeawayBillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSeawayBillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SeawayBillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SeawayBillDtoListEnvelope
