...
LocationCreateDto<PSCustomObject>
#>

function Initialize-LocationCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationCreateDto' | Write-Debug
...
Convert from JSON to LocationCreateDto<PSCustomObject>
...
LocationCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToLocationCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
