...
BusinessRelationshipDtoListEnvelope<PSCustomObject>
#>

function Initialize-BusinessRelationshipDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessRelationshipDtoListEnvelope' | Write-Debug
...
Convert from JSON to BusinessRelationshipDtoListEnvelope<PSCustomObject>
...
BusinessRelationshipDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessRelationshipDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessRelationshipDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessRelationshipDtoListEnvelope
