...
ReceiptCreateDto<PSCustomObject>
#>

function Initialize-ReceiptCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReceiptCreateDto' | Write-Debug
...
Convert from JSON to ReceiptCreateDto<PSCustomObject>
...
ReceiptCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToReceiptCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReceiptCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
