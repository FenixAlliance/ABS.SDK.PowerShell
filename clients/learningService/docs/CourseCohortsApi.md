...
# Get all course cohorts
try {
    $Result = Get-CourseCohortsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseCohortDtoCollectionQueryParameters $CourseCohortDtoCollectionQueryParameters
} catch {
...
# Get course cohorts count
try {
    $Result = Get-CourseCohortsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseCohortDtoCollectionQueryParameters $CourseCohortDtoCollectionQueryParameters
} catch {
...
# Patch a course cohort
try {
    $Result = Invoke-PatchCourseCohortAsync -TenantId $TenantId -CohortId $CohortId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
