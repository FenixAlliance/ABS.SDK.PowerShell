...
JobOfferApplicationDtoListEnvelope<PSCustomObject>
#>

function Initialize-JobOfferApplicationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobOfferApplicationDtoListEnvelope' | Write-Debug
...
Convert from JSON to JobOfferApplicationDtoListEnvelope<PSCustomObject>
...
JobOfferApplicationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobOfferApplicationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobOfferApplicationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobOfferApplicationDtoListEnvelope
