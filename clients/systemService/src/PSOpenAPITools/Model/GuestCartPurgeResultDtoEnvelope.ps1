...
GuestCartPurgeResultDtoEnvelope<PSCustomObject>
#>

function Initialize-GuestCartPurgeResultDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GuestCartPurgeResultDtoEnvelope' | Write-Debug
...
Convert from JSON to GuestCartPurgeResultDtoEnvelope<PSCustomObject>
...
GuestCartPurgeResultDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGuestCartPurgeResultDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GuestCartPurgeResultDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuestCartPurgeResultDtoEnvelope
