...
LeaveTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-LeaveTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LeaveTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to LeaveTypeDtoListEnvelope<PSCustomObject>
...
LeaveTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLeaveTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LeaveTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LeaveTypeDtoListEnvelope
