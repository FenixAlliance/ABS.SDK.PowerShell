...
DealUnitFlowStageDtoEnvelope<PSCustomObject>
#>

function Initialize-DealUnitFlowStageDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DealUnitFlowStageDtoEnvelope' | Write-Debug
...
Convert from JSON to DealUnitFlowStageDtoEnvelope<PSCustomObject>
...
DealUnitFlowStageDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDealUnitFlowStageDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DealUnitFlowStageDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DealUnitFlowStageDtoEnvelope
