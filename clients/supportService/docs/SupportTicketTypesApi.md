...
# Patch a support ticket type
try {
    $Result = Invoke-PatchSupportTicketTypeAsync -TenantId $TenantId -SupportTicketTypeId $SupportTicketTypeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
