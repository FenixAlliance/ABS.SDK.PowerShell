...
# Patch an item category
try {
    $Result = Invoke-PatchItemCategoryAsync -TenantId $TenantId -ItemCategoryId $ItemCategoryId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
