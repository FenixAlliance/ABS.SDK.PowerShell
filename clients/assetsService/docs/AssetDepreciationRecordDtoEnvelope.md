...
```powershell
$AssetDepreciationRecordDtoEnvelope = Initialize-PSOpenAPIToolsAssetDepreciationRecordDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$AssetDepreciationRecordDtoEnvelope | ConvertTo-JSON
```
