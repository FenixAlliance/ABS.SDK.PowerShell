...
SocialFeedDtoEnvelope<PSCustomObject>
#>

function Initialize-SocialFeedDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialFeedDtoEnvelope' | Write-Debug
...
Convert from JSON to SocialFeedDtoEnvelope<PSCustomObject>
...
SocialFeedDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialFeedDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialFeedDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialFeedDtoEnvelope
