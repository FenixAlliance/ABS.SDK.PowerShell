...
TaskCategoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-TaskCategoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaskCategoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to TaskCategoryDtoListEnvelope<PSCustomObject>
...
TaskCategoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaskCategoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaskCategoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskCategoryDtoListEnvelope
