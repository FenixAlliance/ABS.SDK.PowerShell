...
ActivityTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-ActivityTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ActivityTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to ActivityTypeDtoEnvelope<PSCustomObject>
...
ActivityTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToActivityTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ActivityTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ActivityTypeDtoEnvelope
