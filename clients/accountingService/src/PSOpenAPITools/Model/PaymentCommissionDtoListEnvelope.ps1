...
PaymentCommissionDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentCommissionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentCommissionDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentCommissionDtoListEnvelope<PSCustomObject>
...
PaymentCommissionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentCommissionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentCommissionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentCommissionDtoListEnvelope
