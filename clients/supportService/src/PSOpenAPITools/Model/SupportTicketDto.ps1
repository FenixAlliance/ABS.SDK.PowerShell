...
function ConvertFrom-JsonToSupportTicketDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "title", "description", "supportTicketStatus", "userId", "contactId", "tenantId", "enrollmentId", "supportTicketTypeId", "supportEntitlementId", "supportPriorityId")
