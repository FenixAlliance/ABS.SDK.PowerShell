...
JobOfferDtoEnvelope<PSCustomObject>
#>

function Initialize-JobOfferDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobOfferDtoEnvelope' | Write-Debug
...
Convert from JSON to JobOfferDtoEnvelope<PSCustomObject>
...
JobOfferDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobOfferDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobOfferDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobOfferDtoEnvelope
