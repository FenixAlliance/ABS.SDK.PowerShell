...
SupportRequestCreateDto<PSCustomObject>
#>

function Initialize-SupportRequestCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportRequestCreateDto' | Write-Debug
...
Convert from JSON to SupportRequestCreateDto<PSCustomObject>
...
SupportRequestCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSupportRequestCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportRequestCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
