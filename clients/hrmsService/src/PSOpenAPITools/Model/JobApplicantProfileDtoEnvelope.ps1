...
JobApplicantProfileDtoEnvelope<PSCustomObject>
#>

function Initialize-JobApplicantProfileDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobApplicantProfileDtoEnvelope' | Write-Debug
...
Convert from JSON to JobApplicantProfileDtoEnvelope<PSCustomObject>
...
JobApplicantProfileDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobApplicantProfileDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobApplicantProfileDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobApplicantProfileDtoEnvelope
