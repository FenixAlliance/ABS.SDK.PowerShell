...
LedgerDtoEnvelope<PSCustomObject>
#>

function Initialize-LedgerDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LedgerDtoEnvelope' | Write-Debug
...
Convert from JSON to LedgerDtoEnvelope<PSCustomObject>
...
LedgerDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLedgerDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LedgerDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LedgerDtoEnvelope
