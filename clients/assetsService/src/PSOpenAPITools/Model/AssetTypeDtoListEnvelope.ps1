...
AssetTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetTypeDtoListEnvelope<PSCustomObject>
...
AssetTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetTypeDtoListEnvelope
