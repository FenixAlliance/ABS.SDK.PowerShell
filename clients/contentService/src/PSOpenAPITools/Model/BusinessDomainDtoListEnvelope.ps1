...
BusinessDomainDtoListEnvelope<PSCustomObject>
#>

function Initialize-BusinessDomainDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessDomainDtoListEnvelope' | Write-Debug
...
Convert from JSON to BusinessDomainDtoListEnvelope<PSCustomObject>
...
BusinessDomainDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessDomainDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessDomainDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessDomainDtoListEnvelope
