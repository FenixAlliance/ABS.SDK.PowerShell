...
AddressDtoListEnvelope<PSCustomObject>
#>

function Initialize-AddressDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddressDtoListEnvelope' | Write-Debug
...
Convert from JSON to AddressDtoListEnvelope<PSCustomObject>
...
AddressDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAddressDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddressDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddressDtoListEnvelope
