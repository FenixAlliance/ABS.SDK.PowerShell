...
ExtendedUserDtoEnvelope<PSCustomObject>
#>

function Initialize-ExtendedUserDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedUserDtoEnvelope' | Write-Debug
...
Convert from JSON to ExtendedUserDtoEnvelope<PSCustomObject>
...
ExtendedUserDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedUserDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedUserDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedUserDtoEnvelope
