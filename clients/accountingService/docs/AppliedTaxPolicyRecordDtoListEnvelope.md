...
```powershell
$AppliedTaxPolicyRecordDtoListEnvelope = Initialize-PSOpenAPIToolsAppliedTaxPolicyRecordDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$AppliedTaxPolicyRecordDtoListEnvelope | ConvertTo-JSON
```
