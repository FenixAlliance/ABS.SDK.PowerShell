...
LoanTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-LoanTypeDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanTypeDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to LoanTypeDtoIReadOnlyListEnvelope<PSCustomObject>
...
LoanTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoanTypeDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanTypeDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanTypeDtoIReadOnlyListEnvelope
