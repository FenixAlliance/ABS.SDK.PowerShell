...
ItemCartRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemCartRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemCartRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemCartRecordDtoEnvelope<PSCustomObject>
...
ItemCartRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemCartRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemCartRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemCartRecordDtoEnvelope
