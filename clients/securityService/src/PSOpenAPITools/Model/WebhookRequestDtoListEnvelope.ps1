...
WebhookRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebhookRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebhookRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebhookRequestDtoListEnvelope<PSCustomObject>
...
WebhookRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebhookRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebhookRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebhookRequestDtoListEnvelope
