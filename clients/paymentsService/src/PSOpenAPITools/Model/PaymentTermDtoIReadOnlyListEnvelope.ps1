...
PaymentTermDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-PaymentTermDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentTermDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to PaymentTermDtoIReadOnlyListEnvelope<PSCustomObject>
...
PaymentTermDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentTermDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentTermDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentTermDtoIReadOnlyListEnvelope
