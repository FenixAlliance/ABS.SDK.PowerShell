...
CourseEnrollmentDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-CourseEnrollmentDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseEnrollmentDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to CourseEnrollmentDtoIReadOnlyListEnvelope<PSCustomObject>
...
CourseEnrollmentDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCourseEnrollmentDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseEnrollmentDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseEnrollmentDtoIReadOnlyListEnvelope
