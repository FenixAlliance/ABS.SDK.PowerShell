...
UnitGroupDtoEnvelope<PSCustomObject>
#>

function Initialize-UnitGroupDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UnitGroupDtoEnvelope' | Write-Debug
...
Convert from JSON to UnitGroupDtoEnvelope<PSCustomObject>
...
UnitGroupDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUnitGroupDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UnitGroupDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UnitGroupDtoEnvelope
