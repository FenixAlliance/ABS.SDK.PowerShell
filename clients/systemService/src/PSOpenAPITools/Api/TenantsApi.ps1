...
None
#>
function Invoke-AdminPreviewTenantEmail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-AdminPreviewTenantEmail' | Write-Debug
        ...
        $LocalVarUri = '/api/v2/SystemService/Tenants/{tenantId}/Emails/Preview'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling adminPreviewTenantEmail."
        }
...
None
#>
function Invoke-AdminSendTenantEmail {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-AdminSendTenantEmail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/SystemService/Tenants/{tenantId}/Emails/Send'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling adminSendTenantEmail."
        }
        $LocalVarUri = $LocalVarUri.replace('{tenantId}', [System.Web.HTTPUtility]::UrlEncode($TenantId))
...
.PARAMETER ExtendedTenantDtoCollectionQueryParameters
No description available.
...
function Get-AllExtendedTenants {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $ExtendedTenantDtoCollectionQueryParameters | ConvertTo-Json -Depth 100
...
#>
function Get-TenantModuleGrants {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-TenantModuleGrants' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/SystemService/Tenants/{tenantId}/ModuleGrants'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getTenantModuleGrants."
        }
        $LocalVarUri = $LocalVarUri.replace('{tenantId}', [System.Web.HTTPUtility]::UrlEncode($TenantId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ModuleGrantDtoListEnvelope" `
                                -IsBodyNullable $false
...
function Invoke-PatchTenant {
    ...
    Process {
        'Calling method: Invoke-PatchTenant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/SystemService/Tenants/{tenantId}'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling patchTenant."
        }
        $LocalVarUri = $LocalVarUri.replace('{tenantId}', [System.Web.HTTPUtility]::UrlEncode($TenantId))
...
EmptyEnvelope
#>
function Set-TenantModuleGrants {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-TenantModuleGrants' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/SystemService/Tenants/{tenantId}/ModuleGrants'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling setTenantModuleGrants."
        }
        $LocalVarUri = $LocalVarUri.replace('{tenantId}', [System.Web.HTTPUtility]::UrlEncode($TenantId))
        ...
        $LocalVarBodyParameter = ConvertTo-Json @($ModuleGrantDto) -Depth 100
