...
BankProfileDto<PSCustomObject>
#>

function Initialize-BankProfileDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankProfileDto' | Write-Debug
...
Convert from JSON to BankProfileDto<PSCustomObject>
...
BankProfileDto<PSCustomObject>
#>
function ConvertFrom-JsonToBankProfileDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankProfileDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankProfileDto
        $AllProperties = ("id", "timestamp", "contactId", "tenantId", "type", "enrollmentId", "about", "verified", "submitted", "avatarUrl", "contact", "qualifiedName", "verificationTimestamp", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "bankId", "bankName")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "bankName"))) { #optional property not found
            $BankName = $null
        } else {
            $BankName = $JsonParameters.PSobject.Properties["bankName"].value
        }
