...
MarketingAreaDtoListEnvelope<PSCustomObject>
#>

function Initialize-MarketingAreaDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingAreaDtoListEnvelope' | Write-Debug
...
Convert from JSON to MarketingAreaDtoListEnvelope<PSCustomObject>
...
MarketingAreaDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingAreaDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingAreaDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingAreaDtoListEnvelope
