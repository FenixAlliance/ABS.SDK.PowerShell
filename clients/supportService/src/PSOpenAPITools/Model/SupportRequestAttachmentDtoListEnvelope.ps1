...
SupportRequestAttachmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-SupportRequestAttachmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportRequestAttachmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to SupportRequestAttachmentDtoListEnvelope<PSCustomObject>
...
SupportRequestAttachmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportRequestAttachmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportRequestAttachmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportRequestAttachmentDtoListEnvelope
