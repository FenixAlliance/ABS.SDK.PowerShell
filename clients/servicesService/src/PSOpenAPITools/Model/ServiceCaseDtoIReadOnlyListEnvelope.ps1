...
ServiceCaseDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-ServiceCaseDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to ServiceCaseDtoIReadOnlyListEnvelope<PSCustomObject>
...
ServiceCaseDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseDtoIReadOnlyListEnvelope
