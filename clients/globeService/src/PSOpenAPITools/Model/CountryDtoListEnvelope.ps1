...
CountryDtoListEnvelope<PSCustomObject>
#>

function Initialize-CountryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountryDtoListEnvelope' | Write-Debug
...
Convert from JSON to CountryDtoListEnvelope<PSCustomObject>
...
CountryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountryDtoListEnvelope
