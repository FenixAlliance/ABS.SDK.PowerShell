...
UserSettingsDtoEnvelope<PSCustomObject>
#>

function Initialize-UserSettingsDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserSettingsDtoEnvelope' | Write-Debug
...
Convert from JSON to UserSettingsDtoEnvelope<PSCustomObject>
...
UserSettingsDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUserSettingsDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserSettingsDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserSettingsDtoEnvelope
