...
MenuContextDtoListEnvelope<PSCustomObject>
#>

function Initialize-MenuContextDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MenuContextDtoListEnvelope' | Write-Debug
...
Convert from JSON to MenuContextDtoListEnvelope<PSCustomObject>
...
MenuContextDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMenuContextDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MenuContextDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MenuContextDtoListEnvelope
