...
InstructorProfileCreateDto<PSCustomObject>
#>

function Initialize-InstructorProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InstructorProfileCreateDto' | Write-Debug
...
Convert from JSON to InstructorProfileCreateDto<PSCustomObject>
...
InstructorProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToInstructorProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InstructorProfileCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InstructorProfileCreateDto
        $AllProperties = ("id", "timestamp", "type", "contactId", "about", "avatarUrl", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "authorized", "contactID")
