...
[**Invoke-PatchSystemOption**](OptionsApi.md#Invoke-PatchSystemOption) | **PATCH** /api/v2/SystemService/Options/{optionId} | Partially update a system option
...
# Retrieve a list of system options
try {
    $Result = Get-SystemOptions -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Get the count of system options
try {
    $Result = Get-SystemOptionsCount -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSystemOption"></a>
# **Invoke-PatchSystemOption**
> EmptyEnvelope Invoke-PatchSystemOption<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OptionId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Partially update a system option
try {
    $Result = Invoke-PatchSystemOption -OptionId $OptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSystemOption: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
