...
LocationDtoListEnvelope<PSCustomObject>
#>

function Initialize-LocationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationDtoListEnvelope' | Write-Debug
...
Convert from JSON to LocationDtoListEnvelope<PSCustomObject>
...
LocationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLocationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationDtoListEnvelope
