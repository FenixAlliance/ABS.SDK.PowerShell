...
ServiceLevelAgreementDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-ServiceLevelAgreementDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceLevelAgreementDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to ServiceLevelAgreementDtoIReadOnlyListEnvelope<PSCustomObject>
...
ServiceLevelAgreementDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceLevelAgreementDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceLevelAgreementDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceLevelAgreementDtoIReadOnlyListEnvelope
