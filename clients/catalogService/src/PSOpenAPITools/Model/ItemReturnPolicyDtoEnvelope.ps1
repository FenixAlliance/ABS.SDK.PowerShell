...
ItemReturnPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemReturnPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemReturnPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemReturnPolicyDtoEnvelope<PSCustomObject>
...
ItemReturnPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemReturnPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemReturnPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemReturnPolicyDtoEnvelope
