...
LoyaltyProgramCreateDto<PSCustomObject>
#>

function Initialize-LoyaltyProgramCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoyaltyProgramCreateDto' | Write-Debug
...
Convert from JSON to LoyaltyProgramCreateDto<PSCustomObject>
...
LoyaltyProgramCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToLoyaltyProgramCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoyaltyProgramCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoyaltyProgramCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "priceListId")
