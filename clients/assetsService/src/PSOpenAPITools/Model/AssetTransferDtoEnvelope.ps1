...
AssetTransferDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetTransferDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetTransferDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetTransferDtoEnvelope<PSCustomObject>
...
AssetTransferDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetTransferDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetTransferDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetTransferDtoEnvelope
