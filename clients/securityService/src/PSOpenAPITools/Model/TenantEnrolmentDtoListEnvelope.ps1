...
TenantEnrolmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantEnrolmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantEnrolmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantEnrolmentDtoListEnvelope<PSCustomObject>
...
TenantEnrolmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantEnrolmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantEnrolmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantEnrolmentDtoListEnvelope
