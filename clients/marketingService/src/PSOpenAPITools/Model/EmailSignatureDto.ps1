...
EmailSignatureDto<PSCustomObject>
#>

function Initialize-EmailSignatureDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailSignatureDto' | Write-Debug
...
Convert from JSON to EmailSignatureDto<PSCustomObject>
...
EmailSignatureDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmailSignatureDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailSignatureDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailSignatureDto
