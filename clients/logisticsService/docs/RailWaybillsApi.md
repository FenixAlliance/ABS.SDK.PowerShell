...
# Get rail waybill lines
try {
    $Result = Get-RailWaybillLinesAsync -TenantId $TenantId -WaybillId $WaybillId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -WaybillLineDtoCollectionQueryParameters $WaybillLineDtoCollectionQueryParameters
} catch {
...
# Get rail waybill lines count
try {
    $Result = Get-RailWaybillLinesCountAsync -TenantId $TenantId -WaybillId $WaybillId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -WaybillLineDtoCollectionQueryParameters $WaybillLineDtoCollectionQueryParameters
} catch {
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RailWaybillDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$RailWaybillDtoCollectionQueryParameters = Initialize-RailWaybillDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # RailWaybillDtoCollectionQueryParameters |  (optional)

# Get all rail waybills
try {
    $Result = Get-RailWaybillsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -RailWaybillDtoCollectionQueryParameters $RailWaybillDtoCollectionQueryParameters
} catch {
...
# Get rail waybills count
try {
    $Result = Get-RailWaybillsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -RailWaybillDtoCollectionQueryParameters $RailWaybillDtoCollectionQueryParameters
} catch {
...
# Patch a rail waybill
try {
    $Result = Invoke-PatchRailWaybillAsync -TenantId $TenantId -WaybillId $WaybillId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
...
# Patch a rail waybill line
try {
    $Result = Invoke-PatchRailWaybillLineAsync -TenantId $TenantId -WaybillId $WaybillId -LineId $LineId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
