...
ServiceDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-ServiceDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to ServiceDtoIReadOnlyListEnvelope<PSCustomObject>
...
ServiceDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceDtoIReadOnlyListEnvelope
