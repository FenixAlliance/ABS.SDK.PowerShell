...
SupportTicketConversationDtoEnvelope<PSCustomObject>
#>

function Initialize-SupportTicketConversationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketConversationDtoEnvelope' | Write-Debug
...
Convert from JSON to SupportTicketConversationDtoEnvelope<PSCustomObject>
...
SupportTicketConversationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketConversationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketConversationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SupportTicketConversationDtoEnvelope
