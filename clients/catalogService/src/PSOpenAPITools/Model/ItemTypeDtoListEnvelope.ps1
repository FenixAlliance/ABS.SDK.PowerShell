...
ItemTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemTypeDtoListEnvelope<PSCustomObject>
...
ItemTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTypeDtoListEnvelope
