...
TenantEnrolmentDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantEnrolmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantEnrolmentDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantEnrolmentDtoEnvelope<PSCustomObject>
...
TenantEnrolmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantEnrolmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantEnrolmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantEnrolmentDtoEnvelope
