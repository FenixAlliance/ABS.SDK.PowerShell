...
WebPageCategoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebPageCategoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageCategoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebPageCategoryDtoListEnvelope<PSCustomObject>
...
WebPageCategoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageCategoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageCategoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageCategoryDtoListEnvelope
