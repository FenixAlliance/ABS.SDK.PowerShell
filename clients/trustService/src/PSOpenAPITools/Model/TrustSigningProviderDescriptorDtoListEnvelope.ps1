...
TrustSigningProviderDescriptorDtoListEnvelope<PSCustomObject>
#>

function Initialize-TrustSigningProviderDescriptorDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrustSigningProviderDescriptorDtoListEnvelope' | Write-Debug
...
Convert from JSON to TrustSigningProviderDescriptorDtoListEnvelope<PSCustomObject>
...
TrustSigningProviderDescriptorDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrustSigningProviderDescriptorDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrustSigningProviderDescriptorDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrustSigningProviderDescriptorDtoListEnvelope
