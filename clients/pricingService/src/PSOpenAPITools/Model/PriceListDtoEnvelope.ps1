...
PriceListDtoEnvelope<PSCustomObject>
#>

function Initialize-PriceListDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PriceListDtoEnvelope' | Write-Debug
...
Convert from JSON to PriceListDtoEnvelope<PSCustomObject>
...
PriceListDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPriceListDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PriceListDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceListDtoEnvelope
