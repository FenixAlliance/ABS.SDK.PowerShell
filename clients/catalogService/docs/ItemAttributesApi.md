...
# Patch an item attribute
try {
    $Result = Invoke-PatchItemAttributeAsync -TenantId $TenantId -ItemAttributeId $ItemAttributeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
