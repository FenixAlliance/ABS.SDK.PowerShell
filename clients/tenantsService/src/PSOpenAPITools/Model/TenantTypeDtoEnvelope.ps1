...
TenantTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantTypeDtoEnvelope<PSCustomObject>
...
TenantTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTypeDtoEnvelope
