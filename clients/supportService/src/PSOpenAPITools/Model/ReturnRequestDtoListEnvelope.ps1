...
ReturnRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-ReturnRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReturnRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to ReturnRequestDtoListEnvelope<PSCustomObject>
...
ReturnRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToReturnRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReturnRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReturnRequestDtoListEnvelope
