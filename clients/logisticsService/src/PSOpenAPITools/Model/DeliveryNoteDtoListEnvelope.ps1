...
DeliveryNoteDtoListEnvelope<PSCustomObject>
#>

function Initialize-DeliveryNoteDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeliveryNoteDtoListEnvelope' | Write-Debug
...
Convert from JSON to DeliveryNoteDtoListEnvelope<PSCustomObject>
...
DeliveryNoteDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDeliveryNoteDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeliveryNoteDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeliveryNoteDtoListEnvelope
