...
```powershell
$SupportRequestAttachmentDtoEnvelope = Initialize-PSOpenAPIToolsSupportRequestAttachmentDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$SupportRequestAttachmentDtoEnvelope | ConvertTo-JSON
```
