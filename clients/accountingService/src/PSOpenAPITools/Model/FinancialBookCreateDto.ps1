...
FinancialBookCreateDto<PSCustomObject>
#>

function Initialize-FinancialBookCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FinancialBookCreateDto' | Write-Debug
...
Convert from JSON to FinancialBookCreateDto<PSCustomObject>
...
FinancialBookCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToFinancialBookCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FinancialBookCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FinancialBookCreateDto
        $AllProperties = ("id", "timestamp", "name", "description", "tenantID")
