...
TenantSegmentDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantSegmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantSegmentDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantSegmentDtoEnvelope<PSCustomObject>
...
TenantSegmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantSegmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantSegmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantSegmentDtoEnvelope
