...
OrderLineDtoEnvelope<PSCustomObject>
#>

function Initialize-OrderLineDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderLineDtoEnvelope' | Write-Debug
...
Convert from JSON to OrderLineDtoEnvelope<PSCustomObject>
...
OrderLineDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOrderLineDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderLineDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderLineDtoEnvelope
