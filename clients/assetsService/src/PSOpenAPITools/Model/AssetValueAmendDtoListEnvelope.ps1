...
AssetValueAmendDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetValueAmendDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetValueAmendDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetValueAmendDtoListEnvelope<PSCustomObject>
...
AssetValueAmendDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetValueAmendDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetValueAmendDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetValueAmendDtoListEnvelope
