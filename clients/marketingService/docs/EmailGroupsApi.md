...
[**Invoke-PatchEmailGroupAsync**](EmailGroupsApi.md#Invoke-PatchEmailGroupAsync) | **PATCH** /api/v2/MarketingService/EmailGroups/{emailgroupId} | Patch an email group
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmailGroupDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$EmailGroupDtoCollectionQueryParameters = Initialize-EmailGroupDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # EmailGroupDtoCollectionQueryParameters |  (optional)

# Get email groups count
try {
    $Result = Get-EmailGroupsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmailGroupDtoCollectionQueryParameters $EmailGroupDtoCollectionQueryParameters
} catch {
...
# Get email groups
try {
    $Result = Get-EmailGroupsODataAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -EmailGroupDtoCollectionQueryParameters $EmailGroupDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchEmailGroupAsync"></a>
# **Invoke-PatchEmailGroupAsync**
> EmptyEnvelope Invoke-PatchEmailGroupAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmailgroupId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch an email group
try {
    $Result = Invoke-PatchEmailGroupAsync -TenantId $TenantId -EmailgroupId $EmailgroupId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchEmailGroupAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
