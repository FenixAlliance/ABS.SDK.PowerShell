...
InstructorProfileDto<PSCustomObject>
#>

function Initialize-InstructorProfileDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InstructorProfileDto' | Write-Debug
...
Convert from JSON to InstructorProfileDto<PSCustomObject>
...
InstructorProfileDto<PSCustomObject>
#>
function ConvertFrom-JsonToInstructorProfileDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InstructorProfileDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InstructorProfileDto
        $AllProperties = ("id", "timestamp", "contactId", "tenantId", "type", "enrollmentId", "about", "verified", "submitted", "avatarUrl", "contact", "qualifiedName", "verificationTimestamp", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "authorized", "businessID", "contactID", "businessProfileRecordID")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "authorized"))) { #optional property not found
            $Authorized = $null
        } else {
            $Authorized = $JsonParameters.PSobject.Properties["authorized"].value
        }
