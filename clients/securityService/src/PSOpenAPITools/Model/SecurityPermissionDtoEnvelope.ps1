...
SecurityPermissionDtoEnvelope<PSCustomObject>
#>

function Initialize-SecurityPermissionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityPermissionDtoEnvelope' | Write-Debug
...
Convert from JSON to SecurityPermissionDtoEnvelope<PSCustomObject>
...
SecurityPermissionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityPermissionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityPermissionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityPermissionDtoEnvelope
