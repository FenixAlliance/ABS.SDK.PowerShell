...
TaxClassDtoEnvelope<PSCustomObject>
#>

function Initialize-TaxClassDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaxClassDtoEnvelope' | Write-Debug
...
Convert from JSON to TaxClassDtoEnvelope<PSCustomObject>
...
TaxClassDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTaxClassDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaxClassDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaxClassDtoEnvelope
