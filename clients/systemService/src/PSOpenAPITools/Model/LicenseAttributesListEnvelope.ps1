...
LicenseAttributesListEnvelope<PSCustomObject>
#>

function Initialize-LicenseAttributesListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseAttributesListEnvelope' | Write-Debug
...
Convert from JSON to LicenseAttributesListEnvelope<PSCustomObject>
...
LicenseAttributesListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseAttributesListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseAttributesListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseAttributesListEnvelope
