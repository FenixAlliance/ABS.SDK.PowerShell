...
ExtendedTenantEnrollmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-ExtendedTenantEnrollmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to ExtendedTenantEnrollmentDtoListEnvelope<PSCustomObject>
...
ExtendedTenantEnrollmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExtendedTenantEnrollmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExtendedTenantEnrollmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendedTenantEnrollmentDtoListEnvelope
