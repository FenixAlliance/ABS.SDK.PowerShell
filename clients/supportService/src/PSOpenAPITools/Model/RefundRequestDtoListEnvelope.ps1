...
RefundRequestDtoListEnvelope<PSCustomObject>
#>

function Initialize-RefundRequestDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RefundRequestDtoListEnvelope' | Write-Debug
...
Convert from JSON to RefundRequestDtoListEnvelope<PSCustomObject>
...
RefundRequestDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRefundRequestDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RefundRequestDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RefundRequestDtoListEnvelope
