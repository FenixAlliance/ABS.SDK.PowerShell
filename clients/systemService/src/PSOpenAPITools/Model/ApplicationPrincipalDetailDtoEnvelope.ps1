...
ApplicationPrincipalDetailDtoEnvelope<PSCustomObject>
#>

function Initialize-ApplicationPrincipalDetailDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationPrincipalDetailDtoEnvelope' | Write-Debug
...
Convert from JSON to ApplicationPrincipalDetailDtoEnvelope<PSCustomObject>
...
ApplicationPrincipalDetailDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationPrincipalDetailDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationPrincipalDetailDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationPrincipalDetailDtoEnvelope
