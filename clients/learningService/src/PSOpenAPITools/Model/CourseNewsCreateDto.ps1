...
CourseNewsCreateDto<PSCustomObject>
#>

function Initialize-CourseNewsCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CourseNewsCreateDto' | Write-Debug
...
Convert from JSON to CourseNewsCreateDto<PSCustomObject>
...
CourseNewsCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToCourseNewsCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CourseNewsCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CourseNewsCreateDto
        $AllProperties = ("id", "timestamp", "title", "description", "content", "courseID", "businessID")
