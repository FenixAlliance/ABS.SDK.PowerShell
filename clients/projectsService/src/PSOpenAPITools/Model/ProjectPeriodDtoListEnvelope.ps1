...
ProjectPeriodDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProjectPeriodDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectPeriodDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProjectPeriodDtoListEnvelope<PSCustomObject>
...
ProjectPeriodDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectPeriodDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectPeriodDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectPeriodDtoListEnvelope
