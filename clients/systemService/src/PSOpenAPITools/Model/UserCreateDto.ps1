...
UserCreateDto<PSCustomObject>
#>

function Initialize-UserCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserCreateDto' | Write-Debug
...
Convert from JSON to UserCreateDto<PSCustomObject>
...
UserCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToUserCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserCreateDto
