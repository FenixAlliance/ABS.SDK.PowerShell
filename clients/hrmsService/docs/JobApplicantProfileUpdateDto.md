...
```powershell
$JobApplicantProfileUpdateDto = Initialize-PSOpenAPIToolsJobApplicantProfileUpdateDto  -Type null `
 -ContactId null `
 -About null `
 -AvatarUrl null `
 -VarData null `
...
```powershell
$JobApplicantProfileUpdateDto | ConvertTo-JSON
```
