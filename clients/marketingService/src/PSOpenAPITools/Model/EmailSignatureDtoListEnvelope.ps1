...
EmailSignatureDtoListEnvelope<PSCustomObject>
#>

function Initialize-EmailSignatureDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailSignatureDtoListEnvelope' | Write-Debug
...
Convert from JSON to EmailSignatureDtoListEnvelope<PSCustomObject>
...
EmailSignatureDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailSignatureDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailSignatureDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailSignatureDtoListEnvelope
