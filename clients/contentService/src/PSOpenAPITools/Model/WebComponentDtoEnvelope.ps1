...
WebComponentDtoEnvelope<PSCustomObject>
#>

function Initialize-WebComponentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebComponentDtoEnvelope' | Write-Debug
...
Convert from JSON to WebComponentDtoEnvelope<PSCustomObject>
...
WebComponentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebComponentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebComponentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebComponentDtoEnvelope
