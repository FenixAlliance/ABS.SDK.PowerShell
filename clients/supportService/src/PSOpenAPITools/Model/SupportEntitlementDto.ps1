...
function Initialize-SupportEntitlementDto {
    ...
    Param (
        ...
        [ValidateSet("Active", "GracePeriod", "Disabled", "Deleted")]
        [String]
        ${Status},
