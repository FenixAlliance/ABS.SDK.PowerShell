...
[**Invoke-PatchItemReviewAsync**](ItemReviewsApi.md#Invoke-PatchItemReviewAsync) | **PATCH** /api/v2/CatalogService/ItemReviews/{itemReviewId} | Patch an item review
...
# Get item review by ID
try {
    $Result = Get-ItemReviewByIdAsync -ItemReviewId $ItemReviewId -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion
} catch {
...
# Get all item reviews
try {
    $Result = Get-ItemReviewsAsync -ItemId $ItemId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemReviewDtoCollectionQueryParameters $ItemReviewDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchItemReviewAsync"></a>
# **Invoke-PatchItemReviewAsync**
> void Invoke-PatchItemReviewAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ItemReviewId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch an item review
try {
    $Result = Invoke-PatchItemReviewAsync -TenantId $TenantId -ItemReviewId $ItemReviewId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchItemReviewAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
