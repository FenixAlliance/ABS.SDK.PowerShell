...
PortalOptionsEnvelope<PSCustomObject>
#>

function Initialize-PortalOptionsEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortalOptionsEnvelope' | Write-Debug
...
Convert from JSON to PortalOptionsEnvelope<PSCustomObject>
...
PortalOptionsEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPortalOptionsEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortalOptionsEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortalOptionsEnvelope
