...
```powershell
$ItemToCompareCartRecordDtoEnvelope = Initialize-PSOpenAPIToolsItemToCompareCartRecordDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$ItemToCompareCartRecordDtoEnvelope | ConvertTo-JSON
```
