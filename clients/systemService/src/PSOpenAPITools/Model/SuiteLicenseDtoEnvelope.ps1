...
SuiteLicenseDtoEnvelope<PSCustomObject>
#>

function Initialize-SuiteLicenseDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuiteLicenseDtoEnvelope' | Write-Debug
...
Convert from JSON to SuiteLicenseDtoEnvelope<PSCustomObject>
...
SuiteLicenseDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSuiteLicenseDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuiteLicenseDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuiteLicenseDtoEnvelope
