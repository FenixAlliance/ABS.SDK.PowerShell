...
ItemCartRecordDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemCartRecordDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemCartRecordDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemCartRecordDtoListEnvelope<PSCustomObject>
...
ItemCartRecordDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemCartRecordDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemCartRecordDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemCartRecordDtoListEnvelope
