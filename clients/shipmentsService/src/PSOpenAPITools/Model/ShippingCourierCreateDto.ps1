...
ShippingCourierCreateDto<PSCustomObject>
#>

function Initialize-ShippingCourierCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShippingCourierCreateDto' | Write-Debug
...
Convert from JSON to ShippingCourierCreateDto<PSCustomObject>
...
ShippingCourierCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToShippingCourierCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShippingCourierCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShippingCourierCreateDto
        $AllProperties = ("id", "timestamp", "name", "logoURL", "countryID", "businessProfileRecordID")
