...
LeaveTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-LeaveTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LeaveTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to LeaveTypeDtoEnvelope<PSCustomObject>
...
LeaveTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLeaveTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LeaveTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LeaveTypeDtoEnvelope
