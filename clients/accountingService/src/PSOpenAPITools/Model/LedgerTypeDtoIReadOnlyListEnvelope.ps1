...
LedgerTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-LedgerTypeDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LedgerTypeDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to LedgerTypeDtoIReadOnlyListEnvelope<PSCustomObject>
...
LedgerTypeDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLedgerTypeDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LedgerTypeDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LedgerTypeDtoIReadOnlyListEnvelope
