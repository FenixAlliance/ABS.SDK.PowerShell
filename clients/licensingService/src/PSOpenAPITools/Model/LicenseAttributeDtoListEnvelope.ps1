...
LicenseAttributeDtoListEnvelope<PSCustomObject>
#>

function Initialize-LicenseAttributeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicenseAttributeDtoListEnvelope' | Write-Debug
...
Convert from JSON to LicenseAttributeDtoListEnvelope<PSCustomObject>
...
LicenseAttributeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLicenseAttributeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicenseAttributeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicenseAttributeDtoListEnvelope
