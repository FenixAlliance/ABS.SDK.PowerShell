...
CommissionDtoEnvelope<PSCustomObject>
#>

function Initialize-CommissionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CommissionDtoEnvelope' | Write-Debug
...
Convert from JSON to CommissionDtoEnvelope<PSCustomObject>
...
CommissionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCommissionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CommissionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CommissionDtoEnvelope
