...
BankGuaranteeDtoEnvelope<PSCustomObject>
#>

function Initialize-BankGuaranteeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankGuaranteeDtoEnvelope' | Write-Debug
...
Convert from JSON to BankGuaranteeDtoEnvelope<PSCustomObject>
...
BankGuaranteeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankGuaranteeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankGuaranteeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankGuaranteeDtoEnvelope
