...
SigningProfileUpdateDto<PSCustomObject>
#>

function Initialize-SigningProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningProfileUpdateDto' | Write-Debug
...
Convert from JSON to SigningProfileUpdateDto<PSCustomObject>
...
SigningProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSigningProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
