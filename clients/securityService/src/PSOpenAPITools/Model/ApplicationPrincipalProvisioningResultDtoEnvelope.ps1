...
ApplicationPrincipalProvisioningResultDtoEnvelope<PSCustomObject>
#>

function Initialize-ApplicationPrincipalProvisioningResultDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationPrincipalProvisioningResultDtoEnvelope' | Write-Debug
...
Convert from JSON to ApplicationPrincipalProvisioningResultDtoEnvelope<PSCustomObject>
...
ApplicationPrincipalProvisioningResultDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationPrincipalProvisioningResultDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationPrincipalProvisioningResultDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationPrincipalProvisioningResultDtoEnvelope
