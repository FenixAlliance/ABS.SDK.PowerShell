...
LocationDtoEnvelope<PSCustomObject>
#>

function Initialize-LocationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationDtoEnvelope' | Write-Debug
...
Convert from JSON to LocationDtoEnvelope<PSCustomObject>
...
LocationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLocationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationDtoEnvelope
