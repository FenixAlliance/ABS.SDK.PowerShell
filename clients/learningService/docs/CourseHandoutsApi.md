...
# Get all course handouts
try {
    $Result = Get-CourseHandoutsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseHandoutDtoCollectionQueryParameters $CourseHandoutDtoCollectionQueryParameters
} catch {
...
# Get course handouts count
try {
    $Result = Get-CourseHandoutsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -CourseHandoutDtoCollectionQueryParameters $CourseHandoutDtoCollectionQueryParameters
} catch {
...
# Patch a course handout
try {
    $Result = Invoke-PatchCourseHandoutAsync -TenantId $TenantId -HandoutId $HandoutId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
