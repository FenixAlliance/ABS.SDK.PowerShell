...
JobFieldDtoListEnvelope<PSCustomObject>
#>

function Initialize-JobFieldDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobFieldDtoListEnvelope' | Write-Debug
...
Convert from JSON to JobFieldDtoListEnvelope<PSCustomObject>
...
JobFieldDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobFieldDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobFieldDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobFieldDtoListEnvelope
