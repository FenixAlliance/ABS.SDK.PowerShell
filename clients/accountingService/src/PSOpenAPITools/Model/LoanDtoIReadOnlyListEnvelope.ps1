...
LoanDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-LoanDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to LoanDtoIReadOnlyListEnvelope<PSCustomObject>
...
LoanDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoanDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanDtoIReadOnlyListEnvelope
