...
SocialPostReactionDtoEnvelope<PSCustomObject>
#>

function Initialize-SocialPostReactionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostReactionDtoEnvelope' | Write-Debug
...
Convert from JSON to SocialPostReactionDtoEnvelope<PSCustomObject>
...
SocialPostReactionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostReactionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostReactionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostReactionDtoEnvelope
