...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ItemRetainSampleDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$ItemRetainSampleDtoCollectionQueryParameters = Initialize-ItemRetainSampleDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # ItemRetainSampleDtoCollectionQueryParameters |  (optional)

# Get all item retain samples
try {
    $Result = Get-ItemRetainSamplesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRetainSampleDtoCollectionQueryParameters $ItemRetainSampleDtoCollectionQueryParameters
} catch {
...
# Get item retain samples count
try {
    $Result = Get-ItemRetainSamplesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -ItemRetainSampleDtoCollectionQueryParameters $ItemRetainSampleDtoCollectionQueryParameters
} catch {
...
# Patch an item retain sample
try {
    $Result = Invoke-PatchItemRetainSampleAsync -TenantId $TenantId -RetainSampleId $RetainSampleId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
