...
CognitiveAgentDtoListEnvelope<PSCustomObject>
#>

function Initialize-CognitiveAgentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CognitiveAgentDtoListEnvelope' | Write-Debug
...
Convert from JSON to CognitiveAgentDtoListEnvelope<PSCustomObject>
...
CognitiveAgentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCognitiveAgentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CognitiveAgentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CognitiveAgentDtoListEnvelope
