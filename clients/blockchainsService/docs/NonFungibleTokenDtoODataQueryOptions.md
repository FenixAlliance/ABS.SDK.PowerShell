...
**IfMatch** | [**NonFungibleTokenDtoETag**](NonFungibleTokenDtoETag.md) |  | [optional] 
**IfNoneMatch** | [**NonFungibleTokenDtoETag**](NonFungibleTokenDtoETag.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$NonFungibleTokenDtoODataQueryOptions = Initialize-PSOpenAPIToolsNonFungibleTokenDtoODataQueryOptions  -Request null `
 -Context null `
 -RawValues null `
 -SelectExpand null `
 -Apply null `
...
```powershell
$NonFungibleTokenDtoODataQueryOptions | ConvertTo-JSON
```
