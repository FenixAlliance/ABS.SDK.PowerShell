...
AccountGroupDtoEnvelope<PSCustomObject>
#>

function Initialize-AccountGroupDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountGroupDtoEnvelope' | Write-Debug
...
Convert from JSON to AccountGroupDtoEnvelope<PSCustomObject>
...
AccountGroupDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountGroupDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountGroupDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountGroupDtoEnvelope
