...
AccountRelationDtoListEnvelope<PSCustomObject>
#>

function Initialize-AccountRelationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountRelationDtoListEnvelope' | Write-Debug
...
Convert from JSON to AccountRelationDtoListEnvelope<PSCustomObject>
...
AccountRelationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAccountRelationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountRelationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountRelationDtoListEnvelope
