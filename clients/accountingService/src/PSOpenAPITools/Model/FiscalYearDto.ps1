...
FiscalYearDto<PSCustomObject>
#>

function Initialize-FiscalYearDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalYearDto' | Write-Debug
...
Convert from JSON to FiscalYearDto<PSCustomObject>
...
FiscalYearDto<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalYearDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalYearDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalYearDto
        $AllProperties = ("id", "timestamp", "name", "description", "default", "tenantId", "enrollmentId", "fiscalAuthorityId", "endDate", "startDate")
