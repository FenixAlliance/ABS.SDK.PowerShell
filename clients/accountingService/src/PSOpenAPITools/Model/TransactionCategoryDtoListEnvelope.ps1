...
TransactionCategoryDtoListEnvelope<PSCustomObject>
#>

function Initialize-TransactionCategoryDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TransactionCategoryDtoListEnvelope' | Write-Debug
...
Convert from JSON to TransactionCategoryDtoListEnvelope<PSCustomObject>
...
TransactionCategoryDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTransactionCategoryDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TransactionCategoryDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TransactionCategoryDtoListEnvelope
