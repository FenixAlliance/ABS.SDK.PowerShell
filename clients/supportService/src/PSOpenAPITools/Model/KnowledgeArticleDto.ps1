...
function ConvertFrom-JsonToKnowledgeArticleDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "title", "slug", "excerpt", "description", "content", "highlightImage", "seoTitle", "seoKeyWords", "metaDescription", "published", "enable", "releaseDateTime", "lastModification", "tenantId", "enrollmentId")
