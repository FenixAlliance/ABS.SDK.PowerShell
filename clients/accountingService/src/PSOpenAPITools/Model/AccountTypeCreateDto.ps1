...
AccountTypeCreateDto<PSCustomObject>
#>

function Initialize-AccountTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountTypeCreateDto' | Write-Debug
...
Convert from JSON to AccountTypeCreateDto<PSCustomObject>
...
AccountTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToAccountTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountTypeCreateDto
        $AllProperties = ("id", "timestamp", "name", "description", "tenantId", "enrollmentId")
