...
ItemRefundPolicyDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemRefundPolicyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRefundPolicyDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemRefundPolicyDtoListEnvelope<PSCustomObject>
...
ItemRefundPolicyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemRefundPolicyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRefundPolicyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRefundPolicyDtoListEnvelope
