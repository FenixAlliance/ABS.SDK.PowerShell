...
ExecutionContextEnvelope<PSCustomObject>
#>

function Initialize-ExecutionContextEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExecutionContextEnvelope' | Write-Debug
...
Convert from JSON to ExecutionContextEnvelope<PSCustomObject>
...
ExecutionContextEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToExecutionContextEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExecutionContextEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExecutionContextEnvelope
