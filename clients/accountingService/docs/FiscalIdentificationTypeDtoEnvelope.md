...
```powershell
$FiscalIdentificationTypeDtoEnvelope = Initialize-PSOpenAPIToolsFiscalIdentificationTypeDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$FiscalIdentificationTypeDtoEnvelope | ConvertTo-JSON
```
