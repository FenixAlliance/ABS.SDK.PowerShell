...
function Initialize-InvoiceCreateDto {
    ...
    Process {
        ...
        $PSO = [PSCustomObject]@{
            ...
            "invoiceItemRecords" = ${InvoiceItemRecords}
...
function ConvertFrom-JsonToInvoiceCreateDto {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "invoiceItemRecords"))) { #optional property not found
            $InvoiceItemRecords = $null
        } else {
            $InvoiceItemRecords = $JsonParameters.PSobject.Properties["invoiceItemRecords"].value
        }
