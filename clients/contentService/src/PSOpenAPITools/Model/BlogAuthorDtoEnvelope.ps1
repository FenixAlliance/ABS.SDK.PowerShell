...
BlogAuthorDtoEnvelope<PSCustomObject>
#>

function Initialize-BlogAuthorDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogAuthorDtoEnvelope' | Write-Debug
...
Convert from JSON to BlogAuthorDtoEnvelope<PSCustomObject>
...
BlogAuthorDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogAuthorDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogAuthorDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogAuthorDtoEnvelope
