...
```powershell
$InvoiceEnumerationRangeDtoListEnvelope = Initialize-PSOpenAPIToolsInvoiceEnumerationRangeDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$InvoiceEnumerationRangeDtoListEnvelope | ConvertTo-JSON
```
