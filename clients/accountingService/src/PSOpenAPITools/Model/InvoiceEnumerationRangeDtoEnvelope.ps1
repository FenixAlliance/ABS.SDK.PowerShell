...
InvoiceEnumerationRangeDtoEnvelope<PSCustomObject>
#>

function Initialize-InvoiceEnumerationRangeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceEnumerationRangeDtoEnvelope' | Write-Debug
...
Convert from JSON to InvoiceEnumerationRangeDtoEnvelope<PSCustomObject>
...
InvoiceEnumerationRangeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceEnumerationRangeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceEnumerationRangeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceEnumerationRangeDtoEnvelope
