...
LoanApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-LoanApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoanApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to LoanApplicationDtoEnvelope<PSCustomObject>
...
LoanApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoanApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoanApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoanApplicationDtoEnvelope
