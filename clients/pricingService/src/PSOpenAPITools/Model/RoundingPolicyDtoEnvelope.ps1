...
RoundingPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-RoundingPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RoundingPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to RoundingPolicyDtoEnvelope<PSCustomObject>
...
RoundingPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRoundingPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RoundingPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoundingPolicyDtoEnvelope
