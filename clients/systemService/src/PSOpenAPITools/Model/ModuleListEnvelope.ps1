...
ModuleListEnvelope<PSCustomObject>
#>

function Initialize-ModuleListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModuleListEnvelope' | Write-Debug
...
Convert from JSON to ModuleListEnvelope<PSCustomObject>
...
ModuleListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToModuleListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModuleListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModuleListEnvelope
