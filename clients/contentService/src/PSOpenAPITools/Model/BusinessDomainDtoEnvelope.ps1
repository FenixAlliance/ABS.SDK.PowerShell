...
BusinessDomainDtoEnvelope<PSCustomObject>
#>

function Initialize-BusinessDomainDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessDomainDtoEnvelope' | Write-Debug
...
Convert from JSON to BusinessDomainDtoEnvelope<PSCustomObject>
...
BusinessDomainDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessDomainDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessDomainDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessDomainDtoEnvelope
