...
InvoiceItemRecordDto<PSCustomObject>
#>

function Initialize-InvoiceItemRecordDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceItemRecordDto' | Write-Debug
...
Convert from JSON to InvoiceItemRecordDto<PSCustomObject>
...
InvoiceItemRecordDto<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceItemRecordDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceItemRecordDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceItemRecordDto
