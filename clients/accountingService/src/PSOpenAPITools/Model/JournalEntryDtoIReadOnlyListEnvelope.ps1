...
JournalEntryDtoIReadOnlyListEnvelope<PSCustomObject>
#>

function Initialize-JournalEntryDtoIReadOnlyListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JournalEntryDtoIReadOnlyListEnvelope' | Write-Debug
...
Convert from JSON to JournalEntryDtoIReadOnlyListEnvelope<PSCustomObject>
...
JournalEntryDtoIReadOnlyListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJournalEntryDtoIReadOnlyListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JournalEntryDtoIReadOnlyListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JournalEntryDtoIReadOnlyListEnvelope
