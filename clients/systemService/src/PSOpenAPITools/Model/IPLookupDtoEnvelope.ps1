...
IPLookupDtoEnvelope<PSCustomObject>
#>

function Initialize-IPLookupDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IPLookupDtoEnvelope' | Write-Debug
...
Convert from JSON to IPLookupDtoEnvelope<PSCustomObject>
...
IPLookupDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToIPLookupDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IPLookupDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IPLookupDtoEnvelope
