...
MarketingListDto<PSCustomObject>
#>

function Initialize-MarketingListDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MarketingListDto' | Write-Debug
...
Convert from JSON to MarketingListDto<PSCustomObject>
...
MarketingListDto<PSCustomObject>
#>
function ConvertFrom-JsonToMarketingListDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MarketingListDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MarketingListDto
