...
OAuthApplicationDtoListEnvelope<PSCustomObject>
#>

function Initialize-OAuthApplicationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OAuthApplicationDtoListEnvelope' | Write-Debug
...
Convert from JSON to OAuthApplicationDtoListEnvelope<PSCustomObject>
...
OAuthApplicationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToOAuthApplicationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OAuthApplicationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OAuthApplicationDtoListEnvelope
