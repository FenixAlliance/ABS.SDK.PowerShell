...
SocialPostDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialPostDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialPostDtoListEnvelope<PSCustomObject>
...
SocialPostDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostDtoListEnvelope
