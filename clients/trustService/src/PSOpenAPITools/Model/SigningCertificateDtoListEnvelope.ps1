...
SigningCertificateDtoListEnvelope<PSCustomObject>
#>

function Initialize-SigningCertificateDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningCertificateDtoListEnvelope' | Write-Debug
...
Convert from JSON to SigningCertificateDtoListEnvelope<PSCustomObject>
...
SigningCertificateDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSigningCertificateDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningCertificateDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningCertificateDtoListEnvelope
