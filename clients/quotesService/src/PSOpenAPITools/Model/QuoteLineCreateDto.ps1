...
QuoteLineCreateDto<PSCustomObject>
#>

function Initialize-QuoteLineCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuoteLineCreateDto' | Write-Debug
...
Convert from JSON to QuoteLineCreateDto<PSCustomObject>
...
QuoteLineCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToQuoteLineCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuoteLineCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuoteLineCreateDto
