...
AssetCategoryDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetCategoryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetCategoryDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetCategoryDtoEnvelope<PSCustomObject>
...
AssetCategoryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetCategoryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetCategoryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetCategoryDtoEnvelope
