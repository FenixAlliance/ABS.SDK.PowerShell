...
SigningProfileCreateDto<PSCustomObject>
#>

function Initialize-SigningProfileCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningProfileCreateDto' | Write-Debug
...
Convert from JSON to SigningProfileCreateDto<PSCustomObject>
...
SigningProfileCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSigningProfileCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
