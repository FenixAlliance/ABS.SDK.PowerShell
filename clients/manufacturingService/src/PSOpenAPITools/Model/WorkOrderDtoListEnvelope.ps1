...
WorkOrderDtoListEnvelope<PSCustomObject>
#>

function Initialize-WorkOrderDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WorkOrderDtoListEnvelope' | Write-Debug
...
Convert from JSON to WorkOrderDtoListEnvelope<PSCustomObject>
...
WorkOrderDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWorkOrderDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WorkOrderDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkOrderDtoListEnvelope
