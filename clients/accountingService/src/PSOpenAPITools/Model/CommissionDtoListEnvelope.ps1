...
CommissionDtoListEnvelope<PSCustomObject>
#>

function Initialize-CommissionDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CommissionDtoListEnvelope' | Write-Debug
...
Convert from JSON to CommissionDtoListEnvelope<PSCustomObject>
...
CommissionDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCommissionDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CommissionDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CommissionDtoListEnvelope
