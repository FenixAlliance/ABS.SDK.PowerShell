...
Int32Envelope
#>
function Get-PriceListPricesCountAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-PriceListPricesCountAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
EmptyEnvelope
#>
function Invoke-PatchPriceListAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-PatchPriceListAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/PricingService/PriceLists/{priceListId}'
        if (!$PriceListId) {
            throw "Error! The required parameter `PriceListId` missing when calling patchPriceListAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{priceListId}', [System.Web.HTTPUtility]::UrlEncode($PriceListId))

        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling patchPriceListAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
...
EmptyEnvelope
#>
function Invoke-PatchPriceListPriceAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-PatchPriceListPriceAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/PricingService/PriceLists/{priceListId}/Prices/{priceId}'
        if (!$PriceListId) {
            throw "Error! The required parameter `PriceListId` missing when calling patchPriceListPriceAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{priceListId}', [System.Web.HTTPUtility]::UrlEncode($PriceListId))
        if (!$PriceId) {
            throw "Error! The required parameter `PriceId` missing when calling patchPriceListPriceAsync."
        }
        $LocalVarUri = $LocalVarUri.replace('{priceId}', [System.Web.HTTPUtility]::UrlEncode($PriceId))

        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling patchPriceListPriceAsync."
        }
        $LocalVarQueryParameters['tenantId'] = $TenantId
