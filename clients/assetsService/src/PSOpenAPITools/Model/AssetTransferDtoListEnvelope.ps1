...
AssetTransferDtoListEnvelope<PSCustomObject>
#>

function Initialize-AssetTransferDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetTransferDtoListEnvelope' | Write-Debug
...
Convert from JSON to AssetTransferDtoListEnvelope<PSCustomObject>
...
AssetTransferDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetTransferDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetTransferDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetTransferDtoListEnvelope
