...
BlobEnvelope<PSCustomObject>
#>

function Initialize-BlobEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlobEnvelope' | Write-Debug
...
Convert from JSON to BlobEnvelope<PSCustomObject>
...
BlobEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlobEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlobEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlobEnvelope
