...
WorkOrderTypeCreateDto<PSCustomObject>
#>

function Initialize-WorkOrderTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WorkOrderTypeCreateDto' | Write-Debug
...
Convert from JSON to WorkOrderTypeCreateDto<PSCustomObject>
...
WorkOrderTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWorkOrderTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WorkOrderTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkOrderTypeCreateDto
