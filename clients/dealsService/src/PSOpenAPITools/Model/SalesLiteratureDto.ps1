...
SalesLiteratureDto<PSCustomObject>
#>

function Initialize-SalesLiteratureDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SalesLiteratureDto' | Write-Debug
...
Convert from JSON to SalesLiteratureDto<PSCustomObject>
...
SalesLiteratureDto<PSCustomObject>
#>
function ConvertFrom-JsonToSalesLiteratureDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SalesLiteratureDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SalesLiteratureDto
