...
# Patch an invoice enumeration range
try {
    $Result = Invoke-PatchFiscalEnumerationRangeAsync -TenantId $TenantId -EnumerationRangeId $EnumerationRangeId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
