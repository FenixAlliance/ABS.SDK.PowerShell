...
WebPageTagUpdateDto<PSCustomObject>
#>

function Initialize-WebPageTagUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageTagUpdateDto' | Write-Debug
...
Convert from JSON to WebPageTagUpdateDto<PSCustomObject>
...
WebPageTagUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageTagUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageTagUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageTagUpdateDto
