...
CostCentreDtoListEnvelope<PSCustomObject>
#>

function Initialize-CostCentreDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreDtoListEnvelope' | Write-Debug
...
Convert from JSON to CostCentreDtoListEnvelope<PSCustomObject>
...
CostCentreDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreDtoListEnvelope
