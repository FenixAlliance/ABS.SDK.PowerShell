...
MenuContextDtoEnvelope<PSCustomObject>
#>

function Initialize-MenuContextDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MenuContextDtoEnvelope' | Write-Debug
...
Convert from JSON to MenuContextDtoEnvelope<PSCustomObject>
...
MenuContextDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMenuContextDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MenuContextDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MenuContextDtoEnvelope
