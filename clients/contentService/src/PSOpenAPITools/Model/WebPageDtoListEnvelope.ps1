...
WebPageDtoListEnvelope<PSCustomObject>
#>

function Initialize-WebPageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageDtoListEnvelope' | Write-Debug
...
Convert from JSON to WebPageDtoListEnvelope<PSCustomObject>
...
WebPageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageDtoListEnvelope
