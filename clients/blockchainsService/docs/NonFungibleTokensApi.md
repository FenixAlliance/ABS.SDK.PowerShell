...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NonFungibleTokenDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$NonFungibleTokenDtoCollectionQueryParameters = Initialize-NonFungibleTokenDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # NonFungibleTokenDtoCollectionQueryParameters |  (optional)

# Get all non-fungible tokens
try {
    $Result = Get-NonFungibleTokensAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -NonFungibleTokenDtoCollectionQueryParameters $NonFungibleTokenDtoCollectionQueryParameters
} catch {
...
# Get NFTs count
try {
    $Result = Get-NonFungibleTokensCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -NonFungibleTokenDtoCollectionQueryParameters $NonFungibleTokenDtoCollectionQueryParameters
} catch {
...
# Patch a non-fungible token
try {
    $Result = Invoke-PatchNonFungibleTokenAsync -TenantId $TenantId -Id $Id -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
