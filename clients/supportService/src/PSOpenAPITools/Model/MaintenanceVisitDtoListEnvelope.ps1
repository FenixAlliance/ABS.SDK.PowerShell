...
MaintenanceVisitDtoListEnvelope<PSCustomObject>
#>

function Initialize-MaintenanceVisitDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MaintenanceVisitDtoListEnvelope' | Write-Debug
...
Convert from JSON to MaintenanceVisitDtoListEnvelope<PSCustomObject>
...
MaintenanceVisitDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToMaintenanceVisitDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MaintenanceVisitDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MaintenanceVisitDtoListEnvelope
