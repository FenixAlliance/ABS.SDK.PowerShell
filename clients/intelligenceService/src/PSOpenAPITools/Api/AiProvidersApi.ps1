...
function Get-AiProvidersAsync {
    ...
    Process {
        'Calling method: Get-AiProvidersAsync' | Write-Debug
        ...
        $LocalVarUri = '/api/v2/IntelligenceService/AiProviders'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "AiProviderDtoListEnvelope" `
