...
IValidationFailureListEnvelope<PSCustomObject>
#>

function Initialize-IValidationFailureListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IValidationFailureListEnvelope' | Write-Debug
...
Convert from JSON to IValidationFailureListEnvelope<PSCustomObject>
...
IValidationFailureListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToIValidationFailureListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IValidationFailureListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IValidationFailureListEnvelope
