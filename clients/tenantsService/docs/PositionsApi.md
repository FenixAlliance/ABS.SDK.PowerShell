...
# Patch a tenant position
try {
    $Result = Invoke-PatchTenantPosition -TenantId $TenantId -TenantPositionId $TenantPositionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
