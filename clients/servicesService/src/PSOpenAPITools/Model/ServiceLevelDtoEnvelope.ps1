...
ServiceLevelDtoEnvelope<PSCustomObject>
#>

function Initialize-ServiceLevelDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceLevelDtoEnvelope' | Write-Debug
...
Convert from JSON to ServiceLevelDtoEnvelope<PSCustomObject>
...
ServiceLevelDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToServiceLevelDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceLevelDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceLevelDtoEnvelope
