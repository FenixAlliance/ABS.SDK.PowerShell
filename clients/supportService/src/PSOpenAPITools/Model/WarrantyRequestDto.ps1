...
function ConvertFrom-JsonToWarrantyRequestDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "businessProfileRecordId", "supportEntitlementId", "contactId", "accountHolderId", "warrantyPolicyId")
