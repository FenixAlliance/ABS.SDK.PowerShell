...
WorkstationDtoListEnvelope<PSCustomObject>
#>

function Initialize-WorkstationDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WorkstationDtoListEnvelope' | Write-Debug
...
Convert from JSON to WorkstationDtoListEnvelope<PSCustomObject>
...
WorkstationDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWorkstationDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WorkstationDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkstationDtoListEnvelope
