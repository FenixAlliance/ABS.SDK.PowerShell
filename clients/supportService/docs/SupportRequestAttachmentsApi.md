...
[**Invoke-PatchSupportRequestAttachmentAsync**](SupportRequestAttachmentsApi.md#Invoke-PatchSupportRequestAttachmentAsync) | **PATCH** /api/v2/SupportService/SupportRequestAttachments/{supportRequestAttachmentId} | Patch a support request attachment
...
# Retrieve a list of support request attachments
try {
    $Result = Get-SupportRequestAttachmentsAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SupportRequestAttachmentDtoCollectionQueryParameters $SupportRequestAttachmentDtoCollectionQueryParameters
} catch {
...
# Get the count of support request attachments
try {
    $Result = Get-SupportRequestAttachmentsCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SupportRequestAttachmentDtoCollectionQueryParameters $SupportRequestAttachmentDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchSupportRequestAttachmentAsync"></a>
# **Invoke-PatchSupportRequestAttachmentAsync**
> EmptyEnvelope Invoke-PatchSupportRequestAttachmentAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SupportRequestAttachmentId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a support request attachment
try {
    $Result = Invoke-PatchSupportRequestAttachmentAsync -TenantId $TenantId -SupportRequestAttachmentId $SupportRequestAttachmentId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchSupportRequestAttachmentAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
