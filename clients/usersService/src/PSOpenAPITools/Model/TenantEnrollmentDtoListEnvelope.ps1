...
TenantEnrollmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-TenantEnrollmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantEnrollmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to TenantEnrollmentDtoListEnvelope<PSCustomObject>
...
TenantEnrollmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantEnrollmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantEnrollmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantEnrollmentDtoListEnvelope
