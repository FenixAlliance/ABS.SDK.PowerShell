...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-LeaveTypeDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$LeaveTypeDtoCollectionQueryParameters = Initialize-LeaveTypeDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # LeaveTypeDtoCollectionQueryParameters |  (optional)

# Get leave types
try {
    $Result = Get-LeaveTypesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -LeaveTypeDtoCollectionQueryParameters $LeaveTypeDtoCollectionQueryParameters
} catch {
...
# Count leave types
try {
    $Result = Get-LeaveTypesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -LeaveTypeDtoCollectionQueryParameters $LeaveTypeDtoCollectionQueryParameters
} catch {
