...
NewsletterSubscriptionDtoEnvelope<PSCustomObject>
#>

function Initialize-NewsletterSubscriptionDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NewsletterSubscriptionDtoEnvelope' | Write-Debug
...
Convert from JSON to NewsletterSubscriptionDtoEnvelope<PSCustomObject>
...
NewsletterSubscriptionDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToNewsletterSubscriptionDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NewsletterSubscriptionDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NewsletterSubscriptionDtoEnvelope
