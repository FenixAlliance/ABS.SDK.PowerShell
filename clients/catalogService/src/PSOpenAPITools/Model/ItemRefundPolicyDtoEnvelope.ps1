...
ItemRefundPolicyDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemRefundPolicyDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemRefundPolicyDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemRefundPolicyDtoEnvelope<PSCustomObject>
...
ItemRefundPolicyDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemRefundPolicyDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemRefundPolicyDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemRefundPolicyDtoEnvelope
