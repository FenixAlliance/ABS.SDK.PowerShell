...
ProjectTimeLogDtoListEnvelope<PSCustomObject>
#>

function Initialize-ProjectTimeLogDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectTimeLogDtoListEnvelope' | Write-Debug
...
Convert from JSON to ProjectTimeLogDtoListEnvelope<PSCustomObject>
...
ProjectTimeLogDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProjectTimeLogDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectTimeLogDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectTimeLogDtoListEnvelope
