...
FiscalIdentificationTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-FiscalIdentificationTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to FiscalIdentificationTypeDtoEnvelope<PSCustomObject>
...
FiscalIdentificationTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalIdentificationTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalIdentificationTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalIdentificationTypeDtoEnvelope
