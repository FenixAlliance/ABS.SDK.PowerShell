...
function Initialize-BlogPostTagCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostTagCreateDto' | Write-Debug
...
Convert from JSON to BlogPostTagCreateDto<PSCustomObject>
...
BlogPostTagCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostTagCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostTagCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
