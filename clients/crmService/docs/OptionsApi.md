...
[**Invoke-PatchContactOptionAsync**](OptionsApi.md#Invoke-PatchContactOptionAsync) | **PATCH** /api/v2/CrmService/Contacts/{contactId}/Options/{optionId} | Patch a contact option
[**Invoke-PatchContactOptionByKeyAsync**](OptionsApi.md#Invoke-PatchContactOptionByKeyAsync) | **PATCH** /api/v2/CrmService/Contacts/{contactId}/Options/Key/{key} | Patch a contact option by key
...
# Retrieve a list of contact options
try {
    $Result = Get-ContactOptions -TenantId $TenantId -ContactId $ContactId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
# Get the count of contact options
try {
    $Result = Get-ContactOptionsCount -TenantId $TenantId -ContactId $ContactId -PortalId $PortalId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -OptionDtoCollectionQueryParameters $OptionDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchContactOptionAsync"></a>
# **Invoke-PatchContactOptionAsync**
> EmptyEnvelope Invoke-PatchContactOptionAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ContactId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OptionId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
...
# Patch a contact option
try {
    $Result = Invoke-PatchContactOptionAsync -TenantId $TenantId -ContactId $ContactId -OptionId $OptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchContactOptionAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-PatchContactOptionByKeyAsync"></a>
# **Invoke-PatchContactOptionByKeyAsync**
> EmptyEnvelope Invoke-PatchContactOptionByKeyAsync<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ContactId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Key] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
...
# Patch a contact option by key
try {
    $Result = Invoke-PatchContactOptionByKeyAsync -TenantId $TenantId -ContactId $ContactId -Key $Key -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchContactOptionByKeyAsync: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
