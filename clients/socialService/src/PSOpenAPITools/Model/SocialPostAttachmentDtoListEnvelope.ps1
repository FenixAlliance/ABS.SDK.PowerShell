...
SocialPostAttachmentDtoListEnvelope<PSCustomObject>
#>

function Initialize-SocialPostAttachmentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostAttachmentDtoListEnvelope' | Write-Debug
...
Convert from JSON to SocialPostAttachmentDtoListEnvelope<PSCustomObject>
...
SocialPostAttachmentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostAttachmentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostAttachmentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostAttachmentDtoListEnvelope
