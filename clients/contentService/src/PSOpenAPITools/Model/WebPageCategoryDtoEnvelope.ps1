...
WebPageCategoryDtoEnvelope<PSCustomObject>
#>

function Initialize-WebPageCategoryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageCategoryDtoEnvelope' | Write-Debug
...
Convert from JSON to WebPageCategoryDtoEnvelope<PSCustomObject>
...
WebPageCategoryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageCategoryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageCategoryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageCategoryDtoEnvelope
