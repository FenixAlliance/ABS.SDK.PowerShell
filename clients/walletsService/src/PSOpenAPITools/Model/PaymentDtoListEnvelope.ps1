...
PaymentDtoListEnvelope<PSCustomObject>
#>

function Initialize-PaymentDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentDtoListEnvelope' | Write-Debug
...
Convert from JSON to PaymentDtoListEnvelope<PSCustomObject>
...
PaymentDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentDtoListEnvelope
