...
UserAdminDetailDtoEnvelope<PSCustomObject>
#>

function Initialize-UserAdminDetailDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserAdminDetailDtoEnvelope' | Write-Debug
...
Convert from JSON to UserAdminDetailDtoEnvelope<PSCustomObject>
...
UserAdminDetailDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUserAdminDetailDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserAdminDetailDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserAdminDetailDtoEnvelope
