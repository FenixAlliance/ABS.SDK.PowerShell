...
```powershell
$EmployeeAppraisalSessionDtoListEnvelope = Initialize-PSOpenAPIToolsEmployeeAppraisalSessionDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$EmployeeAppraisalSessionDtoListEnvelope | ConvertTo-JSON
```
