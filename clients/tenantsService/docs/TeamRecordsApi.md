...
[**Invoke-PatchTenantTeamRecord**](TeamRecordsApi.md#Invoke-PatchTenantTeamRecord) | **PATCH** /api/v2/TenantsService/TeamRecords/{tenantTeamRecordId} | Patch a tenant team record
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantTeamRecordDtoCollectionQueryParameters] <PSCustomObject><br>
...
$ApiVersion = "MyApiVersion" # String |  (optional)
$XApiVersion = "MyXApiVersion" # String |  (optional)
$TenantTeamRecordDtoCollectionQueryParameters = Initialize-TenantTeamRecordDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # TenantTeamRecordDtoCollectionQueryParameters |  (optional)

# Retrieve a list of tenant team records
try {
    $Result = Get-TenantTeamRecords -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantTeamRecordDtoCollectionQueryParameters $TenantTeamRecordDtoCollectionQueryParameters
} catch {
...
# Get the count of tenant team records
try {
    $Result = Get-TenantTeamRecordsCount -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -TenantTeamRecordDtoCollectionQueryParameters $TenantTeamRecordDtoCollectionQueryParameters
} catch {
...
<a id="Invoke-PatchTenantTeamRecord"></a>
# **Invoke-PatchTenantTeamRecord**
> EmptyEnvelope Invoke-PatchTenantTeamRecord<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-TenantTeamRecordId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApiVersion] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-XApiVersion] <String><br>
...
# Patch a tenant team record
try {
    $Result = Invoke-PatchTenantTeamRecord -TenantId $TenantId -TenantTeamRecordId $TenantTeamRecordId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -PatchOperation $PatchOperation
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchTenantTeamRecord: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
