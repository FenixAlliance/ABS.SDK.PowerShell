...
SocialPostAttachmentDtoEnvelope<PSCustomObject>
#>

function Initialize-SocialPostAttachmentDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialPostAttachmentDtoEnvelope' | Write-Debug
...
Convert from JSON to SocialPostAttachmentDtoEnvelope<PSCustomObject>
...
SocialPostAttachmentDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSocialPostAttachmentDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialPostAttachmentDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialPostAttachmentDtoEnvelope
