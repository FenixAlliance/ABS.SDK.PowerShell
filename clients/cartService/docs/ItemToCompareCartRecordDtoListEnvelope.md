...
```powershell
$ItemToCompareCartRecordDtoListEnvelope = Initialize-PSOpenAPIToolsItemToCompareCartRecordDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$ItemToCompareCartRecordDtoListEnvelope | ConvertTo-JSON
```
