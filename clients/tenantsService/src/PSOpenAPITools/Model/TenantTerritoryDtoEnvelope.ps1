...
TenantTerritoryDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantTerritoryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantTerritoryDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantTerritoryDtoEnvelope<PSCustomObject>
...
TenantTerritoryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantTerritoryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantTerritoryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantTerritoryDtoEnvelope
