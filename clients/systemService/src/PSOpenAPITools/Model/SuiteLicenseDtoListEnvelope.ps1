...
SuiteLicenseDtoListEnvelope<PSCustomObject>
#>

function Initialize-SuiteLicenseDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuiteLicenseDtoListEnvelope' | Write-Debug
...
Convert from JSON to SuiteLicenseDtoListEnvelope<PSCustomObject>
...
SuiteLicenseDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToSuiteLicenseDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuiteLicenseDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuiteLicenseDtoListEnvelope
