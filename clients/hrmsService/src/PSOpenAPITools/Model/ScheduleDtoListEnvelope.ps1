...
ScheduleDtoListEnvelope<PSCustomObject>
#>

function Initialize-ScheduleDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ScheduleDtoListEnvelope' | Write-Debug
...
Convert from JSON to ScheduleDtoListEnvelope<PSCustomObject>
...
ScheduleDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToScheduleDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ScheduleDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ScheduleDtoListEnvelope
