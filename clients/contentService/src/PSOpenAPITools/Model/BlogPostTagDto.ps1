...
BlogPostTagDto<PSCustomObject>
#>

function Initialize-BlogPostTagDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostTagDto' | Write-Debug
...
Convert from JSON to BlogPostTagDto<PSCustomObject>
...
BlogPostTagDto<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostTagDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostTagDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostTagDto
