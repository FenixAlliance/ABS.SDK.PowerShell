...
AssetDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetDtoEnvelope<PSCustomObject>
...
AssetDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetDtoEnvelope
