...
ItemAttachmentCreateDto<PSCustomObject>
#>

function Initialize-ItemAttachmentCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttachmentCreateDto' | Write-Debug
...
Convert from JSON to ItemAttachmentCreateDto<PSCustomObject>
...
ItemAttachmentCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttachmentCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttachmentCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttachmentCreateDto
        $AllProperties = ("id", "timestamp", "notes", "title", "author", "isFolder", "fileName", "abstract", "keyWords", "validResponse", "parentFileUploadId", "filePath", "publicAccessType", "itemId")
