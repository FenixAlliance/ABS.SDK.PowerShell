...
**Result** | [**BankProfileDto[]**](BankProfileDto.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$BankProfileDtoListEnvelope = Initialize-PSOpenAPIToolsBankProfileDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$BankProfileDtoListEnvelope | ConvertTo-JSON
```
