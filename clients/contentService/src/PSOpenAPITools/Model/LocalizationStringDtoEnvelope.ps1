...
LocalizationStringDtoEnvelope<PSCustomObject>
#>

function Initialize-LocalizationStringDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalizationStringDtoEnvelope' | Write-Debug
...
Convert from JSON to LocalizationStringDtoEnvelope<PSCustomObject>
...
LocalizationStringDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLocalizationStringDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalizationStringDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalizationStringDtoEnvelope
