...
```powershell
$ServiceLevelAgreementDtoEnvelope = Initialize-PSOpenAPIToolsServiceLevelAgreementDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$ServiceLevelAgreementDtoEnvelope | ConvertTo-JSON
```
