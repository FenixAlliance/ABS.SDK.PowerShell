...
BlogPostDtoListEnvelope<PSCustomObject>
#>

function Initialize-BlogPostDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BlogPostDtoListEnvelope' | Write-Debug
...
Convert from JSON to BlogPostDtoListEnvelope<PSCustomObject>
...
BlogPostDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBlogPostDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BlogPostDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BlogPostDtoListEnvelope
