...
JobApplicantProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-JobApplicantProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobApplicantProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to JobApplicantProfileDtoListEnvelope<PSCustomObject>
...
JobApplicantProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobApplicantProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobApplicantProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobApplicantProfileDtoListEnvelope
