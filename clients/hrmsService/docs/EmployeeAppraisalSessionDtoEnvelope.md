...
```powershell
$EmployeeAppraisalSessionDtoEnvelope = Initialize-PSOpenAPIToolsEmployeeAppraisalSessionDtoEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -HttpStatus null `
...
```powershell
$EmployeeAppraisalSessionDtoEnvelope | ConvertTo-JSON
```
