...
ShiftDtoEnvelope<PSCustomObject>
#>

function Initialize-ShiftDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShiftDtoEnvelope' | Write-Debug
...
Convert from JSON to ShiftDtoEnvelope<PSCustomObject>
...
ShiftDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShiftDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShiftDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShiftDtoEnvelope
