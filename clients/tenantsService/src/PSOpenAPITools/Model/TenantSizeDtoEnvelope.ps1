...
TenantSizeDtoEnvelope<PSCustomObject>
#>

function Initialize-TenantSizeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TenantSizeDtoEnvelope' | Write-Debug
...
Convert from JSON to TenantSizeDtoEnvelope<PSCustomObject>
...
TenantSizeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTenantSizeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TenantSizeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TenantSizeDtoEnvelope
