...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SecurityCertificateDtoCollectionQueryParameters] <PSCustomObject><br>
...
$SecurityCertificateDtoCollectionQueryParameters = Initialize-SecurityCertificateDtoCollectionQueryParameters -Top 0 -Skip 0 -Count $false -VarFilter "MyVarFilter" -OrderBy "MyOrderBy" -Search "MySearch" -Select "MySelect" -Expand "MyExpand" -IsEmpty $false # SecurityCertificateDtoCollectionQueryParameters |  (optional)

# Get security certificates
try {
    $Result = Get-SecurityCertificatesAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SecurityCertificateDtoCollectionQueryParameters $SecurityCertificateDtoCollectionQueryParameters
} catch {
...
# Get security certificates count
try {
    $Result = Get-SecurityCertificatesCountAsync -TenantId $TenantId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -SecurityCertificateDtoCollectionQueryParameters $SecurityCertificateDtoCollectionQueryParameters
} catch {
