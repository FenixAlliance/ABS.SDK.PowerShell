...
ShareClassDtoEnvelope<PSCustomObject>
#>

function Initialize-ShareClassDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ShareClassDtoEnvelope' | Write-Debug
...
Convert from JSON to ShareClassDtoEnvelope<PSCustomObject>
...
ShareClassDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToShareClassDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ShareClassDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShareClassDtoEnvelope
