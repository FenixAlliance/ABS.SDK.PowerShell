...
InfinityComexIntegrationOptions<PSCustomObject>
#>

function Initialize-InfinityComexIntegrationOptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InfinityComexIntegrationOptions' | Write-Debug
...
Convert from JSON to InfinityComexIntegrationOptions<PSCustomObject>
...
InfinityComexIntegrationOptions<PSCustomObject>
#>
function ConvertFrom-JsonToInfinityComexIntegrationOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InfinityComexIntegrationOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InfinityComexIntegrationOptions
