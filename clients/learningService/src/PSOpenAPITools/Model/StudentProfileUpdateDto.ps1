...
StudentProfileUpdateDto<PSCustomObject>
#>

function Initialize-StudentProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StudentProfileUpdateDto' | Write-Debug
...
Convert from JSON to StudentProfileUpdateDto<PSCustomObject>
...
StudentProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToStudentProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StudentProfileUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StudentProfileUpdateDto
        $AllProperties = ("id", "timestamp", "about", "verified", "submitted", "avatarUrl", "qualifiedName", "verificationTimestamp", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "businessID", "contactID", "businessProfileRecordID")
