...
ItemPackingSlipEntryDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemPackingSlipEntryDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPackingSlipEntryDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemPackingSlipEntryDtoEnvelope<PSCustomObject>
...
ItemPackingSlipEntryDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPackingSlipEntryDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPackingSlipEntryDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPackingSlipEntryDtoEnvelope
