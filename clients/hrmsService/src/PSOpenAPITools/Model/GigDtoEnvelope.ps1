...
GigDtoEnvelope<PSCustomObject>
#>

function Initialize-GigDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GigDtoEnvelope' | Write-Debug
...
Convert from JSON to GigDtoEnvelope<PSCustomObject>
...
GigDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGigDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GigDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GigDtoEnvelope
