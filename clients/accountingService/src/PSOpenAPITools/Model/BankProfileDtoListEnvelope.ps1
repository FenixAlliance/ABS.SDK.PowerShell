...
BankProfileDtoListEnvelope<PSCustomObject>
#>

function Initialize-BankProfileDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankProfileDtoListEnvelope' | Write-Debug
...
Convert from JSON to BankProfileDtoListEnvelope<PSCustomObject>
...
BankProfileDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankProfileDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankProfileDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankProfileDtoListEnvelope
