...
TrainingProgramCourseDtoListEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramCourseDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramCourseDtoListEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramCourseDtoListEnvelope<PSCustomObject>
...
TrainingProgramCourseDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramCourseDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramCourseDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramCourseDtoListEnvelope
