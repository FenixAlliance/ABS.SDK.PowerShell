...
ServiceCaseDto<PSCustomObject>
#>

function Initialize-ServiceCaseDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceCaseDto' | Write-Debug
...
Convert from JSON to ServiceCaseDto<PSCustomObject>
...
ServiceCaseDto<PSCustomObject>
#>
function ConvertFrom-JsonToServiceCaseDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceCaseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServiceCaseDto
