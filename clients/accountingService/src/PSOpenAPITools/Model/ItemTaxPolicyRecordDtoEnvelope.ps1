...
ItemTaxPolicyRecordDtoEnvelope<PSCustomObject>
#>

function Initialize-ItemTaxPolicyRecordDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordDtoEnvelope' | Write-Debug
...
Convert from JSON to ItemTaxPolicyRecordDtoEnvelope<PSCustomObject>
...
ItemTaxPolicyRecordDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemTaxPolicyRecordDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemTaxPolicyRecordDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemTaxPolicyRecordDtoEnvelope
