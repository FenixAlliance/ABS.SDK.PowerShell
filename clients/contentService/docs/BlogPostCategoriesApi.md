...
# Patch a blog post category
try {
    $Result = Invoke-PatchBlogPostCategoryAsync -TenantId $TenantId -BlogPostCategoryId $BlogPostCategoryId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
