...
WorkOrderTypeDtoListEnvelope<PSCustomObject>
#>

function Initialize-WorkOrderTypeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WorkOrderTypeDtoListEnvelope' | Write-Debug
...
Convert from JSON to WorkOrderTypeDtoListEnvelope<PSCustomObject>
...
WorkOrderTypeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWorkOrderTypeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WorkOrderTypeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkOrderTypeDtoListEnvelope
