...
BusinessRelationshipDtoEnvelope<PSCustomObject>
#>

function Initialize-BusinessRelationshipDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BusinessRelationshipDtoEnvelope' | Write-Debug
...
Convert from JSON to BusinessRelationshipDtoEnvelope<PSCustomObject>
...
BusinessRelationshipDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessRelationshipDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BusinessRelationshipDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessRelationshipDtoEnvelope
