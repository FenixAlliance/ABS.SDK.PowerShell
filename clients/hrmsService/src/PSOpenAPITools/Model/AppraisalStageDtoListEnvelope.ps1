...
AppraisalStageDtoListEnvelope<PSCustomObject>
#>

function Initialize-AppraisalStageDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppraisalStageDtoListEnvelope' | Write-Debug
...
Convert from JSON to AppraisalStageDtoListEnvelope<PSCustomObject>
...
AppraisalStageDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppraisalStageDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppraisalStageDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppraisalStageDtoListEnvelope
