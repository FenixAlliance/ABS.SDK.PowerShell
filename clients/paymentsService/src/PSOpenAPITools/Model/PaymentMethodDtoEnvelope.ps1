...
PaymentMethodDtoEnvelope<PSCustomObject>
#>

function Initialize-PaymentMethodDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentMethodDtoEnvelope' | Write-Debug
...
Convert from JSON to PaymentMethodDtoEnvelope<PSCustomObject>
...
PaymentMethodDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentMethodDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentMethodDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentMethodDtoEnvelope
