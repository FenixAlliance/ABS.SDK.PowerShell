...
function Initialize-SupportTicketTypeCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportTicketTypeCreateDto' | Write-Debug
...
Convert from JSON to SupportTicketTypeCreateDto<PSCustomObject>
...
SupportTicketTypeCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSupportTicketTypeCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportTicketTypeCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
