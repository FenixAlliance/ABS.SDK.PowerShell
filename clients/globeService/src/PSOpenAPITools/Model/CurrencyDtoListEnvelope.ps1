...
CurrencyDtoListEnvelope<PSCustomObject>
#>

function Initialize-CurrencyDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CurrencyDtoListEnvelope' | Write-Debug
...
Convert from JSON to CurrencyDtoListEnvelope<PSCustomObject>
...
CurrencyDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCurrencyDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CurrencyDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CurrencyDtoListEnvelope
