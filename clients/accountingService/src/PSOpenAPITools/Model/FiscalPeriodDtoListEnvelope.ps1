...
FiscalPeriodDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalPeriodDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalPeriodDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalPeriodDtoListEnvelope<PSCustomObject>
...
FiscalPeriodDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalPeriodDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalPeriodDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalPeriodDtoListEnvelope
