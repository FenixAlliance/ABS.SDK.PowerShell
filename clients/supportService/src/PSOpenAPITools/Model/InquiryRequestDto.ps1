...
function ConvertFrom-JsonToInquiryRequestDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "timestamp", "type", "name", "lastName", "email", "organizationName", "jobRole", "organizationDomain", "countryId", "phone", "message", "tenantId", "businessProfileRecordId", "accountHolderId", "socialProfileId")
