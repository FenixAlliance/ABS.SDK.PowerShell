...
BankDtoEnvelope<PSCustomObject>
#>

function Initialize-BankDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankDtoEnvelope' | Write-Debug
...
Convert from JSON to BankDtoEnvelope<PSCustomObject>
...
BankDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankDtoEnvelope
