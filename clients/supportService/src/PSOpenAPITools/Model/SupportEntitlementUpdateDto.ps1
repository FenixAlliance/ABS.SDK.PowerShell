...
SupportEntitlementUpdateDto<PSCustomObject>
#>

function Initialize-SupportEntitlementUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SupportEntitlementUpdateDto' | Write-Debug
...
Convert from JSON to SupportEntitlementUpdateDto<PSCustomObject>
...
SupportEntitlementUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToSupportEntitlementUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SupportEntitlementUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
