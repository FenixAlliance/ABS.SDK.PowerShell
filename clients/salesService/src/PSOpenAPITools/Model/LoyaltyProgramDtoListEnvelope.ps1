...
LoyaltyProgramDtoListEnvelope<PSCustomObject>
#>

function Initialize-LoyaltyProgramDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoyaltyProgramDtoListEnvelope' | Write-Debug
...
Convert from JSON to LoyaltyProgramDtoListEnvelope<PSCustomObject>
...
LoyaltyProgramDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLoyaltyProgramDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoyaltyProgramDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoyaltyProgramDtoListEnvelope
