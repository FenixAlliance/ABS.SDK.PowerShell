...
GigApplicationDtoEnvelope<PSCustomObject>
#>

function Initialize-GigApplicationDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GigApplicationDtoEnvelope' | Write-Debug
...
Convert from JSON to GigApplicationDtoEnvelope<PSCustomObject>
...
GigApplicationDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToGigApplicationDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GigApplicationDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GigApplicationDtoEnvelope
