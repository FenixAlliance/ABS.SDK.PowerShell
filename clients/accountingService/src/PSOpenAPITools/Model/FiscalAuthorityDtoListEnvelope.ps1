...
FiscalAuthorityDtoListEnvelope<PSCustomObject>
#>

function Initialize-FiscalAuthorityDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FiscalAuthorityDtoListEnvelope' | Write-Debug
...
Convert from JSON to FiscalAuthorityDtoListEnvelope<PSCustomObject>
...
FiscalAuthorityDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToFiscalAuthorityDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FiscalAuthorityDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FiscalAuthorityDtoListEnvelope
