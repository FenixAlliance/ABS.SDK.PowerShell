...
JobFieldDtoEnvelope<PSCustomObject>
#>

function Initialize-JobFieldDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobFieldDtoEnvelope' | Write-Debug
...
Convert from JSON to JobFieldDtoEnvelope<PSCustomObject>
...
JobFieldDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJobFieldDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobFieldDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobFieldDtoEnvelope
