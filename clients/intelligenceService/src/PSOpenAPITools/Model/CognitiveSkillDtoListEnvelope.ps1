...
CognitiveSkillDtoListEnvelope<PSCustomObject>
#>

function Initialize-CognitiveSkillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CognitiveSkillDtoListEnvelope' | Write-Debug
...
Convert from JSON to CognitiveSkillDtoListEnvelope<PSCustomObject>
...
CognitiveSkillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCognitiveSkillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CognitiveSkillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CognitiveSkillDtoListEnvelope
