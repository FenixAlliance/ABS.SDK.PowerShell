...
InvoiceDtoEnvelope<PSCustomObject>
#>

function Initialize-InvoiceDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceDtoEnvelope' | Write-Debug
...
Convert from JSON to InvoiceDtoEnvelope<PSCustomObject>
...
InvoiceDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceDtoEnvelope
