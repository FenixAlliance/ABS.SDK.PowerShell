...
.PARAMETER IsActive
No description available.
.PARAMETER DefaultForDocumentType
No description available.
.OUTPUTS

SigningProfileDto<PSCustomObject>
#>

function Initialize-SigningProfileDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SigningProfileDto' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "isActive" = ${IsActive}
            "defaultForDocumentType" = ${DefaultForDocumentType}
        }
...
Convert from JSON to SigningProfileDto<PSCustomObject>
...
SigningProfileDto<PSCustomObject>
#>
function ConvertFrom-JsonToSigningProfileDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SigningProfileDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SigningProfileDto
        $AllProperties = ("id", "timestamp", "contactId", "tenantId", "type", "enrollmentId", "about", "verified", "submitted", "avatarUrl", "contact", "qualifiedName", "verificationTimestamp", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "contactName", "signatureFormat", "signaturePurpose", "digestAlgorithm", "signatureAlgorithm", "canonicalizationAlgorithm", "policyIdentifier", "policyUri", "authorityProfile", "isActive", "defaultForDocumentType")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "signaturePurpose"))) { #optional property not found
            $SignaturePurpose = $null
        } else {
            $SignaturePurpose = $JsonParameters.PSobject.Properties["signaturePurpose"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "policyUri"))) { #optional property not found
            $PolicyUri = $null
        } else {
            $PolicyUri = $JsonParameters.PSobject.Properties["policyUri"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "defaultForDocumentType"))) { #optional property not found
            $DefaultForDocumentType = $null
        } else {
            $DefaultForDocumentType = $JsonParameters.PSobject.Properties["defaultForDocumentType"].value
        }
