...
AssetTypeDtoEnvelope<PSCustomObject>
#>

function Initialize-AssetTypeDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetTypeDtoEnvelope' | Write-Debug
...
Convert from JSON to AssetTypeDtoEnvelope<PSCustomObject>
...
AssetTypeDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAssetTypeDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetTypeDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetTypeDtoEnvelope
