...
None
#>
function Invoke-ApiV2SalesServiceMarginsMarginIdDetailsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ApiV2SalesServiceMarginsMarginIdDetailsGet' | Write-Debug
        ...
        if (!$MarginId) {
            throw "Error! The required parameter `MarginId` missing when calling apiV2SalesServiceMarginsMarginIdDetailsGet."
        }
