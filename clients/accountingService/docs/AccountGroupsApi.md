...
# Patch an account group
try {
    $Result = Invoke-PatchAccountGroupAsync -TenantId $TenantId -AccountGroupId $AccountGroupId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
