...
UserDtoListEnvelope<PSCustomObject>
#>

function Initialize-UserDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserDtoListEnvelope' | Write-Debug
...
Convert from JSON to UserDtoListEnvelope<PSCustomObject>
...
UserDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToUserDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserDtoListEnvelope
