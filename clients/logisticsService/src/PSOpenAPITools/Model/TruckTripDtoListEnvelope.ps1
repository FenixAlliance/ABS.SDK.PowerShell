...
TruckTripDtoListEnvelope<PSCustomObject>
#>

function Initialize-TruckTripDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TruckTripDtoListEnvelope' | Write-Debug
...
Convert from JSON to TruckTripDtoListEnvelope<PSCustomObject>
...
TruckTripDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTruckTripDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TruckTripDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TruckTripDtoListEnvelope
