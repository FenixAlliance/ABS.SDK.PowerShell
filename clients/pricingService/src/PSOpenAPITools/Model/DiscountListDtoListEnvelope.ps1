...
DiscountListDtoListEnvelope<PSCustomObject>
#>

function Initialize-DiscountListDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DiscountListDtoListEnvelope' | Write-Debug
...
Convert from JSON to DiscountListDtoListEnvelope<PSCustomObject>
...
DiscountListDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToDiscountListDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DiscountListDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiscountListDtoListEnvelope
