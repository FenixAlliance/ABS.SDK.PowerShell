...
RailWaybillDtoListEnvelope<PSCustomObject>
#>

function Initialize-RailWaybillDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RailWaybillDtoListEnvelope' | Write-Debug
...
Convert from JSON to RailWaybillDtoListEnvelope<PSCustomObject>
...
RailWaybillDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToRailWaybillDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RailWaybillDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RailWaybillDtoListEnvelope
