...
```powershell
$SupportTicketPriorityDtoListEnvelope = Initialize-PSOpenAPIToolsSupportTicketPriorityDtoListEnvelope  -IsSuccess null `
 -ErrorMessage null `
 -CorrelationId null `
 -Timestamp null `
 -ActivityId null `
...
```powershell
$SupportTicketPriorityDtoListEnvelope | ConvertTo-JSON
```
