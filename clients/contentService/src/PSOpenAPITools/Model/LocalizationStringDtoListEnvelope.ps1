...
LocalizationStringDtoListEnvelope<PSCustomObject>
#>

function Initialize-LocalizationStringDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalizationStringDtoListEnvelope' | Write-Debug
...
Convert from JSON to LocalizationStringDtoListEnvelope<PSCustomObject>
...
LocalizationStringDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToLocalizationStringDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalizationStringDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalizationStringDtoListEnvelope
