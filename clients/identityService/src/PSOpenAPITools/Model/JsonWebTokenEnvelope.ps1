...
JsonWebTokenEnvelope<PSCustomObject>
#>

function Initialize-JsonWebTokenEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonWebTokenEnvelope' | Write-Debug
...
Convert from JSON to JsonWebTokenEnvelope<PSCustomObject>
...
JsonWebTokenEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToJsonWebTokenEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonWebTokenEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonWebTokenEnvelope
