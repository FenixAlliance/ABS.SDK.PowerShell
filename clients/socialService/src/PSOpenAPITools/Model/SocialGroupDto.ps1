...
SocialGroupDto<PSCustomObject>
#>

function Initialize-SocialGroupDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SocialGroupDto' | Write-Debug
...
Convert from JSON to SocialGroupDto<PSCustomObject>
...
SocialGroupDto<PSCustomObject>
#>
function ConvertFrom-JsonToSocialGroupDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SocialGroupDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SocialGroupDto
        $AllProperties = ("id", "timestamp", "name", "title", "avatarURL", "businessID", "businessProfileRecordID", "socialProfileID")
