...
ItemAttributeDtoListEnvelope<PSCustomObject>
#>

function Initialize-ItemAttributeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeDtoListEnvelope' | Write-Debug
...
Convert from JSON to ItemAttributeDtoListEnvelope<PSCustomObject>
...
ItemAttributeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeDtoListEnvelope
