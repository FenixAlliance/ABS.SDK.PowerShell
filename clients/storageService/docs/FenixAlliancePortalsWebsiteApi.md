# PSOpenAPITools.PSOpenAPITools\Api.FenixAlliancePortalsWebsiteApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-AccountLogoutPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-AccountLogoutPost) | **POST** /Account/Logout | 
[**Invoke-AccountManageDownloadPersonalDataPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-AccountManageDownloadPersonalDataPost) | **POST** /Account/Manage/DownloadPersonalData | 
[**Invoke-AccountManageLinkExternalLoginPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-AccountManageLinkExternalLoginPost) | **POST** /Account/Manage/LinkExternalLogin | 
[**Invoke-AccountPerformExternalLoginPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-AccountPerformExternalLoginPost) | **POST** /Account/PerformExternalLogin | 
[**Invoke-ForgotPasswordPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-ForgotPasswordPost) | **POST** /forgotPassword | 
[**Invoke-HealthGet**](FenixAlliancePortalsWebsiteApi.md#Invoke-HealthGet) | **GET** /health | 
[**Invoke-HelloGet**](FenixAlliancePortalsWebsiteApi.md#Invoke-HelloGet) | **GET** /hello | 
[**Invoke-LoginPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-LoginPost) | **POST** /login | 
[**Invoke-Manage2faPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-Manage2faPost) | **POST** /manage/2fa | 
[**Invoke-ManageInfoGet**](FenixAlliancePortalsWebsiteApi.md#Invoke-ManageInfoGet) | **GET** /manage/info | 
[**Invoke-ManageInfoPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-ManageInfoPost) | **POST** /manage/info | 
[**Invoke-MapIdentityApiConfirmEmail**](FenixAlliancePortalsWebsiteApi.md#Invoke-MapIdentityApiConfirmEmail) | **GET** /confirmEmail | 
[**Invoke-RefreshPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-RefreshPost) | **POST** /refresh | 
[**Register-Post**](FenixAlliancePortalsWebsiteApi.md#Register-Post) | **POST** /register | 
[**Invoke-ResendConfirmationEmailPost**](FenixAlliancePortalsWebsiteApi.md#Invoke-ResendConfirmationEmailPost) | **POST** /resendConfirmationEmail | 
[**Reset-PasswordPost**](FenixAlliancePortalsWebsiteApi.md#Reset-PasswordPost) | **POST** /resetPassword | 
[**Invoke-VersionGet**](FenixAlliancePortalsWebsiteApi.md#Invoke-VersionGet) | **GET** /version | 


<a id="Invoke-AccountLogoutPost"></a>
# **Invoke-AccountLogoutPost**
> void Invoke-AccountLogoutPost<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ReturnUrl] <String><br>
...
### Example
```powershell
$ReturnUrl = "MyReturnUrl" # String |  (optional)

try {
    $Result = Invoke-AccountLogoutPost -ReturnUrl $ReturnUrl
} catch {
    Write-Host ("Exception occurred when calling Invoke-AccountLogoutPost: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Invoke-AccountManageDownloadPersonalDataPost"></a>
# **Invoke-AccountManageDownloadPersonalDataPost**
> void Invoke-AccountManageDownloadPersonalDataPost<br>
...
try {
    $Result = Invoke-AccountManageDownloadPersonalDataPost
} catch {
    Write-Host ("Exception occurred when calling Invoke-AccountManageDownloadPersonalDataPost: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-AccountManageLinkExternalLoginPost"></a>
# **Invoke-AccountManageLinkExternalLoginPost**
> void Invoke-AccountManageLinkExternalLoginPost<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Provider] <String><br>
...
### Example
```powershell
$Provider = "MyProvider" # String |  (optional)

try {
    $Result = Invoke-AccountManageLinkExternalLoginPost -Provider $Provider
} catch {
    Write-Host ("Exception occurred when calling Invoke-AccountManageLinkExternalLoginPost: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-AccountPerformExternalLoginPost"></a>
# **Invoke-AccountPerformExternalLoginPost**
> void Invoke-AccountPerformExternalLoginPost<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Provider] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ReturnUrl] <String><br>
...
try {
    $Result = Invoke-AccountPerformExternalLoginPost -Provider $Provider -ReturnUrl $ReturnUrl
} catch {
    Write-Host ("Exception occurred when calling Invoke-AccountPerformExternalLoginPost: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
