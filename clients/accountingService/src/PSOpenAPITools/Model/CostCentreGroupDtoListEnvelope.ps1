...
CostCentreGroupDtoListEnvelope<PSCustomObject>
#>

function Initialize-CostCentreGroupDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CostCentreGroupDtoListEnvelope' | Write-Debug
...
Convert from JSON to CostCentreGroupDtoListEnvelope<PSCustomObject>
...
CostCentreGroupDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCostCentreGroupDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CostCentreGroupDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CostCentreGroupDtoListEnvelope
