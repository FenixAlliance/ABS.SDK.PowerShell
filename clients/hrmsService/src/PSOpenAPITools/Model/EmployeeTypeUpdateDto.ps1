...
EmployeeTypeUpdateDto<PSCustomObject>
#>

function Initialize-EmployeeTypeUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployeeTypeUpdateDto' | Write-Debug
...
Convert from JSON to EmployeeTypeUpdateDto<PSCustomObject>
...
EmployeeTypeUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmployeeTypeUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployeeTypeUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployeeTypeUpdateDto
