...
ProviderWebhookRegistrationCreatedDtoEnvelope<PSCustomObject>
#>

function Initialize-ProviderWebhookRegistrationCreatedDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProviderWebhookRegistrationCreatedDtoEnvelope' | Write-Debug
...
Convert from JSON to ProviderWebhookRegistrationCreatedDtoEnvelope<PSCustomObject>
...
ProviderWebhookRegistrationCreatedDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToProviderWebhookRegistrationCreatedDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProviderWebhookRegistrationCreatedDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProviderWebhookRegistrationCreatedDtoEnvelope
