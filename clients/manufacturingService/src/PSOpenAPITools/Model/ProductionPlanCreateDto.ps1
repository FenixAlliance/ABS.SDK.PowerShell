...
ProductionPlanCreateDto<PSCustomObject>
#>

function Initialize-ProductionPlanCreateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductionPlanCreateDto' | Write-Debug
...
Convert from JSON to ProductionPlanCreateDto<PSCustomObject>
...
ProductionPlanCreateDto<PSCustomObject>
#>
function ConvertFrom-JsonToProductionPlanCreateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductionPlanCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductionPlanCreateDto
