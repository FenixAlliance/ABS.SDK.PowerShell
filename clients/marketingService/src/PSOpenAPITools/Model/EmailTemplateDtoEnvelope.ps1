...
EmailTemplateDtoEnvelope<PSCustomObject>
#>

function Initialize-EmailTemplateDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailTemplateDtoEnvelope' | Write-Debug
...
Convert from JSON to EmailTemplateDtoEnvelope<PSCustomObject>
...
EmailTemplateDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToEmailTemplateDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailTemplateDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailTemplateDtoEnvelope
