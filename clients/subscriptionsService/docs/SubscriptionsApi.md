...
# Patch a subscription
try {
    $Result = Invoke-PatchSubscriptionAsync -TenantId $TenantId -SubscriptionId $SubscriptionId -ApiVersion $ApiVersion -XApiVersion $XApiVersion -Operation $Operation
} catch {
