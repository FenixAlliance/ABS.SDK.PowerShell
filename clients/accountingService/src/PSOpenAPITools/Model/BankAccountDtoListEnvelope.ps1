...
BankAccountDtoListEnvelope<PSCustomObject>
#>

function Initialize-BankAccountDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BankAccountDtoListEnvelope' | Write-Debug
...
Convert from JSON to BankAccountDtoListEnvelope<PSCustomObject>
...
BankAccountDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToBankAccountDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BankAccountDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BankAccountDtoListEnvelope
