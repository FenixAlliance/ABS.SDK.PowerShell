...
TrainingProgramEventDtoEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramEventDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramEventDtoEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramEventDtoEnvelope<PSCustomObject>
...
TrainingProgramEventDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramEventDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramEventDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramEventDtoEnvelope
