...
CountDtoEnvelope<PSCustomObject>
#>

function Initialize-CountDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountDtoEnvelope' | Write-Debug
...
Convert from JSON to CountDtoEnvelope<PSCustomObject>
...
CountDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToCountDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountDtoEnvelope
