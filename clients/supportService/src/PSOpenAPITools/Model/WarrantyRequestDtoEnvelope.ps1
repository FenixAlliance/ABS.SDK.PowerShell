...
WarrantyRequestDtoEnvelope<PSCustomObject>
#>

function Initialize-WarrantyRequestDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WarrantyRequestDtoEnvelope' | Write-Debug
...
Convert from JSON to WarrantyRequestDtoEnvelope<PSCustomObject>
...
WarrantyRequestDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWarrantyRequestDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WarrantyRequestDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WarrantyRequestDtoEnvelope
