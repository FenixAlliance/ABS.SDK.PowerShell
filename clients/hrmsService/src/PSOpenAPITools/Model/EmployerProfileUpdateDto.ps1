...
EmployerProfileUpdateDto<PSCustomObject>
#>

function Initialize-EmployerProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmployerProfileUpdateDto' | Write-Debug
...
Convert from JSON to EmployerProfileUpdateDto<PSCustomObject>
...
EmployerProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmployerProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmployerProfileUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmployerProfileUpdateDto
