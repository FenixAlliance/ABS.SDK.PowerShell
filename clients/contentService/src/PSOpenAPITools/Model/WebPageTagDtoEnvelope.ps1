...
WebPageTagDtoEnvelope<PSCustomObject>
#>

function Initialize-WebPageTagDtoEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebPageTagDtoEnvelope' | Write-Debug
...
Convert from JSON to WebPageTagDtoEnvelope<PSCustomObject>
...
WebPageTagDtoEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToWebPageTagDtoEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebPageTagDtoEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebPageTagDtoEnvelope
