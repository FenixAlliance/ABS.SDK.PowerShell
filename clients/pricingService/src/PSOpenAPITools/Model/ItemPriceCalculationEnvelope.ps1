...
ItemPriceCalculationEnvelope<PSCustomObject>
#>

function Initialize-ItemPriceCalculationEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPriceCalculationEnvelope' | Write-Debug
...
Convert from JSON to ItemPriceCalculationEnvelope<PSCustomObject>
...
ItemPriceCalculationEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToItemPriceCalculationEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPriceCalculationEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPriceCalculationEnvelope
