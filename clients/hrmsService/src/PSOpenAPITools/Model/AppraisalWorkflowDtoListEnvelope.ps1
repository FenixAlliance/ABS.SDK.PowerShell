...
AppraisalWorkflowDtoListEnvelope<PSCustomObject>
#>

function Initialize-AppraisalWorkflowDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppraisalWorkflowDtoListEnvelope' | Write-Debug
...
Convert from JSON to AppraisalWorkflowDtoListEnvelope<PSCustomObject>
...
AppraisalWorkflowDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToAppraisalWorkflowDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppraisalWorkflowDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppraisalWorkflowDtoListEnvelope
