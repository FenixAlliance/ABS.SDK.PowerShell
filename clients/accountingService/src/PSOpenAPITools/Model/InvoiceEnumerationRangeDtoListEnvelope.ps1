...
InvoiceEnumerationRangeDtoListEnvelope<PSCustomObject>
#>

function Initialize-InvoiceEnumerationRangeDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InvoiceEnumerationRangeDtoListEnvelope' | Write-Debug
...
Convert from JSON to InvoiceEnumerationRangeDtoListEnvelope<PSCustomObject>
...
InvoiceEnumerationRangeDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToInvoiceEnumerationRangeDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InvoiceEnumerationRangeDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InvoiceEnumerationRangeDtoListEnvelope
