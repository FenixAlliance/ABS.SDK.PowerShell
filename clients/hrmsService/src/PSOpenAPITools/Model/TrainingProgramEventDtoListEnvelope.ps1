...
TrainingProgramEventDtoListEnvelope<PSCustomObject>
#>

function Initialize-TrainingProgramEventDtoListEnvelope {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrainingProgramEventDtoListEnvelope' | Write-Debug
...
Convert from JSON to TrainingProgramEventDtoListEnvelope<PSCustomObject>
...
TrainingProgramEventDtoListEnvelope<PSCustomObject>
#>
function ConvertFrom-JsonToTrainingProgramEventDtoListEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrainingProgramEventDtoListEnvelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrainingProgramEventDtoListEnvelope
