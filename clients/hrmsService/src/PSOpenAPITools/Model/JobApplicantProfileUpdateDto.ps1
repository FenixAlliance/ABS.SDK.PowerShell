...
JobApplicantProfileUpdateDto<PSCustomObject>
#>

function Initialize-JobApplicantProfileUpdateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JobApplicantProfileUpdateDto' | Write-Debug
...
Convert from JSON to JobApplicantProfileUpdateDto<PSCustomObject>
...
JobApplicantProfileUpdateDto<PSCustomObject>
#>
function ConvertFrom-JsonToJobApplicantProfileUpdateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JobApplicantProfileUpdateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JobApplicantProfileUpdateDto
